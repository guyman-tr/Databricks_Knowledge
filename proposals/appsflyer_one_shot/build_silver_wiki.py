"""Build the silver-table wiki .md from a single string template."""
from pathlib import Path

OUT = Path(__file__).resolve().parents[2] / "knowledge" / "UC_generated" / "de_output" / "Tables" / "de_output_appsflyer_silver_reports.md"
...
print(f"Wrote silver wiki: {OUT}")
print(f"  size: {len(WIKI)} chars / {WIKI.count(chr(10))+1} lines")
