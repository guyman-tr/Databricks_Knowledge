"""
Generic ALTER deploy batch — works for ANY schema.
...
Prerequisite: _deploy-index.md must exist for the schema.
  Build it with: python tools/build_deploy_index.py --schema <SCHEMA>

Usage:
  python tools/deploy_alter_batch.py --schema DWH_dbo --batch-size 25 --deploy-batch 2
  python tools/deploy_alter_batch.py --schema eMoney_dbo --batch-size 50 --deploy-batch 1 -v
  python tools/deploy_alter_batch.py --schema Dealing_dbo --redo-batch 5 --deploy-batch 5
