...
CREATE OR REPLACE PROCEDURE dwh_daily_process.migration_tables.SP_Fact_SnapshotEquity_DL_To_Synapse(
IN V_dt TIMESTAMP)
LANGUAGE SQL
...
call dwh_daily_process.migration_tables.SP_Fact_SnapshotEquity_InProcessCashouts(V_dt);
...
call dwh_daily_process.migration_tables.SP_Fact_SnapshotEquity_TotalPositionAmount(V_dt);
call dwh_daily_process.migration_tables.SP_Fact_SnapshotEquity(V_dt);
END;
