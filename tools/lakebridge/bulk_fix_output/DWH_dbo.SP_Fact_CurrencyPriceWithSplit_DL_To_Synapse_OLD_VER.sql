...
CREATE OR REPLACE PROCEDURE dwh_daily_process.migration_tables.SP_Fact_CurrencyPriceWithSplit_DL_To_Synapse_OLD_VER(
IN V_dt TIMESTAMP)
LANGUAGE SQL
...
(select Distinct InstrumentID from dwh_daily_process.migration_tables.Ext_FCPWS_History_SplitRatio)
...
FROM dwh_daily_process.daily_snapshot.PriceLog_Candles_CurrencyPriceMaxDateWithSplitView_SplitInstHistory
