...
**The master user table.** One row per user_id (but 1:MANY member_id→user_id — see data-patterns.md).
...
3. **Super/Voyager weekday-only**: Balance tables skip Sat/Sun. Use fill-forward pattern (see `data-patterns.md`)
