...
out_of_scope:
  ...
  - Tribe / FiatDwh / Treezor audit envelopes / eMoney audit trail → domain-cross/tribe-emoney-audit (Compliance ↔ C.3 eMoney cross-domain skill)
...
- **Tribe / FiatDwh / eMoney audit trail** → [`domain-cross/tribe-emoney-audit.md`](../domain-cross/tribe-emoney-audit.md).
...
`bronze_fiatdwhdb_tribe_*`) live in the [`tribe-emoney-audit`](../domain-cross/tribe-emoney-audit.md)
...
|--------|----------|--------------|
| [`../domain-cross/crypto-to-fiat.md`](../domain-cross/crypto-to-fiat.md) | C.4 ↔ C.3 via `EXW_C2F_E2E` | "Crypto came into wallet then converted to EUR/USD on IBAN" — cross-domain skill owns the E2E underbelly map. |
...
- It does not cover **fee revenue** of any kind. All fees, all products,
  all aggregations live in the [Revenue & Fees super-domain](../domain-revenue-and-fees/SKILL.md).
...
- It does not cover **Treezor / Tribe / FiatDwhDB audit envelopes** — that's the [`tribe-emoney-audit`](../domain-cross/tribe-emoney-audit.md) cross-domain skill.
