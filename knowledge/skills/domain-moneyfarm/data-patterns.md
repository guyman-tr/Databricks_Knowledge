...
**Source**: Confluence MG/13600227427 ("MoneyFarm - global payments configurations") + the UK BA Genie sql_snippet text quoted in `dashboard-queries.md` §"UK BA Genie sql_snippet".
