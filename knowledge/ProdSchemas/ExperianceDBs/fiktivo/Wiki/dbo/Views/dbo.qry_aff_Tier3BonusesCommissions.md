# dbo.qry_aff_Tier3BonusesCommissions

> Tier 3 filter view over tblaff_Bonuses_Commissions, extracting bonuses commissions for tier 3 (grandparent) affiliates with aliased column names for cross-tier joining.
...
Filtered subset of tblaff_Bonuses_Commissions where Tier = 3.
...
|---------|---------------|-------------------|-------------|
| (all) | dbo.tblaff_Bonuses_Commissions | Base table | Filtered by Tier = 3 |

### 5.2 Referenced By (other objects point to this)

| Source Object | Source Element | Relationship Type | Description |
|--------------|---------------|-------------------|-------------|
| dbo.qry_aff_BonusesDetailAllTiers | LEFT OUTER JOIN | View | All-tiers pivot joins this for tier 3 data |
...
|--------|------|----------|
| dbo.tblaff_Bonuses_Commissions | Table | Base table (WHERE Tier = 3) |

### 6.2 Objects That Depend On This

| Object | Type | How Used |
|--------|------|----------|
| dbo.qry_aff_BonusesDetailAllTiers | View | LEFT OUTER JOIN for tier 3 pivot |
...
### 8.1 Tier 3 bonuses commissions for an affiliate
```sql
SELECT BonusID, Tier3Commission, Tier3Paid
FROM dbo.qry_aff_Tier3BonusesCommissions WITH (NOLOCK)
WHERE Tier3AffiliateID = @AffiliateID
```

### 8.2 Total unpaid tier 3 bonuses commissions
```sql
...
```sql
SELECT COUNT(*) AS TierRecords FROM dbo.qry_aff_Tier3BonusesCommissions WITH (NOLOCK)
```
...
*Object: dbo.qry_aff_Tier3BonusesCommissions | Type: View | Source: fiktivo/dbo/Views/dbo.qry_aff_Tier3BonusesCommissions.sql*
