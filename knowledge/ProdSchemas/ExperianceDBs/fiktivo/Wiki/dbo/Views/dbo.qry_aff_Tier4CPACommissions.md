# dbo.qry_aff_Tier4CPACommissions

> Tier 4 filter view over tblaff_CPA_Commissions, extracting CPA commissions for tier 4 (great-grandparent) affiliates with aliased column names for cross-tier joining.
...
Filtered subset of tblaff_CPA_Commissions where Tier = 4.
...
|---------|---------------|-------------------|-------------|
| (all) | dbo.tblaff_CPA_Commissions | Base table | Filtered by Tier = 4 |

### 5.2 Referenced By (other objects point to this)

| Source Object | Source Element | Relationship Type | Description |
|--------------|---------------|-------------------|-------------|
| dbo.qry_aff_CPADetailAllTiers | LEFT OUTER JOIN | View | All-tiers pivot joins this for tier 4 data |
...
|--------|------|----------|
| dbo.tblaff_CPA_Commissions | Table | Base table (WHERE Tier = 4) |

### 6.2 Objects That Depend On This

| Object | Type | How Used |
|--------|------|----------|
| dbo.qry_aff_CPADetailAllTiers | View | LEFT OUTER JOIN for tier 4 pivot |
...
### 8.1 Tier 4 CPA commissions for an affiliate
```sql
SELECT DepositID, Tier4Commission, Tier4Paid
FROM dbo.qry_aff_Tier4CPACommissions WITH (NOLOCK)
WHERE Tier4AffiliateID = @AffiliateID
```

### 8.2 Total unpaid tier 4 CPA commissions
```sql
...
```sql
SELECT COUNT(*) AS TierRecords FROM dbo.qry_aff_Tier4CPACommissions WITH (NOLOCK)
```
...
*Object: dbo.qry_aff_Tier4CPACommissions | Type: View | Source: fiktivo/dbo/Views/dbo.qry_aff_Tier4CPACommissions.sql*
