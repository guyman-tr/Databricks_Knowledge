# dbo.qry_aff_Tier4CopyTradersCommissions

> Tier 4 filter view over tblaff_CopyTraders_Commissions, extracting copytraders commissions for tier 4 (great-grandparent) affiliates with aliased column names for cross-tier joining.
...
Filtered subset of tblaff_CopyTraders_Commissions where Tier = 4.
...
|---------|---------------|-------------------|-------------|
| (all) | dbo.tblaff_CopyTraders_Commissions | Base table | Filtered by Tier = 4 |

### 5.2 Referenced By (other objects point to this)

| Source Object | Source Element | Relationship Type | Description |
|--------------|---------------|-------------------|-------------|
| dbo.qry_aff_CopyTraderDetailAllTiers | LEFT OUTER JOIN | View | All-tiers pivot joins this for tier 4 data |
...
|--------|------|----------|
| dbo.tblaff_CopyTraders_Commissions | Table | Base table (WHERE Tier = 4) |

### 6.2 Objects That Depend On This

| Object | Type | How Used |
|--------|------|----------|
| dbo.qry_aff_CopyTraderDetailAllTiers | View | LEFT OUTER JOIN for tier 4 pivot |
...
### 8.1 Tier 4 copytraders commissions for an affiliate
```sql
SELECT CopyTraderID, Tier4Commission, Tier4Paid
FROM dbo.qry_aff_Tier4CopyTradersCommissions WITH (NOLOCK)
WHERE Tier4AffiliateID = @AffiliateID
```

### 8.2 Total unpaid tier 4 copytraders commissions
```sql
...
```sql
SELECT COUNT(*) AS TierRecords FROM dbo.qry_aff_Tier4CopyTradersCommissions WITH (NOLOCK)
```
...
*Object: dbo.qry_aff_Tier4CopyTradersCommissions | Type: View | Source: fiktivo/dbo/Views/dbo.qry_aff_Tier4CopyTradersCommissions.sql*
