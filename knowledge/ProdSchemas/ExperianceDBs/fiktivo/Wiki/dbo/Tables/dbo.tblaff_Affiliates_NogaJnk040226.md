# dbo.tblaff_Affiliates_NogaJnk040226

> Developer backup/snapshot of tblaff_Affiliates, created on 2026-02-04 by Noga. No indexes, no FKs, no triggers - exists purely as a point-in-time data safety copy.
...
```sql
SELECT COUNT(*) AS RowCount FROM dbo.tblaff_Affiliates_NogaJnk040226 WITH (NOLOCK)
```
...
UNION ALL
SELECT 'Backup', COUNT(*) FROM dbo.tblaff_Affiliates_NogaJnk040226 WITH (NOLOCK)
```

### 8.3 Sample backup data
```sql
SELECT TOP 5 * FROM dbo.tblaff_Affiliates_NogaJnk040226 WITH (NOLOCK)
```
...
*Object: dbo.tblaff_Affiliates_NogaJnk040226 | Type: Table (backup) | Source: fiktivo/dbo/Tables/dbo.tblaff_Affiliates_NogaJnk040226.sql*
