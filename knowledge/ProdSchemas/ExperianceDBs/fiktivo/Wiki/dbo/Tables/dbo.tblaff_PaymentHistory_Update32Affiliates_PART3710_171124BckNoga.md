# dbo.tblaff_PaymentHistory_Update32Affiliates_PART3710_171124BckNoga

> Developer backup/snapshot of tblaff_PaymentHistory, created by Noga before the PART-3710 ticket update of 32 affiliates on 2024-11-17. No indexes, no FKs, no triggers - exists purely as a point-in-time data safety copy.
...
dbo.tblaff_PaymentHistory_Update32Affiliates_PART3710_171124BckNoga is a developer backup copy of dbo.tblaff_PaymentHistory, created by Noga on 2024-11-17 as a pre-change safety snapshot before executing the update described in Jira ticket PART-3710. The name encodes the context: the update affected 32 affiliate records, was performed on 17 Nov 2024 (171124), and was backed up by Noga ("BckNoga"). These tables should be reviewed for potential cleanup.
...
Developer backup - data represents a point-in-time snapshot from 2024-11-17, taken before the PART-3710 update to 32 affiliates' payment history records.
...
```sql
SELECT COUNT(*) AS RowCount FROM dbo.tblaff_PaymentHistory_Update32Affiliates_PART3710_171124BckNoga WITH (NOLOCK)
```
...
UNION ALL
SELECT 'Backup', COUNT(*) FROM dbo.tblaff_PaymentHistory_Update32Affiliates_PART3710_171124BckNoga WITH (NOLOCK)
```

### 8.3 Sample backup data
```sql
SELECT TOP 5 * FROM dbo.tblaff_PaymentHistory_Update32Affiliates_PART3710_171124BckNoga WITH (NOLOCK)
```
...
*Object: dbo.tblaff_PaymentHistory_Update32Affiliates_PART3710_171124BckNoga | Type: Table (backup) | Source: fiktivo/dbo/Tables/dbo.tblaff_PaymentHistory_Update32Affiliates_PART3710_171124BckNoga.sql*
