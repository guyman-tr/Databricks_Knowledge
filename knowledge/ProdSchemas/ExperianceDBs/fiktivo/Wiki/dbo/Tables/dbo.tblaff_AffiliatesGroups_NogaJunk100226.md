# dbo.tblaff_AffiliatesGroups_NogaJunk100226

> Developer backup/snapshot of tblaff_AffiliatesGroups, created on 2026-02-10 by Noga. No indexes, no FKs, no triggers - exists purely as a point-in-time data safety copy.
...
```sql
SELECT COUNT(*) AS RowCount FROM dbo.tblaff_AffiliatesGroups_NogaJunk100226 WITH (NOLOCK)
```
...
UNION ALL
SELECT 'Backup', COUNT(*) FROM dbo.tblaff_AffiliatesGroups_NogaJunk100226 WITH (NOLOCK)
```

### 8.3 Sample backup data
```sql
SELECT TOP 5 * FROM dbo.tblaff_AffiliatesGroups_NogaJunk100226 WITH (NOLOCK)
```
...
*Object: dbo.tblaff_AffiliatesGroups_NogaJunk100226 | Type: Table (backup) | Source: fiktivo/dbo/Tables/dbo.tblaff_AffiliatesGroups_NogaJunk100226.sql*
