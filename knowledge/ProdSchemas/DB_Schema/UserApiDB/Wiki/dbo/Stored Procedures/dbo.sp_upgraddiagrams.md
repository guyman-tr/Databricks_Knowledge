...
dbo.sp_upgraddiagrams is a standard SQL Server system procedure for managing database diagrams in dbo.sysdiagrams. Part of the SSMS diagram designer infrastructure. Not application-specific.
...
*Object: dbo.sp_upgraddiagrams | Type: Stored Procedure | Source: UserApiDB/UserApiDB/dbo/Stored Procedures/dbo.sp_upgraddiagrams.sql*
