...
### 8.1 Use the synonym
```sql
SELECT TOP 10 * FROM Dictionary_Country WITH (NOLOCK)
```
...
```sql
SELECT OBJECT_ID('dbo.Dictionary_Country') AS ObjectID
```
...
*Object: dbo.Dictionary_Country | Type: Synonym | Source: UserApiDB/UserApiDB/dbo/Synonyms/dbo.Dictionary_Country.sql*
