# dbo.sp_MSdel_dboReplCheck_RiskClassification_etoro

> Auto-generated transactional replication stored procedure that applies DELETE operations from the publication to the subscriber table dbo.ReplCheck_RiskClassification_etoro.
...
`sp_MSdel_dboReplCheck_RiskClassification_etoro` is an auto-generated stored procedure created by SQL Server transactional replication. It is part of the Distribution Agent mechanism that applies DELETE operations from the publisher to the subscriber copy of the `dbo.ReplCheck_RiskClassification_etoro` table.
...
1. DELETE FROM `dbo.ReplCheck_RiskClassification_etoro` WHERE `ID` = `@pkc1`
...
|--------|------|--------------|
| dbo.ReplCheck_RiskClassification_etoro | Table | Target table for DELETE operation |
...
```sql
EXEC dbo.sp_MSdel_dboReplCheck_RiskClassification_etoro @pkc1 = 1
```
...
*Object: dbo.sp_MSdel_dboReplCheck_RiskClassification_etoro | Type: Stored Procedure | Source: RiskClassification/dbo/Stored Procedures/dbo.sp_MSdel_dboReplCheck_RiskClassification_etoro.sql*
