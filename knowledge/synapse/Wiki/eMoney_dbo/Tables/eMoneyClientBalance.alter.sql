...
ALTER TABLE main.bi_db.gold_sql_dp_prod_we_emoney_dbo_emoneyclientbalance ALTER COLUMN ClosingBalanceBORepCur COMMENT 'Reporting-currency equivalent of ClosingBalanceBO (Tribe back-office closing balance) in entity reporting currency: ClosingBalanceBO * CrossExchangeRate2. NULL for rows loaded before 2026-01-20.';
ALTER TABLE main.bi_db.gold_sql_dp_prod_we_emoney_dbo_emoneyclientbalance ALTER COLUMN OpeningBalanceRepCur COMMENT 'Reporting-currency equivalent of OpeningBalance (total opening balance) in entity reporting currency: OpeningBalance * CrossExchangeRate2. NULL for rows loaded before 2026-01-20.';
ALTER TABLE main.bi_db.gold_sql_dp_prod_we_emoney_dbo_emoneyclientbalance ALTER COLUMN OpeningPositiveBalanceRepCur COMMENT 'Reporting-currency equivalent of OpeningPositiveBalance (positive-only opening component) in entity reporting currency: OpeningPositiveBalance * CrossExchangeRate2. NULL for rows loaded before 2026-01-20.';
ALTER TABLE main.bi_db.gold_sql_dp_prod_we_emoney_dbo_emoneyclientbalance ALTER COLUMN BankPayInsRepCur COMMENT 'Reporting-currency equivalent of BankPayIns (inbound banking transfers sum) in entity reporting currency: BankPayIns * CrossExchangeRate2. NULL for rows loaded before 2026-01-20.';
ALTER TABLE main.bi_db.gold_sql_dp_prod_we_emoney_dbo_emoneyclientbalance ALTER COLUMN BankPayOutsRepCur COMMENT 'Reporting-currency equivalent of BankPayOuts (outbound banking transfers sum) in entity reporting currency: BankPayOuts * CrossExchangeRate2. NULL for rows loaded before 2026-01-20.';
ALTER TABLE main.bi_db.gold_sql_dp_prod_we_emoney_dbo_emoneyclientbalance ALTER COLUMN Card_POSRepCur COMMENT 'Reporting-currency equivalent of Card_POS (point-of-sale card transactions) in entity reporting currency: Card_POS * CrossExchangeRate2. NULL for rows loaded before 2026-01-20.';
ALTER TABLE main.bi_db.gold_sql_dp_prod_we_emoney_dbo_emoneyclientbalance ALTER COLUMN Card_ATMRepCur COMMENT 'Reporting-currency equivalent of Card_ATM (ATM cash withdrawals) in entity reporting currency: Card_ATM * CrossExchangeRate2. NULL for rows loaded before 2026-01-20.';
ALTER TABLE main.bi_db.gold_sql_dp_prod_we_emoney_dbo_emoneyclientbalance ALTER COLUMN EtoroDepositsRepCur COMMENT 'Reporting-currency equivalent of EtoroDeposits (eToro wallet loads) in entity reporting currency: EtoroDeposits * CrossExchangeRate2. NULL for rows loaded before 2026-01-20.';
ALTER TABLE main.bi_db.gold_sql_dp_prod_we_emoney_dbo_emoneyclientbalance ALTER COLUMN EtoroCashoutsRepCur COMMENT 'Reporting-currency equivalent of EtoroCashouts (eToro wallet unloads) in entity reporting currency: EtoroCashouts * CrossExchangeRate2. NULL for rows loaded before 2026-01-20.';
ALTER TABLE main.bi_db.gold_sql_dp_prod_we_emoney_dbo_emoneyclientbalance ALTER COLUMN EtoroC2FDepositsRepCur COMMENT 'Reporting-currency equivalent of EtoroC2FDeposits (crypto-to-fiat conversion loads) in entity reporting currency: EtoroC2FDeposits * CrossExchangeRate2. NULL for rows loaded before 2026-01-20.';
ALTER TABLE main.bi_db.gold_sql_dp_prod_we_emoney_dbo_emoneyclientbalance ALTER COLUMN BalanceAdjustmentsRepCur COMMENT 'Reporting-currency equivalent of BalanceAdjustments (manual/API credit and debit adjustments) in entity reporting currency: BalanceAdjustments * CrossExchangeRate2. NULL for rows loaded before 2026-01-20.';
ALTER TABLE main.bi_db.gold_sql_dp_prod_we_emoney_dbo_emoneyclientbalance ALTER COLUMN ChargeBackAdjustmentsRepCur COMMENT 'Reporting-currency equivalent of ChargeBackAdjustments (chargeback dispute credits) in entity reporting currency: ChargeBackAdjustments * CrossExchangeRate2. NULL for rows loaded before 2026-01-20.';
ALTER TABLE main.bi_db.gold_sql_dp_prod_we_emoney_dbo_emoneyclientbalance ALTER COLUMN ATMFeeRepCur COMMENT 'Reporting-currency equivalent of ATMFee in entity reporting currency: ATMFee * CrossExchangeRate2. NULL for rows loaded before 2026-01-20.';
ALTER TABLE main.bi_db.gold_sql_dp_prod_we_emoney_dbo_emoneyclientbalance ALTER COLUMN FxFeeRepCur COMMENT 'Reporting-currency equivalent of FxFee (FX conversion fees) in entity reporting currency: FxFee * CrossExchangeRate2. NULL for rows loaded before 2026-01-20.';
ALTER TABLE main.bi_db.gold_sql_dp_prod_we_emoney_dbo_emoneyclientbalance ALTER COLUMN OtherFeeRepCur COMMENT 'Reporting-currency equivalent of OtherFee (non-ATM settlement fees) in entity reporting currency: OtherFee * CrossExchangeRate2. NULL for rows loaded before 2026-01-20.';
ALTER TABLE main.bi_db.gold_sql_dp_prod_we_emoney_dbo_emoneyclientbalance ALTER COLUMN ClosingBalanceCalcRepCur COMMENT 'Reporting-currency equivalent of ClosingBalanceCalc (DWH-computed closing balance) in entity reporting currency: ClosingBalanceCalc * CrossExchangeRate2. NULL for rows loaded before 2026-01-20.';
ALTER TABLE main.bi_db.gold_sql_dp_prod_we_emoney_dbo_emoneyclientbalance ALTER COLUMN ClosingBalanceGAPRepCur COMMENT 'Reporting-currency equivalent of ClosingBalanceGAP (calc-vs-BO reconciliation residual) in entity reporting currency: ClosingBalanceGAP * CrossExchangeRate2. NULL for rows loaded before 2026-01-20.';
ALTER TABLE main.bi_db.gold_sql_dp_prod_we_emoney_dbo_emoneyclientbalance ALTER COLUMN ClosingNegativeBalanceBORepCur COMMENT 'Reporting-currency equivalent of ClosingNegativeBalanceBO (negative-only closing component from BO) in entity reporting currency: ClosingNegativeBalanceBO * CrossExchangeRate2. NULL for rows loaded before 2026-01-20.';
ALTER TABLE main.bi_db.gold_sql_dp_prod_we_emoney_dbo_emoneyclientbalance ALTER COLUMN NegativeBalanceMovementRepCur COMMENT 'Reporting-currency equivalent of NegativeBalanceMovement (day-over-day change in negative balance) in entity reporting currency: NegativeBalanceMovement * CrossExchangeRate2. NULL for rows loaded before 2026-01-20.';
ALTER TABLE main.bi_db.gold_sql_dp_prod_we_emoney_dbo_emoneyclientbalance ALTER COLUMN ClosingPositiveBalanceBORepCur COMMENT 'Reporting-currency equivalent of ClosingPositiveBalanceBO (positive-only closing component from BO) in entity reporting currency: ClosingPositiveBalanceBO * CrossExchangeRate2. NULL for rows loaded before 2026-01-20.';
ALTER TABLE main.bi_db.gold_sql_dp_prod_we_emoney_dbo_emoneyclientbalance ALTER COLUMN ClosingPositiveBalanceCalcRepCur COMMENT 'Reporting-currency equivalent of ClosingPositiveBalanceCalc (DWH-computed positive closing) in entity reporting currency: ClosingPositiveBalanceCalc * CrossExchangeRate2. NULL for rows loaded before 2026-01-20.';
ALTER TABLE main.bi_db.gold_sql_dp_prod_we_emoney_dbo_emoneyclientbalance ALTER COLUMN ClosingPositiveBalanceGAPRepCur COMMENT 'Reporting-currency equivalent of ClosingPositiveBalanceGAP (positive reconciliation residual) in entity reporting currency: ClosingPositiveBalanceGAP * CrossExchangeRate2. NULL for rows loaded before 2026-01-20.';
...
-- == LAST EXECUTION ==
-- Timestamp: 2026-05-19 11:14:15 UTC
-- Batch: tier_drift_fix (2026-05-19 one-shot)
-- Statements: 146/146 succeeded
-- ====================
