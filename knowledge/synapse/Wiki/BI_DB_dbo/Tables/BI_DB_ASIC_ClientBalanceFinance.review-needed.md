...
| 5 | `IsCreditReportValidCB = 1` filter | Medium | ASIC clients with failed Client_Balance checks are silently excluded. Confirm this population exclusion is correct for ASIC regulatory reporting. |
