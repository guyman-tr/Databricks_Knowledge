...
| 7 | Region | varchar(50) | YES | Marketing region label for this country. Loaded from etoro.Dictionary.MarketingRegion.Name via JOIN on MarketingRegionID. NOT the geographic region from Dictionary.Region. 22 distinct values (e.g., "ROW", "Africa", "French", "Arabic GCC"). Sourced from `DWH_dbo.Dim_Country.Region`. (Tier 1 — DWH_dbo wiki, Dim_Country) |
