...
ALTER TABLE main.bi_db.gold_sql_dp_prod_we_bi_db_dbo_bi_db_money_in_new_management_dashboard ALTER COLUMN PaymentStatusID COMMENT 'Payment status code from Fact_BillingDeposit. 2=Approved, 1/5/11/12=Excluded statuses, 6/13=conditional exclude based on FundingTypeID. (Tier 2 - SP_Money_In_New_Management_Dashboard)';
