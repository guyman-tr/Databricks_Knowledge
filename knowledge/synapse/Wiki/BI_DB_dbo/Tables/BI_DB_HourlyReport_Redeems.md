...
| 6 | CashoutStatusID | int | YES | Current withdrawal status. FK to Dictionary.CashoutStatus. 10 distinct values: 1=Pending, 2=InProcess, 3=Processed, 4=Canceled. Passthrough from Billing.Withdraw. Cancelled (4) excluded from population. (Tier 1 — Billing.Withdraw) |
