...
ALTER TABLE main.general.gold_sql_dp_prod_we_bi_db_dbo_bi_db_withdraw_rollback_pips ALTER COLUMN PlayerLevelID COMMENT 'Customer experience/permission level. FK to Dictionary.PlayerLevel. 1=Standard; 4=Popular Investor; 7=VIP. Determines available features and risk limits. Default=0. Passthrough from Dim_Customer. (Tier 1 - Customer.CustomerStatic)';
