...
| CopyType | NOT NULL | varchar(9) | PI category inherited from BI_DB_CopyDailyData. 'PI' = Popular Investor (GuruStatusID >= 2). 'Portfolio' = CopyPortfolio account (AccountTypeID=9). Observed: PI=96.8%, Portfolio=3.2%. (Tier 2 — BI_DB_dbo.BI_DB_CopyDailyData) |
