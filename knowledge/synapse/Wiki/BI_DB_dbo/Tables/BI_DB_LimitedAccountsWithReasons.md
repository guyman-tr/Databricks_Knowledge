...
| 6 | PlayerStatusID | int | YES | Compliance and trading account status. FK to Dictionary.PlayerStatus. 1=Active/Registered (97.5% of accounts); other values indicate restricted, closed, banned, or special states. Default=0. This table contains only restricted values: 5=Warning, 9=Trade & MIMO Blocked, 10=Deposit Blocked, 12=Copy Block, 13=Pending Verification, 15=Block Deposit & Trading. (Tier 1 — Customer.CustomerStatic) |
