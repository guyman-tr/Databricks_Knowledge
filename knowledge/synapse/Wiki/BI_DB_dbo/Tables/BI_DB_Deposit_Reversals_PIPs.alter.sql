...
ALTER TABLE main.general.gold_sql_dp_prod_we_bi_db_dbo_bi_db_deposit_reversals_pips ALTER COLUMN CreditTypeID COMMENT 'Credit type from External_etoro_history_credit_yesterday. Reversal types: 11=Chargeback, 12=Refund, 16=Refund As ChargeBack, 32=Reverse Deposit. (Tier 2 - SP_Deposit_Reversals_PIPs)';
