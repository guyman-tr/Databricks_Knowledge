...
| 24 | Credit | float | YES | Credit value from Fact_SnapshotEquity.Credit via V_Liabilities. Direct passthrough; the underlying view holds daily snapshots — filter by DateID. (Tier 2 — V_Liabilities) |
