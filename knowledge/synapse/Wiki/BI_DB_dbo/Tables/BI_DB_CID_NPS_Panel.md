...
| 7 | FirstDepositDate | datetime | YES | Date of first deposit. DEFAULT='19000101'. Updated from CustomerFinanceDB FTD data with FTDRecoveryDate logic. NULL when RealCID is unresolved. (Tier 2 — DWH_dbo.Dim_Customer) |
