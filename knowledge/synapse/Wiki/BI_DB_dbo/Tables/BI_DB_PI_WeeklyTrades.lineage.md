...
| Week1 | BI_DB_dbo.BI_DB_CID_WeeklyPanel_FullData | SSWeekNumberOfYear | Passthrough (rename) | Tier 1 — BI_DB_CID_WeeklyPanel_FullData |
| Year1 | BI_DB_dbo.BI_DB_CID_WeeklyPanel_FullData | CalendarYear | Passthrough (rename) | Tier 1 — BI_DB_CID_WeeklyPanel_FullData |
| NewTrades | BI_DB_dbo.BI_DB_CID_WeeklyPanel_FullData | NewTrades_Total | Passthrough (rename) | Tier 1 — BI_DB_CID_WeeklyPanel_FullData |
| UpdateDate | — | — | ETL-computed: GETDATE() | Tier 2 — SP_PI_Dashboard_COPYDATA_RuningSideBySide |
| FirstDayOfWeek | BI_DB_dbo.BI_DB_CID_WeeklyPanel_FullData | FirstDayOfWeek | Passthrough | Tier 1 — BI_DB_CID_WeeklyPanel_FullData |
