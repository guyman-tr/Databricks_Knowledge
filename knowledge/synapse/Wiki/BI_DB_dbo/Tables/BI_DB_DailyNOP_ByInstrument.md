...
| 3 | InstrumentType | varchar(50) | YES | Instrument asset class category from Dim_Instrument. 6 values: Stocks, ETF, Crypto Currencies, Commodities, Currencies, Indices. CASE-computed in SP_Dim_Instrument from InstrumentTypeID: 1=Currencies, 2=Commodities, 4=Indices, 5=Stocks, 6=ETF, 10=Crypto Currencies. (Tier 2 — DWH_dbo.Dim_Instrument) |
