...
| 12 | VerificationLevelID | int | YES | KYC verification level. No filter applied — all levels present (1=registered, 2=partially verified, 3=fully verified). Sourced from BackOffice.Customer. (Tier 1 - BackOffice.Customer via Dim_Customer) |
