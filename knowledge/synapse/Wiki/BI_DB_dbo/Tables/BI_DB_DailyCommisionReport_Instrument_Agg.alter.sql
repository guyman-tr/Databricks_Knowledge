...
ALTER TABLE main.general.gold_sql_dp_prod_we_bi_db_dbo_bi_db_dailycommisionreport_instrument_agg ALTER COLUMN IsCreditReportValidCBPrev COMMENT '**Always NULL.** Legacy column tracking prior credit bureau validity; never activated. Do not use. (Tier 4 - Legacy/Deprecated)';
...
ALTER TABLE main.general.gold_sql_dp_prod_we_bi_db_dbo_bi_db_dailycommisionreport_instrument_agg ALTER COLUMN IsCreditReportValidCB COMMENT 'Credit bureau validity flag (1=credit report validated against external credit bureau). GROUP BY pass-through. (Tier 2 - SP_DailyCommisionReport)';
