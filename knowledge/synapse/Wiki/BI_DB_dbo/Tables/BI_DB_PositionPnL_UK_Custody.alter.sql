...
ALTER TABLE main.bi_db.gold_sql_dp_prod_we_bi_db_dbo_bi_db_positionpnl_uk_custody ALTER COLUMN IsCreditReportValidCB COMMENT 'Financial-customer flag for Client_Balance reports (CB = Client_Balance, NOT CreditBureau). ETL-computed in Fact_SnapshotCustomer from PlayerLevelID, AccountTypeID, LabelID, CountryID. Passthrough from Fact_SnapshotCustomer. (Tier 1 - DWH_dbo.Fact_SnapshotCustomer)';
