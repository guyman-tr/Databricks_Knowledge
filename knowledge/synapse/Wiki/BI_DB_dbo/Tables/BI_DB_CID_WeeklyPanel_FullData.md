...
| 21 | NewMarketingRegion | varchar(50) | YES | Marketing team region classification (e.g., 'Arabic', 'French', 'UK', 'ROW'). EOW snapshot. More recent vintage than Region. (Tier 3 — Dim_Country.MarketingRegionManualName, via DailyPanel) |
