...
| 6 | IsCreditReportValidCB | int | YES | Flag indicating whether the customer has a valid Client_Balance report (used for K-CMH capital adequacy calculations). 1=valid (81.5%), 0=not valid (18.5%). (Tier 2 — SP_Equity_Real_Crypto_Stocks_Total_Cash_by_Regulation) |
