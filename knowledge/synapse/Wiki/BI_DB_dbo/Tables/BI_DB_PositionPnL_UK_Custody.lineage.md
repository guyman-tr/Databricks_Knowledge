# BI_DB_dbo.BI_DB_PositionPnL_UK_Custody — Column Lineage
...
| PositionID_Hashed | BI_DB_PositionPnL | PositionID | MD5 hash: CONVERT(NVARCHAR(32), HASHBYTES('MD5', CONVERT(NVARCHAR(MAX), PositionID)), 2) |
...
#posFCA (CySEC stock/ETF positions with credit/validity flags)
  |-- TRUNCATE + INSERT, CID → 999999999, PositionID → MD5
  v
