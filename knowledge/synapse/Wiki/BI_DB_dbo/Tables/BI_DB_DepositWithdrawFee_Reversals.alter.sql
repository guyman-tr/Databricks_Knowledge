...
ALTER TABLE main.bi_db.gold_sql_dp_prod_we_bi_db_dbo_bi_db_depositwithdrawfee_reversals ALTER COLUMN IsValidCustomer COMMENT '1 when not Popular Investor (PlayerLevelID != 4), not label 30/26, and not CountryID=250. Point-in-time snapshot from Fact_SnapshotCustomer. (Tier 2 - SP_DepositWithdrawFee)';
