...
| 12 | IsFunded_ThisWeek | int | YES | Funded on last day of week (rn=1). Changed Nov 2025 from any-day to last-day. (Tier 2 — SP_DDR_Customer_Periodic_Status) |
| 13 | FirstTimeFunded_ThisWeek | int | YES | Count of days first-time-funded occurred this week. SUM across period. (Tier 2 — SP_DDR_Customer_Periodic_Status) |
| 14 | ActiveTraded_ThisWeek | int | YES | Count of days actively traded this week. SUM across period. >0 means "active this week." (Tier 2 — SP_DDR_Customer_Periodic_Status) |
| 15 | Portfolio_Only_ThisWeek | int | YES | Portfolio-only days this week (excl ActiveTraded days). COUNT with conditional hierarchy. (Tier 2 — SP_DDR_Customer_Periodic_Status) |
| 16 | BalanceOnlyAccount_ThisWeek | int | YES | Balance-only days this week (excl ActiveTraded and Portfolio_Only). COUNT with conditional hierarchy. (Tier 2 — SP_DDR_Customer_Periodic_Status) |
