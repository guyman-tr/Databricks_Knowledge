...
| 10 | IsCreditReportValidCB | bit | YES | Credit report validity flag for US Client_Balance reporting — from Fact_SnapshotCustomer. Typically equals IsValidCustomer (0.02% rows show False/True divergence). (Tier 2 — SP_DailyCommisionReport via BI_DB_DailyCommisionReport) |
