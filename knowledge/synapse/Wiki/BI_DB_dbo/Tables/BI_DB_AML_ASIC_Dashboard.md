...
| 7 | FirstDepositDate | datetime | YES | Date and time of first deposit from Dim_Customer.FirstDepositDate. Observed range: 2008-12-14 to 2026-04-12. (Tier 2 — DWH_dbo.Dim_Customer wiki) |
| 8 | FirstDepositAmount | money | YES | First deposit amount in USD from Dim_Customer.FirstDepositAmount. (Tier 2 — DWH_dbo.Dim_Customer wiki) |
