...
ALTER TABLE main.bi_db.gold_sql_dp_prod_we_bi_db_dbo_bi_db_dailycommisionreport ALTER COLUMN PlayerLevelID COMMENT 'Integer player level key (1=Bronze, 2=Platinum, 3=Gold, 4=Internal, etc.) from Fact_SnapshotCustomer.';
...
ALTER TABLE main.bi_db.gold_sql_dp_prod_we_bi_db_dbo_bi_db_dailycommisionreport ALTER COLUMN IsCreditReportValidCB COMMENT 'Financial-customer flag for Client_Balance reports (CB = Client_Balance, NOT CreditBureau). From Fact_SnapshotCustomer.';
...
ALTER TABLE main.bi_db.gold_sql_dp_prod_we_bi_db_dbo_bi_db_dailycommisionreport ALTER COLUMN AccountTypeID COMMENT 'Integer account type key (1=Private, 2=Corporate, 14=SMSF, etc.) from Fact_SnapshotCustomer.';
