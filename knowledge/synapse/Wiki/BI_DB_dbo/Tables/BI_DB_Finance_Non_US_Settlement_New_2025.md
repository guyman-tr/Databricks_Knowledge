...
| 23 | IsCreditReportValidCB | int | YES | Financial-customer flag for Client_Balance reports (CB = Client_Balance, NOT CreditBureau). ETL-computed in Fact_SnapshotCustomer. Passthrough via SCD snapshot. NULL for No_Client_Holdings rows. (Tier 2 — SP_Fact_SnapshotCustomer) |
