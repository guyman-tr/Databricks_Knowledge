...
| 13 | FieldID | int | YES | FK to Dictionary.ExtendedUserField. Identifies which field: 0=province, 6=TaxId, 7=NationalPin, etc. Always 6 (TaxId) in this table. (Tier 2 — UserApiDB.Customer.ExtendedUserField) |
