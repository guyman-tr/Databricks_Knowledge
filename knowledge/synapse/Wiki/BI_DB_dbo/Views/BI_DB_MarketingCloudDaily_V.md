...
| 37 | Credit | money | YES | Credit projected from BI_DB_MarketingCloudDaily (see base table wiki). Outstanding credit/bonus balance from History.ActiveCredit. Last credit event per CID per day. From V_Liabilities.Credit where DateID=@dateID. (Tier 1 — Fact_SnapshotEquity via V_Liabilities)|
