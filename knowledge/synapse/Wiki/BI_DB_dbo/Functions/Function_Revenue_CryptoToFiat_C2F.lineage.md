# Object lineage — BI_DB_dbo.Function_Revenue_CryptoToFiat_C2F
...
| Object | Schema | Notes |
|--------|--------|-------|
| EXW_C2F_E2E | EXW_dbo | Referenced in function body |
...
- **ALTER**: Companion `Function_Revenue_CryptoToFiat_C2F.alter.sql` is a **comment-only stub** when UC Target is `_Not_Migrated` — `deploy-alter-dwh` must skip executable statements for these files.
