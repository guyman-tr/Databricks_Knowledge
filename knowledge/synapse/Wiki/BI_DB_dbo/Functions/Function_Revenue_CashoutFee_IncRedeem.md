# Function_Revenue_CashoutFee_IncRedeem
...
| 35 | IsCreditReportValidCB | Fact_SnapshotCustomer.IsCreditReportValidCB | Financial-customer flag for Client_Balance reports (CB = Client_Balance, NOT CreditBureau). ETL-computed. See §2.3. (Tier 2 - SP_Fact_SnapshotCustomer) (via Fact_SnapshotCustomer) | T2 |
...
| 45 | CashoutFeeIncRedeem | Fact_CustomerAction.Commission | Commission WHERE ActionTypeID IN (30) | T2 |
