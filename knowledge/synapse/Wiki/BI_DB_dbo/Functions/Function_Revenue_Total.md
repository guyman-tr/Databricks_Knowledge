...
| 2 | DateID | BI_DB_DDR_Fact_Revenue_Generating_Actions.DateID; Function_Revenue_StakingFee.DateID | Direct (UNION) | T2 |
...
| 6 | IsSettled | BI_DB_DDR_Fact_Revenue_Generating_Actions.IsSettled | DDR: direct; Staking: 1 | T5 |
...
| 19 | IsSQF | BI_DB_DDR_Fact_Revenue_Generating_Actions.IsSQF | DDR: direct; Staking: 0 | T5 |
...
| 23 | IsValidCustomer | Fact_SnapshotCustomer.IsValidCustomer; Function_Revenue_StakingFee.IsValidCustomer | Direct (UNION) | T2 |
| 24 | IsCreditReportValidCB | Fact_SnapshotCustomer.IsCreditReportValidCB; Function_Revenue_StakingFee.IsCreditReportValidCB | Direct (UNION) | T2 |
| 25 | CountryID | Fact_SnapshotCustomer.CountryID; Function_Revenue_StakingFee.CountryID | Direct (UNION) | T2 |
| 26 | PlayerLevelID | Fact_SnapshotCustomer.PlayerLevelID; Function_Revenue_StakingFee.PlayerLevelID | Direct (UNION) | T2 |
| 27 | PlayerStatusID | Fact_SnapshotCustomer.PlayerStatusID; Function_Revenue_StakingFee.PlayerStatusID | Direct (UNION) | T2 |
| 28 | RegulationID | Fact_SnapshotCustomer.RegulationID; Function_Revenue_StakingFee.RegulationID | Direct (UNION) | T2 |
| 29 | AccountTypeID | Fact_SnapshotCustomer.AccountTypeID; Function_Revenue_StakingFee.AccountTypeID | Direct (UNION) | T2 |
| 30 | AffiliateID | Fact_SnapshotCustomer.AffiliateID; Function_Revenue_StakingFee.AffiliateID | Direct (UNION) | T2 |
