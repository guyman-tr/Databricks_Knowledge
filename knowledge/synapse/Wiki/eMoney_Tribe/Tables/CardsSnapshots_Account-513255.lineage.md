...
|---|---------------|--------------|---------------|-----------|------|
| 1 | @Id | Tribe.CardsSnapshots_Account-513255 | @Id | Passthrough (CAST uniqueidentifier → varchar(255)) | Tier 3 |
...
| 24 | Created | Tribe.CardsSnapshots_Account-513255 | Created | Passthrough | Tier 3 |
