...
| 18 | ActionTypeID | int | NULL | Transaction direction: 1=ManualPositionOpen (outgoing), 2=CopyPositionOpen (incoming). Hard-coded per CTE block. DWH note: Renamed from ActionTypeId. (Tier 1 — Wallet.TransactionsView) |
