...
ALTER TABLE main.bi_db.gold_sql_dp_prod_we_exw_dbo_exw_c2p_e2e ALTER COLUMN `IsCreditReportValidCB` COMMENT 'Credit bureau report validity flag at conversion time from Fact_SnapshotCustomer. (Tier 2 - SP_EXW_C2F_E2E)';
...
-- == LAST EXECUTION ==
-- Timestamp: 2026-05-03 06:31:08 UTC
