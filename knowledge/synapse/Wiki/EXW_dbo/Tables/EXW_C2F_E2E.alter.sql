...
ALTER TABLE main.bi_db.gold_sql_dp_prod_we_exw_dbo_exw_c2f_e2e ALTER COLUMN `IsCreditReportValidCB` COMMENT 'Financial-customer flag for Client_Balance reports (CB = Client_Balance, NOT CreditBureau); captured at conversion time from Fact_SnapshotCustomer. (Tier 2 - SP_EXW_C2F_E2E)';
