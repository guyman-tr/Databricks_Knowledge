...
| 16 | WalletProviderId | int | NULL | Custody provider: 1=BitGo (97.5% of wallets, multi-sig), 2=CUG (2.5%, MPC-based, newer blockchains like SOL). FK to Dictionary.WalletProvider. (Tier 3 — WalletDB.Wallet.CustomerWalletsView) |
