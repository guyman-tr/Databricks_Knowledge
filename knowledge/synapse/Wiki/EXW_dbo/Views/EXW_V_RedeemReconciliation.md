...
| 17 | InstrumentID | bigint | YES | — | VERIFIED | The trading instrument being redeemed. Renamed from `[etoro - InstrumentID]`. FK to Trade.InstrumentMetaData(InstrumentID). (Tier 1 — Billing.Redeem) |
