# Propagation Scope Report: gold_sql_dp_prod_we_dwh_dbo_v_fact_snapshotcustomer_fromdateid
...
| Property | Value |
|----------|-------|
| UC Name | `main.pii_data.gold_sql_dp_prod_we_dwh_dbo_v_fact_snapshotcustomer_fromdateid` |
| Columns with descriptions | 54 |
| Discovery methods | name_pattern |
| Discovered at | 2026-04-12T14:36:25.488777+00:00 |
...
|--------|------|-----|-----|-----------|---------|-------|
| `main.dwh.gold_sql_dp_prod_we_dwh_dbo_v_fact_snapshotcustomer_fromdateid_masked` | TABLE | 1 | name_pattern | 53 | 0 | 53 |
...
- **Batch 1**: 1 objects, 53 statements — `gold_sql_dp_prod_we_dwh_dbo_v_fact_snapshotcustomer_fromdateid_masked`
