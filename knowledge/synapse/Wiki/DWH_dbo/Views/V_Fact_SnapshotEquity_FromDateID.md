...
| 12 | RealizedEquity | money | Fact_SnapshotEquity.RealizedEquity | Total account value. From History.ActiveCredit.RealizedEquity if non-zero; otherwise TotalCash + TotalPositionsAmount + InProcessCashouts. (Tier 1 — inherited from Fact_SnapshotEquity wiki) |
