"""Deep lineage propagation for DWH_dbo.V_Fact_SnapshotCustomer."""
import sys, os
sys.stdout.reconfigure(line_buffering=True)
sys.path.insert(0, os.path.normpath(os.path.join(os.path.dirname(__file__), "../..")))
import _deep_propagate_lib as lib

SOURCE_UC = "main.pii_data.gold_sql_dp_prod_we_dwh_dbo_v_fact_snapshotcustomer"
SOURCE_SYNAPSE = "DWH_dbo.V_Fact_SnapshotCustomer"
OBJECT_DIR = os.path.dirname(os.path.abspath(__file__))
OBJECT_NAME = "V_Fact_SnapshotCustomer"
