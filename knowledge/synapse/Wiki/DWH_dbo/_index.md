...
| **Schema** | DWH_dbo |
| **Total Objects** | 379 |
| **Active (to document)** | 131 (110 tables, 21 views) |
| **Blacklisted** | 246 |
| **Documented** | 0 (0%) |
| **Skipped** | 2 |
...
Batch 1 will be planned on next run.

## Completed Batches

_(None — reset after pipeline fix)_
...
| DWH_dbo.Dim_Customer | - | Pending |
| DWH_dbo.Dim_CustomerChangeType | - | Pending |
| DWH_dbo.Dim_Desk | - | Pending |
| DWH_dbo.Dim_DocumentStatus | - | Pending |
| DWH_dbo.Dim_EvMatchStatus | - | Pending |
| DWH_dbo.Dim_ExchangeInfo | - | Pending |
| DWH_dbo.Dim_ExecutionOperationType | - | Pending |
| DWH_dbo.Dim_ExtendedUserField | - | Pending |
| DWH_dbo.Dim_FTDPlatform | - | Pending |
| DWH_dbo.Dim_FeeOperationTypes | - | Pending |
| DWH_dbo.Dim_Fund | - | Pending |
| DWH_dbo.Dim_FundType | - | Pending |
| DWH_dbo.Dim_FundingType | - | Pending |
| DWH_dbo.Dim_Funnel | - | Pending |
| DWH_dbo.Dim_GuruStatus | - | Pending |
| DWH_dbo.Dim_HistorySplitRatio | - | Pending |
| DWH_dbo.Dim_Instrument | - | Pending |
| DWH_dbo.Dim_Instrument_Snapshot | - | Pending |
| DWH_dbo.Dim_Label | - | Pending |
| DWH_dbo.Dim_Language | - | Pending |
| DWH_dbo.Dim_Manager | - | Pending |
...
| DWH_dbo.Dim_PEPStatus | - | Pending |
| DWH_dbo.Dim_PaymentStatus | - | Pending |
| DWH_dbo.Dim_PendingClosureStatus | - | Pending |
| DWH_dbo.Dim_PhoneVerified | - | Pending |
| DWH_dbo.Dim_Platform | - | Pending |
| DWH_dbo.Dim_PlatformType | - | Pending |
| DWH_dbo.Dim_PlayerLevel | - | Pending |
| DWH_dbo.Dim_PlayerStatus | - | Pending |
| DWH_dbo.Dim_PlayerStatusReasons | - | Pending |
| DWH_dbo.Dim_PlayerStatusSubReasons | - | Pending |
| DWH_dbo.Dim_Position | - | Pending |
| DWH_dbo.Dim_PositionChangeLog | - | Pending |
| DWH_dbo.Dim_PositionHedgeServerChangeLog | - | Pending |
| DWH_dbo.Dim_Position_Account_Statement_AmountInUnitsDecimal | - | Pending |
| DWH_dbo.Dim_Position_Account_Statement_NetProfit | - | Pending |
| DWH_dbo.Dim_Product | - | Pending |
| DWH_dbo.Dim_Range | - | Pending |
| DWH_dbo.Dim_RedeemReason | - | Pending |
| DWH_dbo.Dim_RedeemStatus | - | Pending |
| DWH_dbo.Dim_Regulation | - | Pending |
| DWH_dbo.Dim_RiskClassification | - | Pending |
| DWH_dbo.Dim_RiskManagementStatus | - | Pending |
| DWH_dbo.Dim_RiskStatus | - | Pending |
| DWH_dbo.Dim_ScreeningStatus | - | Pending |
| DWH_dbo.Dim_SocialNetwork | - | Pending |
| DWH_dbo.Dim_State_and_Province | - | Pending |
| DWH_dbo.Dim_ThreeDsResponseTypes | - | Pending |
| DWH_dbo.Dim_VerificationLevel | - | Pending |
| DWH_dbo.Dim_VerificationStatus | - | Pending |
| DWH_dbo.Dim_WorldCheck | - | Pending |
...
| Object | Quality | Status |
|--------|---------|--------|
| DWH_dbo.Dim_Instrument_Correlation | - | Pending |
| DWH_dbo.Dim_Instrument_Correlation_UnionedPartitions | - | Pending |
| DWH_dbo.VU_FactBilling_ForBigQuery | - | Pending |
| DWH_dbo.V_Customers | - | Pending |
| DWH_dbo.V_Dim_Customer | - | Pending |
| DWH_dbo.V_Dim_Date | - | Pending |
| DWH_dbo.V_Dim_Date_For_DWHRep | - | Pending |
| DWH_dbo.V_Dim_Instrument_Correlation | - | Pending |
| DWH_dbo.V_Dim_Instrument_Correlation_Test_Full | - | Pending |
| DWH_dbo.V_FCA_NumOfLogins_mean_1q | - | Pending |
| DWH_dbo.V_Fact_CustomerUnrealized_PnL_For_DWH_Rep | - | Pending |
| DWH_dbo.V_Fact_RegulationTransfer | - | Pending |
| DWH_dbo.V_Fact_SnapshotCustomer | - | Pending |
| DWH_dbo.V_Fact_SnapshotCustomer_FromDateID | - | Pending |
| DWH_dbo.V_Fact_SnapshotEquity | - | Pending |
| DWH_dbo.V_Fact_SnapshotEquity_ForDWHRep | - | Pending |
| DWH_dbo.V_Fact_SnapshotEquity_FromDateID | - | Pending |
| DWH_dbo.V_Liabilities | - | Pending |
| DWH_dbo.V_M2M_Date_DateRange | - | Pending |
| DWH_dbo.Vw_STS_User_Operations_Data_History | - | Pending |
| DWH_dbo.v_Dim_Mirror | - | Pending |
