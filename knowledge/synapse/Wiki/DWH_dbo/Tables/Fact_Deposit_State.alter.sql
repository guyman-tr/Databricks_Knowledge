...
-- ---------------------------------------------------------------------------
-- 3. COLUMN COMMENTS (reference only)
-- ---------------------------------------------------------------------------
...
-- ALTER TABLE _Not found in generic pipeline mapping - custom Billing pipeline_
-- ALTER COLUMN ExchangeFee COMMENT 'Exchange fee indicator; CS deposit conversion guidance references fee in PIPs and exchange fee in USD alongside base vs effective rate. (Tier 4 - Confluence, Deposit conversion fee)';
...
-- ALTER TABLE _Not found in generic pipeline mapping - custom Billing pipeline_
-- ALTER COLUMN PIPsInUSD COMMENT 'PIP in USD - finance definition: conversion-fee revenue in USD (original amount x spread between base and effective rate). (Tier 4 - Confluence, Conversion fee Revenue Calculation)';
...
-- ---------------------------------------------------------------------------
-- 4. COLUMN PII TAGS (reference only)
-- ---------------------------------------------------------------------------
