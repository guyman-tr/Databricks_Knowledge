...
ALTER TABLE main.dwh.gold_sql_dp_prod_we_dwh_dbo_dim_billingdepot ALTER COLUMN FundingTypeID COMMENT 'Payment method type (e.g., 1=CreditCard, 2=WireTransfer, 6=Neteller, 8=MoneyBookers/Skrill). References Dictionary.FundingType. 38 distinct values across 163 depots. (Tier 1 - upstream wiki, Billing.Depot)';
