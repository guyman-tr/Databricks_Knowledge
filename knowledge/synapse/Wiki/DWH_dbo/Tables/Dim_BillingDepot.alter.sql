...
ALTER TABLE main.dwh.gold_sql_dp_prod_we_dwh_dbo_dim_billingdepot ALTER COLUMN FundingTypeID COMMENT 'Payment method type (e.g., 1=CreditCard, 6=Wire, 7=PayPal). References Dictionary.FundingType. 38 distinct values across 163 depots.';
