...
-- UC Target:    main.dwh.gold_sql_dp_prod_we_dwh_dbo_dim_instrument_snapshot (see _generic_pipeline_mapping.json generic_id=1861)
...
-- 1. TABLE COMMENT
-- ---------------------------------------------------------------------------
ALTER TABLE main.dwh.gold_sql_dp_prod_we_dwh_dbo_dim_instrument_snapshot
SET TBLPROPERTIES (
