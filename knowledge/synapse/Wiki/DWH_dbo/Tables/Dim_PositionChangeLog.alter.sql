...
ALTER TABLE main.dwh.gold_sql_dp_prod_we_dwh_dbo_dim_positionchangelog ALTER COLUMN ChangeTypeID COMMENT 'Type of change event. Known codes from SP usage: 0=Initial open, 1=Invested-amount change, 11=Partial-close child, 12=Partial close. Codes 2, 5, 13 are unverified. No official lookup table in DWH.';
