...
ALTER TABLE main.dwh.gold_sql_dp_prod_we_dwh_dbo_dim_campaign ALTER COLUMN Code COMMENT 'Unique public-facing campaign code (e.g., "20coupon", "freecopyref"). The identifier customers enter at registration. UNIQUE index. Auto-generated 6-char random string if not supplied. (Tier 1 - BackOffice.Campaign)';
