...
ALTER TABLE main.dwh.gold_sql_dp_prod_we_dwh_dbo_dim_countrybin ALTER COLUMN MinAmountFor3ds COMMENT 'Minimum amount that triggers 3DS check. NULL = no minimum. (Tier 1 - Dictionary.CountryBin6)';
