...
ALTER TABLE main.dwh.gold_sql_dp_prod_we_dwh_dbo_dim_countrybin ALTER COLUMN CardTypeID COMMENT 'FK to DWH_dbo.Dim_CardType (if exists). Card network/type: 1=Visa, 2=Mastercard, 13=Unknown/other. Used in deposit routing and reporting. (Tier 1 - Dictionary.CountryBin6 upstream wiki)';
