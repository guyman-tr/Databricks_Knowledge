...
ALTER TABLE main.dwh.gold_sql_dp_prod_we_dwh_dbo_dim_bonustype ALTER COLUMN IsActive COMMENT 'Whether this bonus type is still in active use. 0=deprecated (should not be assigned to new bonuses). Active=0 types: 17=Refill-Negative Balance, 23=Championship Winner Demo. All other 68 types are IsActive=1 (Tier 1 - BackOffice.BonusType)';
