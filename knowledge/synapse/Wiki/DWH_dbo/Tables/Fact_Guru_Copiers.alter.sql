...
ALTER TABLE main.dwh.gold_sql_dp_prod_we_dwh_dbo_fact_guru_copiers ALTER COLUMN Investment COMMENT 'Sum of investment amounts across all copy relationships for this copier on this day. Aggregated from Ext_FGC_Guru_Copiers, which is loaded from [DWH_staging].[etoro_History_GuruCopiers].';
