...
ALTER TABLE main.bi_db.gold_sql_dp_prod_we_dwh_dbo_fact_deposit_fees ALTER COLUMN Threedsresponse COMMENT '3D Secure authentication outcome resolved from Dictionary.ThreeDsResponseTypes (e.g., Unspecified, Success, Failed Authentication, Skipped 3ds). Passthrough from BackOffice.BillingDepositsPCIVersion.';
