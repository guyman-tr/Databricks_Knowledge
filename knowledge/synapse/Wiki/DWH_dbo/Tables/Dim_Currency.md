...
| 2 | CurrencyTypeID | int | NO | FK to Dim_CurrencyType. Asset class identifier: 1=Forex (176), 2=Commodity (412), 4=Indices (167), 5=Stocks (8,632), 6=ETF (652), 10=Crypto (630). Determines trading rules, leverage limits, and settlement eligibility. |
