...
ALTER TABLE main.dwh.gold_sql_dp_prod_we_dwh_dbo_fact_billingwithdraw ALTER COLUMN CashoutModeID COMMENT 'Mode of withdrawal execution: 1=Auto Create (75.2%), NULL=legacy (17%), 2=Mass Auto Create (4%), 0=Manual (3.8%). FK to Dim_CashoutMode. (Tier 1 - Billing.WithdrawToFunding)';
