...
| 4 | IsSettled | varchar(20) | YES | Settlement type text: 'Real' for real-asset positions (HedgeServerID IN (9,102,112,125,126)), 'CFD' for contract-for-difference positions. This is a string ('Real'/'CFD'), unlike the integer (0/1) in Dim_Position. Derived from HedgeServerID classification in both LP and client data. (Tier 2 — SP_HedgeCost) |
