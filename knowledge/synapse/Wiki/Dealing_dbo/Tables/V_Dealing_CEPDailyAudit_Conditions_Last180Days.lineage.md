# Lineage Map — Dealing_dbo.V_Dealing_CEPDailyAudit_Conditions_Last180Days
...
All columns pass through unchanged from `Dealing_dbo.Dealing_CEPDailyAudit_Conditions`. No transformations. See [Dealing_CEPDailyAudit_Conditions.md](Dealing_CEPDailyAudit_Conditions.md) for full column definitions.
