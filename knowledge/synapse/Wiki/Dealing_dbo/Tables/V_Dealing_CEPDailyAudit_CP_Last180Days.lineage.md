# Lineage Map — Dealing_dbo.V_Dealing_CEPDailyAudit_CP_Last180Days
...
All columns pass through unchanged from `Dealing_dbo.Dealing_CEPDailyAudit_CP`. No transformations. See [Dealing_CEPDailyAudit_CP.md](Dealing_CEPDailyAudit_CP.md) for full column definitions.
