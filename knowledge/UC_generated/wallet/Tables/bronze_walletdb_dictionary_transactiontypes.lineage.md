# Column Lineage: main.wallet.bronze_walletdb_dictionary_transactiontypes
...
> `_discovery/column_lineage/bronze_walletdb_dictionary_transactiontypes.json` for upstream resolution.
