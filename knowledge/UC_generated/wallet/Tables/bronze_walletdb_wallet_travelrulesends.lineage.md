# Column Lineage: main.wallet.bronze_walletdb_wallet_travelrulesends
...
> `_discovery/column_lineage/bronze_walletdb_wallet_travelrulesends.json` for upstream resolution.
...
| 3 | `CorrelationId` | `—` | `—` | `runtime_lineage` |
| 4 | `TravelRuleAddressId` | `—` | `—` | `runtime_lineage` |
