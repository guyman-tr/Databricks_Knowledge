# Column Lineage: main.wallet.bronze_walletdb_wallet_senttransactionreplaces
...
> `_discovery/column_lineage/bronze_walletdb_wallet_senttransactionreplaces.json` for upstream resolution.
...
| 3 | `OldBlockchainTransactionId` | `—` | `—` | `runtime_lineage` |
| 4 | `NewBlockchainTransactionId` | `—` | `—` | `runtime_lineage` |
