# Column Lineage: main.wallet.bronze_walletdb_dictionary_requesttypes
...
> `_discovery/column_lineage/bronze_walletdb_dictionary_requesttypes.json` for upstream resolution.
