# Column Lineage: main.wallet.bronze_walletdb_dictionary_cryptocoinproviders
...
> `_discovery/column_lineage/bronze_walletdb_dictionary_cryptocoinproviders.json` for upstream resolution.
...
| 3 | `WalletProviderId` | `—` | `—` | `runtime_lineage` |
