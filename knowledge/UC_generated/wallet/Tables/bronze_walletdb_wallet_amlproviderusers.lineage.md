# Column Lineage: main.wallet.bronze_walletdb_wallet_amlproviderusers
...
> `_discovery/column_lineage/bronze_walletdb_wallet_amlproviderusers.json` for upstream resolution.
...
| 2 | `AmlProviderId` | `—` | `—` | `runtime_lineage` |
| 3 | `Gcid` | `—` | `—` | `runtime_lineage` |
| 4 | `ProviderUserId` | `—` | `—` | `runtime_lineage` |
