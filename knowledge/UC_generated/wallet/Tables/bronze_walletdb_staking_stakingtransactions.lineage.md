# Column Lineage: main.wallet.bronze_walletdb_staking_stakingtransactions
...
> `_discovery/column_lineage/bronze_walletdb_staking_stakingtransactions.json` for upstream resolution.
...
| 2 | `ExternalStakingAddress` | `—` | `—` | `runtime_lineage` |
| 3 | `StakingId` | `—` | `—` | `runtime_lineage` |
| 4 | `EtoroFee` | `—` | `—` | `runtime_lineage` |
| 5 | `BlockchainEstFee` | `—` | `—` | `runtime_lineage` |
| 6 | `Occurred` | `—` | `—` | `runtime_lineage` |
