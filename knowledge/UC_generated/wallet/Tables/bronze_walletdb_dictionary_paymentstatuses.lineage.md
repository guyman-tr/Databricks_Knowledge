# Column Lineage: main.wallet.bronze_walletdb_dictionary_paymentstatuses
...
> `_discovery/column_lineage/bronze_walletdb_dictionary_paymentstatuses.json` for upstream resolution.
