# Column Lineage: main.wallet.bronze_walletdb_wallet_cryptomarketratesmappings
...
> `_discovery/column_lineage/bronze_walletdb_wallet_cryptomarketratesmappings.json` for upstream resolution.
