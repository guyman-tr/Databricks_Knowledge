# Column Lineage: main.wallet.bronze_walletdb_wallet_blockchaincryptos
...
> `_discovery/column_lineage/bronze_walletdb_wallet_blockchaincryptos.json` for upstream resolution.
...
| 4 | `CryptoCoinProviderId` | `—` | `—` | `runtime_lineage` |
| 5 | `AddressPattern` | `—` | `—` | `runtime_lineage` |
