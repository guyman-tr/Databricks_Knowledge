# Column Lineage: main.wallet.bronze_walletdb_dictionary_conversionstatuses
...
> `_discovery/column_lineage/bronze_walletdb_dictionary_conversionstatuses.json` for upstream resolution.
