# Column Lineage: main.wallet.bronze_walletbalancesreportdb_wallet_financereports
...
> `_discovery/column_lineage/bronze_walletbalancesreportdb_wallet_financereports.json` for upstream resolution.
...
| 2 | `StartTime` | `—` | `—` | `runtime_lineage` |
| 3 | `EndTime` | `—` | `—` | `runtime_lineage` |
