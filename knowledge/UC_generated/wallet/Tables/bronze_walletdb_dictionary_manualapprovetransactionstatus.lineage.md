# Column Lineage: main.wallet.bronze_walletdb_dictionary_manualapprovetransactionstatus
...
> `_discovery/column_lineage/bronze_walletdb_dictionary_manualapprovetransactionstatus.json` for upstream resolution.
