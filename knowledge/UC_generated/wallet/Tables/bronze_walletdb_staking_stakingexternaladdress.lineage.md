# Column Lineage: main.wallet.bronze_walletdb_staking_stakingexternaladdress
...
> `_discovery/column_lineage/bronze_walletdb_staking_stakingexternaladdress.json` for upstream resolution.
...
| 2 | `ExternalAddress` | `—` | `—` | `runtime_lineage` |
| 3 | `CryptoId` | `—` | `—` | `runtime_lineage` |
| 4 | `IsActive` | `—` | `—` | `runtime_lineage` |
| 5 | `EffectiveFrom` | `—` | `—` | `runtime_lineage` |
