# Column Lineage: main.wallet.bronze_walletdb_dictionary_transactionstatus
...
> `_discovery/column_lineage/bronze_walletdb_dictionary_transactionstatus.json` for upstream resolution.
