# Column Lineage: main.wallet.bronze_walletdb_dictionary_checksumtypes
...
> `_discovery/column_lineage/bronze_walletdb_dictionary_checksumtypes.json` for upstream resolution.
