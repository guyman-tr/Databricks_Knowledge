# Column Lineage: main.etoro_kpi.crm_case_v

| Property | Value |
|----------|-------|
| **UC Object** | `main.etoro_kpi.crm_case_v` |
| **Object Type** | `VIEW` |
| **Source** | `knowledge\UC_generated\etoro_kpi\_discovery\source_code\crm_case_v.sql` |
| **Column-lineage cache** | `knowledge\UC_generated\etoro_kpi\_discovery\column_lineage\crm_case_v.json` (rows: 57, mismatches: 8) |
...
| `main.crm.gold_crm_case_tiny` | JOIN / referenced | ✗ `(no wiki found)` |
...
main.crm.silver_crm_case   ←── primary upstream
  ...
  + main.crm.gold_crm_case_tiny   (JOIN)
        │
        ▼
...
| `IsDeflected` | — | `main.crm.gold_crm_case_tiny.case_id_18__c` | ERROR |
