---
object_fqn: main.etoro_kpi.ddr_customer_dailystatus
object_type: VIEW
...
writer:
  ...
  path: knowledge/UC_generated/etoro_kpi/_discovery/source_code/ddr_customer_dailystatus.sql
  source_code_snapshot: knowledge/UC_generated/etoro_kpi/_discovery/source_code/ddr_customer_dailystatus.sql
concept_count: 0
formula_count: 9
tier_breakdown:
  tier1_columns: 0
...
> View in `main.etoro_kpi`. 0 business concept(s) in §2; 9 of 9 columns documented from anchored evidence; 0 unverified (see sidecar).
...
| **Created** | Mon May 04 06:00:21 UTC 2026 |

---

## 1. Business Meaning

`ddr_customer_dailystatus` is a view in `main.etoro_kpi`. No discriminator concepts were detected in the source — see §2 for the transform pattern breakdown.
...
Of its 9 columns: 0 inherit byte-for-byte from upstream wikis (Tier 1), 0 are formula-assembled from cached source code (Tier 2 — see §4 for the formula and §2 for the named concept), 9 are null-with-provenance (Tier N — terminal-no-wiki upstream).
...
| 1 | FromDateID | INT | YES | Source: `main.etoro_kpi_prep.gold_de_user_dim_ddr_customer_dailystatus_scd.FromDateID`. Upstream wiki is in-scope but not yet authored as of 2026-05-19; this column will be re-resolved when the upstream wiki is generated (Tier N — blocked-on-upstream `main.etoro_kpi_prep.gold_de_user_dim_ddr_customer_dailystatus_scd`). |
| 2 | ToDateID | INT | YES | Source: `main.etoro_kpi_prep.gold_de_user_dim_ddr_customer_dailystatus_scd.ToDateID`. Upstream wiki is in-scope but not yet authored as of 2026-05-19; this column will be re-resolved when the upstream wiki is generated (Tier N — blocked-on-upstream `main.etoro_kpi_prep.gold_de_user_dim_ddr_customer_dailystatus_scd`). |
| 3 | IsFunded | INT | YES | Source: `main.etoro_kpi_prep.gold_de_user_dim_ddr_customer_dailystatus_scd.IsFunded`. Upstream wiki is in-scope but not yet authored as of 2026-05-19; this column will be re-resolved when the upstream wiki is generated (Tier N — blocked-on-upstream `main.etoro_kpi_prep.gold_de_user_dim_ddr_customer_dailystatus_scd`). |
| 4 | IsActiveTrade | INT | YES | Source: `main.etoro_kpi_prep.gold_de_user_dim_ddr_customer_dailystatus_scd.ActiveTraded`. Upstream wiki is in-scope but not yet authored as of 2026-05-19; this column will be re-resolved when the upstream wiki is generated (Tier N — blocked-on-upstream `main.etoro_kpi_prep.gold_de_user_dim_ddr_customer_dailystatus_scd`). |
| 5 | BalanceOnly | INT | YES | Source: `main.etoro_kpi_prep.gold_de_user_dim_ddr_customer_dailystatus_scd.BalanceOnlyAccount`. Upstream wiki is in-scope but not yet authored as of 2026-05-19; this column will be re-resolved when the upstream wiki is generated (Tier N — blocked-on-upstream `main.etoro_kpi_prep.gold_de_user_dim_ddr_customer_dailystatus_scd`). |
| 6 | PortfolioOnly | INT | YES | Source: `main.etoro_kpi_prep.gold_de_user_dim_ddr_customer_dailystatus_scd.Portfolio_Only`. Upstream wiki is in-scope but not yet authored as of 2026-05-19; this column will be re-resolved when the upstream wiki is generated (Tier N — blocked-on-upstream `main.etoro_kpi_prep.gold_de_user_dim_ddr_customer_dailystatus_scd`). |
| 7 | IsChurn | INT | YES | Source: `main.etoro_kpi_prep.gold_de_user_dim_ddr_customer_dailystatus_scd.IsChurned`. Upstream wiki is in-scope but not yet authored as of 2026-05-19; this column will be re-resolved when the upstream wiki is generated (Tier N — blocked-on-upstream `main.etoro_kpi_prep.gold_de_user_dim_ddr_customer_dailystatus_scd`). |
| 8 | IsWinback | INT | YES | Source: `main.etoro_kpi_prep.gold_de_user_dim_ddr_customer_dailystatus_scd.IsWinBack`. Upstream wiki is in-scope but not yet authored as of 2026-05-19; this column will be re-resolved when the upstream wiki is generated (Tier N — blocked-on-upstream `main.etoro_kpi_prep.gold_de_user_dim_ddr_customer_dailystatus_scd`). |
...
*Generated: 2026-05-19 | Concepts: 0 | Formulas: 9 | Tiers: 0 T1, 0 T2, 0 T3, 0 T4, 0 T5, 9 TN, 0 U | Elements: 9/9 | Source: view_definition*
