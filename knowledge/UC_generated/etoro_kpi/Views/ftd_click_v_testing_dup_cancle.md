---
object_fqn: main.etoro_kpi.ftd_click_v_testing_dup_cancle
object_type: VIEW
...
writer:
  ...
  path: knowledge/UC_generated/etoro_kpi/_discovery/source_code/ftd_click_v_testing_dup_cancle.sql
  source_code_snapshot: knowledge/UC_generated/etoro_kpi/_discovery/source_code/ftd_click_v_testing_dup_cancle.sql
concept_count: 1
formula_count: 9
tier_breakdown:
  tier1_columns: 0
...
# ftd_click_v_testing_dup_cancle
...
| Property | Value |
|----------|-------|
| **UC Object** | `main.etoro_kpi.ftd_click_v_testing_dup_cancle` |
| **Type** | VIEW |
| **Format** | n/a |
...
| **Created** | Tue Mar 10 16:50:38 UTC 2026 |

---

## 1. Business Meaning

`ftd_click_v_testing_dup_cancle` is a view in `main.etoro_kpi` that composes 1 CASE-based classifier flag(s) computed from upstream IDs.
...
**Evidence**: `knowledge/UC_generated/etoro_kpi/_discovery/source_code/ftd_click_v_testing_dup_cancle.sql` etoro_kpi.sql L44-L50
...
main.etoro_kpi.de_output_ftd_click
        │
        ▼
main.etoro_kpi.ftd_click_v_testing_dup_cancle   ←── this object
```
