# Column Lineage: main.etoro_kpi.crm_user_v

| Property | Value |
|----------|-------|
| **UC Object** | `main.etoro_kpi.crm_user_v` |
| **Object Type** | `VIEW` |
| **Source** | `knowledge\UC_generated\etoro_kpi\_discovery\source_code\crm_user_v.sql` |
| **Column-lineage cache** | `knowledge\UC_generated\etoro_kpi\_discovery\column_lineage\crm_user_v.json` (rows: 21, mismatches: 5) |
...
| 12 | `Manager_BO_User_ID` | `main.crm.silver_crm_user` | `BO_User_ID__c` | `join_enriched` | — | m.BO_User_ID__c AS Manager_BO_User_ID |
...
| 20 | `RM_UserId` | `—` | `RM_UserId` | `join_enriched` | — | rc.RM_UserId AS RM_UserId |
