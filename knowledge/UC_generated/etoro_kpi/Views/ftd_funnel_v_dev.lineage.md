# Column Lineage: main.etoro_kpi.ftd_funnel_v_dev

| Property | Value |
|----------|-------|
| **UC Object** | `main.etoro_kpi.ftd_funnel_v_dev` |
| **Object Type** | `MATERIALIZED_VIEW` |
| **Source** | `knowledge\UC_generated\etoro_kpi\_discovery\source_code\ftd_funnel_v_dev.sql` |
| **Column-lineage cache** | `knowledge\UC_generated\etoro_kpi\_discovery\column_lineage\ftd_funnel_v_dev.json` (rows: 60, mismatches: 20) |
...
| 58 | `FirstAction` | `main.bi_db.gold_sql_dp_prod_we_bi_db_dbo_bi_db_first5actions` | `FirstAction` | `join_enriched` | — | f5a.FirstAction |
| 59 | `FirstInstrument` | `main.bi_db.gold_sql_dp_prod_we_bi_db_dbo_bi_db_first5actions` | `FirstInstrument` | `join_enriched` | — | f5a.FirstInstrument |
| 60 | `FirstActionDate` | `main.bi_db.gold_sql_dp_prod_we_bi_db_dbo_bi_db_first5actions` | `FirstActionDate` | `join_enriched` | — | f5a.FirstActionDate |

## Cross-check vs system.access.column_lineage

- Total target columns: **60**
- OK: **40**, WARN: **0**, ERROR: **20**, INFO: **0**  ⚠
...
- Computed/added columns vs primary: **41**
...
- `LEFT JOIN` — LEFT JOIN main.bi_db.gold_sql_dp_prod_we_bi_db_dbo_bi_db_first5actions AS f5a ON dc.RealCID = f5a.CID
