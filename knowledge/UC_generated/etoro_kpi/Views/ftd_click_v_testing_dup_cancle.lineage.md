# Column Lineage: main.etoro_kpi.ftd_click_v_testing_dup_cancle

| Property | Value |
|----------|-------|
| **UC Object** | `main.etoro_kpi.ftd_click_v_testing_dup_cancle` |
| **Object Type** | `VIEW` |
| **Source** | `knowledge\UC_generated\etoro_kpi\_discovery\source_code\ftd_click_v_testing_dup_cancle.sql` |
| **Column-lineage cache** | `knowledge\UC_generated\etoro_kpi\_discovery\column_lineage\ftd_click_v_testing_dup_cancle.json` (rows: 9, mismatches: 7) |
