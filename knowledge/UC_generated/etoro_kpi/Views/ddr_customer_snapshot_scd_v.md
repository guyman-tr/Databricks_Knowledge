---
object_fqn: main.etoro_kpi.ddr_customer_snapshot_scd_v
object_type: VIEW
...
writer:
  ...
  path: knowledge/UC_generated/etoro_kpi/_discovery/source_code/ddr_customer_snapshot_scd_v.sql
  source_code_snapshot: knowledge/UC_generated/etoro_kpi/_discovery/source_code/ddr_customer_snapshot_scd_v.sql
concept_count: 14
formula_count: 44
tier_breakdown:
  tier1_columns: 17
...
> View in `main.etoro_kpi`. 14 business concept(s) in §2; 44 of 44 columns documented from anchored evidence; 0 unverified (see sidecar).
...
| **Created** | Wed May 13 07:16:24 UTC 2026 |

---

## 1. Business Meaning

`ddr_customer_snapshot_scd_v` is a view in `main.etoro_kpi` that composes 1 CASE-based classifier flag(s) computed from upstream IDs, 13 JOIN-enriched dimension lookup(s).
...
Of its 44 columns: 17 inherit byte-for-byte from upstream wikis (Tier 1), 27 are formula-assembled from cached source code (Tier 2 — see §4 for the formula and §2 for the named concept), 0 are null-with-provenance (Tier N — terminal-no-wiki upstream).
...
**Rules**:
- `GuruStatusID > 1`
**Evidence**: `knowledge/UC_generated/etoro_kpi/_discovery/source_code/ddr_customer_snapshot_scd_v.sql` etoro_kpi.sql L34-L37
...
**Evidence**: `knowledge/UC_generated/etoro_kpi/_discovery/source_code/ddr_customer_snapshot_scd_v.sql` L57
...
**Evidence**: `knowledge/UC_generated/etoro_kpi/_discovery/source_code/ddr_customer_snapshot_scd_v.sql` L59
...
**Evidence**: `knowledge/UC_generated/etoro_kpi/_discovery/source_code/ddr_customer_snapshot_scd_v.sql` L61
...
**Evidence**: `knowledge/UC_generated/etoro_kpi/_discovery/source_code/ddr_customer_snapshot_scd_v.sql` L63
...
**Evidence**: `knowledge/UC_generated/etoro_kpi/_discovery/source_code/ddr_customer_snapshot_scd_v.sql` L65,L85
...
**Evidence**: `knowledge/UC_generated/etoro_kpi/_discovery/source_code/ddr_customer_snapshot_scd_v.sql` L67,L83
...
**Evidence**: `knowledge/UC_generated/etoro_kpi/_discovery/source_code/ddr_customer_snapshot_scd_v.sql` L69
...
**Evidence**: `knowledge/UC_generated/etoro_kpi/_discovery/source_code/ddr_customer_snapshot_scd_v.sql` L71
...
**Evidence**: `knowledge/UC_generated/etoro_kpi/_discovery/source_code/ddr_customer_snapshot_scd_v.sql` L73
...
**Evidence**: `knowledge/UC_generated/etoro_kpi/_discovery/source_code/ddr_customer_snapshot_scd_v.sql` L75
...
**Evidence**: `knowledge/UC_generated/etoro_kpi/_discovery/source_code/ddr_customer_snapshot_scd_v.sql` L77
...
**Evidence**: `knowledge/UC_generated/etoro_kpi/_discovery/source_code/ddr_customer_snapshot_scd_v.sql` L79
...
**Evidence**: `knowledge/UC_generated/etoro_kpi/_discovery/source_code/ddr_customer_snapshot_scd_v.sql` L81
...
| 37 | CitizenshipCountryID | INT | YES | Direct passthrough from upstream. Formula: `CitizenshipCountryID`. (Tier 2 — from `main.dwh.gold_sql_dp_prod_we_dwh_dbo_dim_customer_masked`) |
| 38 | CitizenshipCountry | STRING | YES | Direct passthrough from upstream. Formula: `Name`. (Tier 2 — from `main.dwh.gold_sql_dp_prod_we_dwh_dbo_dim_country`) |
| 39 | AffiliateID | INT | YES | Direct passthrough from upstream. Formula: `AffiliateID`. (Tier 2 — from `main.dwh.gold_sql_dp_prod_we_dwh_dbo_dim_customer_masked`) |
| 40 | IsValidCustomer | INT | YES | Direct passthrough from upstream. Formula: `IsValidCustomer`. (Tier 2 — from `main.dwh.gold_sql_dp_prod_we_dwh_dbo_v_fact_snapshotcustomer_fromdateid_masked`) |
| 41 | IsDepositor | BOOLEAN | YES | 1 if the customer has made at least one real-money deposit (FTD detected). Set when CID appears in Ext_FSC_Customer_FirstTimeDeposits. Never reverted to 0 once set. DEFAULT 0. (Tier 2 — via Fact_SnapshotCustomer) |
| 42 | FirstDepositDate | TIMESTAMP | YES | Direct passthrough from upstream. Formula: `FirstDepositDate`. (Tier 2 — from `main.dwh.gold_sql_dp_prod_we_dwh_dbo_dim_customer_masked`) |
| 43 | RegisteredReal | TIMESTAMP | YES | Direct passthrough from upstream. Formula: `RegisteredReal`. (Tier 2 — from `main.dwh.gold_sql_dp_prod_we_dwh_dbo_dim_customer_masked`) |
...
*Generated: 2026-05-19 | Concepts: 14 | Formulas: 44 | Tiers: 17 T1, 27 T2, 0 T3, 0 T4, 0 T5, 0 TN, 0 U | Elements: 44/44 | Source: view_definition*
