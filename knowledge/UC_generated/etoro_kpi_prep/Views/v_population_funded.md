---
object_fqn: main.etoro_kpi_prep.v_population_funded
object_type: VIEW
...
writer:
  ...
  path: knowledge/UC_generated/etoro_kpi_prep/_discovery/source_code/v_population_funded.sql
  source_code_snapshot: knowledge/UC_generated/etoro_kpi_prep/_discovery/source_code/v_population_funded.sql
concept_count: 1
formula_count: 3
tier_breakdown:
  tier1_columns: 0
...
> View in `main.etoro_kpi_prep`. 1 business concept(s) in §2; 3 of 3 columns documented from anchored evidence; 0 unverified (see sidecar).
...
| **Created** | Tue Mar 31 06:17:34 UTC 2026 |

---

## 1. Business Meaning

`v_population_funded` is a view in `main.etoro_kpi_prep` that composes 1 JOIN-enriched dimension lookup(s).
...
**Evidence**: `knowledge/UC_generated/etoro_kpi_prep/_discovery/source_code/v_population_funded.sql` L35
...
|---------|-----------|---------|
| `main.dwh.gold_sql_dp_prod_we_dwh_dbo_dim_customer_masked` | `faop.GCID = dc.GCID` | Lookup via alias `dc` |
...
|---|---------|------|----------|-------------|
| 1 | DateID | INT | YES | Direct passthrough from upstream. Formula: `BalanceDateID`. (Tier 2 — from `main.bi_db.gold_sql_dp_prod_we_emoney_dbo_emoneyclientbalance`) |
...
| 2 | Equity | DECIMAL | YES | Aggregate over upstream rows. Formula: `SUM(a.Equity)`. (Tier 2 — literal) |
...
| `main.etoro_kpi_prep.v_options_aum` | JOIN/UNION | `knowledge/UC_generated/etoro_kpi_prep/Views/v_options_aum.md` |
...
| `main.etoro_kpi_prep.v_population_first_time_funded` | JOIN/UNION | `knowledge/UC_generated/etoro_kpi_prep/Views/v_population_first_time_funded.md` |
...
*Generated: 2026-05-19 | Concepts: 1 | Formulas: 3 | Tiers: 0 T1, 3 T2, 0 T3, 0 T4, 0 T5, 0 TN, 0 U | Elements: 3/3 | Source: view_definition*
