---
object_fqn: main.etoro_kpi_prep.v_trading_volume_positionlevel
object_type: VIEW
...
writer:
  ...
  path: knowledge/UC_generated/etoro_kpi_prep/_discovery/source_code/v_trading_volume_positionlevel.sql
  source_code_snapshot: knowledge/UC_generated/etoro_kpi_prep/_discovery/source_code/v_trading_volume_positionlevel.sql
concept_count: 12
formula_count: 32
tier_breakdown:
  tier1_columns: 0
...
# v_trading_volume_positionlevel
...
| Property | Value |
|----------|-------|
| **UC Object** | `main.etoro_kpi_prep.v_trading_volume_positionlevel` |
| **Type** | VIEW |
| **Format** | n/a |
...
| **Created** | Sun Apr 12 15:11:47 UTC 2026 |

---

## 1. Business Meaning

`v_trading_volume_positionlevel` is a view in `main.etoro_kpi_prep` that composes 8 CASE-based classifier flag(s) computed from upstream IDs, 2 JOIN-enriched dimension lookup(s), 2 top-level filter block(s) (settled / status / dedup discriminators).
...
**Evidence**: `knowledge/UC_generated/etoro_kpi_prep/_discovery/source_code/v_trading_volume_positionlevel.sql` etoro_kpi_prep.sql L17-L17
...
- `CloseDateID > 0`
- `MirrorID > 0`
**Evidence**: `knowledge/UC_generated/etoro_kpi_prep/_discovery/source_code/v_trading_volume_positionlevel.sql` etoro_kpi_prep.sql L19-L129
**Source(s)**: `main.dwh.dim_position`
...
**Rules**:
- `SettlementTypeID = 5`
**Evidence**: `knowledge/UC_generated/etoro_kpi_prep/_discovery/source_code/v_trading_volume_positionlevel.sql` etoro_kpi_prep.sql L130-L130
**Source(s)**: `main.dwh.dim_position`
...
**Rules**:
- (no explicit predicates / pattern-only concept)
**Evidence**: `knowledge/UC_generated/etoro_kpi_prep/_discovery/source_code/v_trading_volume_positionlevel.sql` etoro_kpi_prep.sql L133-L133
...
**Rules**:
- (no explicit predicates / pattern-only concept)
**Evidence**: `knowledge/UC_generated/etoro_kpi_prep/_discovery/source_code/v_trading_volume_positionlevel.sql` etoro_kpi_prep.sql L134-L134
...
**Rules**:
- (no explicit predicates / pattern-only concept)
**Evidence**: `knowledge/UC_generated/etoro_kpi_prep/_discovery/source_code/v_trading_volume_positionlevel.sql` etoro_kpi_prep.sql L135-L135
...
**Rules**:
- (no explicit predicates / pattern-only concept)
**Evidence**: `knowledge/UC_generated/etoro_kpi_prep/_discovery/source_code/v_trading_volume_positionlevel.sql` etoro_kpi_prep.sql L137-L137
...
**Rules**:
- (no explicit predicates / pattern-only concept)
**Evidence**: `knowledge/UC_generated/etoro_kpi_prep/_discovery/source_code/v_trading_volume_positionlevel.sql` etoro_kpi_prep.sql L138-L138
...
**Evidence**: `knowledge/UC_generated/etoro_kpi_prep/_discovery/source_code/v_trading_volume_positionlevel.sql` L143
...
**Evidence**: `knowledge/UC_generated/etoro_kpi_prep/_discovery/source_code/v_trading_volume_positionlevel.sql` L146
...
**Rules**:
- `OpenDateID > 0`
**Evidence**: `knowledge/UC_generated/etoro_kpi_prep/_discovery/source_code/v_trading_volume_positionlevel.sql` L39
...
**Rules**:
- `CloseDateID > 0`
**Evidence**: `knowledge/UC_generated/etoro_kpi_prep/_discovery/source_code/v_trading_volume_positionlevel.sql` L65
...
... (6 more upstream(s))
        │
        ▼
main.etoro_kpi_prep.v_trading_volume_positionlevel   ←── this object
```
