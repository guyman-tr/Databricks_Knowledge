...
column_count: 6
row_count: null
generated_at: '2026-05-19T12:26:35Z'
upstreams:
...
`v_revenue_cashoutfee_excluderedeem` is a view in `main.etoro_kpi_prep` that composes 1 JOIN-enriched dimension lookup(s).
...
**Evidence**: `knowledge/UC_generated/etoro_kpi_prep/_discovery/source_code/v_revenue_cashoutfee_excluderedeem.sql` L17
