# Column Lineage: main.etoro_kpi_prep.v_revenue_cashoutfee_excluderedeem

| Property | Value |
|----------|-------|
| **UC Object** | `main.etoro_kpi_prep.v_revenue_cashoutfee_excluderedeem` |
| **Object Type** | `VIEW` |
| **Source** | `knowledge\UC_generated\etoro_kpi_prep\_discovery\source_code\v_revenue_cashoutfee_excluderedeem.sql` |
| **Column-lineage cache** | `knowledge\UC_generated\etoro_kpi_prep\_discovery\column_lineage\v_revenue_cashoutfee_excluderedeem.json` (rows: 6, mismatches: 0) |
...
| 5 | `CashoutFeeExcludeRedeem` | `main.dwh.gold_sql_dp_prod_we_dwh_dbo_fact_customeraction` | `Commission` | `rename` | (Tier 1 — Trade.PositionTbl) | fca.Commission AS CashoutFeeExcludeRedeem |
