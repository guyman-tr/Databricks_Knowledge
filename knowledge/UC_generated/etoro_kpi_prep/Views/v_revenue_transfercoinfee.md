---
object_fqn: main.etoro_kpi_prep.v_revenue_transfercoinfee
object_type: VIEW
producer_kind: view_definition
generator: tools/uc_pipelines/generate_wiki.py
object: main.etoro_kpi_prep.v_revenue_transfercoinfee
...
column_count: 6
row_count: null
generated_at: '2026-05-19T12:26:41Z'
upstreams:
...
writer:
  ...
  path: knowledge/UC_generated/etoro_kpi_prep/_discovery/source_code/v_revenue_transfercoinfee.sql
  source_code_snapshot: knowledge/UC_generated/etoro_kpi_prep/_discovery/source_code/v_revenue_transfercoinfee.sql
concept_count: 1
formula_count: 6
tier_breakdown:
  tier1_columns: 3
...
| Property | Value |
|----------|-------|
| **UC Object** | `main.etoro_kpi_prep.v_revenue_transfercoinfee` |
| **Type** | VIEW |
| **Format** | n/a |
...
| **Created** | Sun Apr 12 15:03:55 UTC 2026 |

---

## 1. Business Meaning

`v_revenue_transfercoinfee` is a view in `main.etoro_kpi_prep` that composes 1 JOIN-enriched dimension lookup(s).
...
**Evidence**: `knowledge/UC_generated/etoro_kpi_prep/_discovery/source_code/v_revenue_transfercoinfee.sql` L17
...
| 4 | TransferCoinFee | DECIMAL | YES | Open commission in dollars (`/100` cents conversion on ingest per `Dim_Position` lineage notes). (Tier 1 — Trade.PositionTbl) |
...
main.dwh.gold_sql_dp_prod_we_dwh_dbo_dim_range
        │
        ▼
main.etoro_kpi_prep.v_revenue_transfercoinfee   ←── this object
```
