# Column Lineage: main.bi_db.bronze_walletdb_dictionary_travelrulestatuses
...
> `_discovery/column_lineage/bronze_walletdb_dictionary_travelrulestatuses.json` for upstream resolution.
