# Column Lineage: main.bi_db.bronze_etoro_billing_mapmerchantcodetomid
...
> `_discovery/column_lineage/bronze_etoro_billing_mapmerchantcodetomid.json` for upstream resolution.

## Column Lineage

| # | Element | source_object | source_column | transform |
|---|---------|---------------|---------------|-----------|
| 1 | `RegulationID` | `—` | `—` | `runtime_lineage` |
| 2 | `CurrencyID` | `—` | `—` | `runtime_lineage` |
| 3 | `MerchantCode` | `—` | `—` | `runtime_lineage` |
| 4 | `MID` | `—` | `—` | `runtime_lineage` |
