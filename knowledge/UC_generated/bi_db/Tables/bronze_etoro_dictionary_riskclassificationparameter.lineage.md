# Column Lineage: main.bi_db.bronze_etoro_dictionary_riskclassificationparameter
...
> `_discovery/column_lineage/bronze_etoro_dictionary_riskclassificationparameter.json` for upstream resolution.

## Column Lineage

| # | Element | source_object | source_column | transform |
|---|---------|---------------|---------------|-----------|
| 1 | `RiskClassificationParameterID` | `—` | `—` | `runtime_lineage` |
