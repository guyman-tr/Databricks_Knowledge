# Column Lineage: main.bi_db.bronze_walletdb_dictionary_addressownershipprooftype
...
> `_discovery/column_lineage/bronze_walletdb_dictionary_addressownershipprooftype.json` for upstream resolution.
