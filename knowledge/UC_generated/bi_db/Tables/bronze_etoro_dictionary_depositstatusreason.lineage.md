# Column Lineage: main.bi_db.bronze_etoro_dictionary_depositstatusreason
...
> `_discovery/column_lineage/bronze_etoro_dictionary_depositstatusreason.json` for upstream resolution.
...
| 2 | `StatusReason` | `—` | `—` | `runtime_lineage` |
