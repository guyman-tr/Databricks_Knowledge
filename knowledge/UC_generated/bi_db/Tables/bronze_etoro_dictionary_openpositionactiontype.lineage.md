# Column Lineage: main.bi_db.bronze_etoro_dictionary_openpositionactiontype
...
> `_discovery/column_lineage/bronze_etoro_dictionary_openpositionactiontype.json` for upstream resolution.
...
| 2 | `OpenPositionActionName` | `—` | `—` | `runtime_lineage` |
