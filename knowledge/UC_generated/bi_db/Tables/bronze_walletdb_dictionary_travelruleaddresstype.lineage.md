# Column Lineage: main.bi_db.bronze_walletdb_dictionary_travelruleaddresstype
...
> `_discovery/column_lineage/bronze_walletdb_dictionary_travelruleaddresstype.json` for upstream resolution.
