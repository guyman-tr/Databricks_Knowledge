# Column Lineage: main.bi_db.bronze_etoro_backoffice_managertopermission
...
> `_discovery/column_lineage/bronze_etoro_backoffice_managertopermission.json` for upstream resolution.

## Column Lineage

| # | Element | source_object | source_column | transform |
|---|---------|---------------|---------------|-----------|
| 1 | `ManagerID` | `—` | `—` | `runtime_lineage` |
| 2 | `PermissionID` | `—` | `—` | `runtime_lineage` |
| 3 | `ProviderID` | `—` | `—` | `runtime_lineage` |
