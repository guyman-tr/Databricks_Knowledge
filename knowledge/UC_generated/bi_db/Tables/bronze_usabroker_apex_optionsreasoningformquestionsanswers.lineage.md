# Column Lineage: main.bi_db.bronze_usabroker_apex_optionsreasoningformquestionsanswers
...
> `_discovery/column_lineage/bronze_usabroker_apex_optionsreasoningformquestionsanswers.json` for upstream resolution.
...
| 2 | `KycQuestionID` | `—` | `—` | `runtime_lineage` |
| 3 | `ReasoningFormAnswerID` | `—` | `—` | `runtime_lineage` |
| 4 | `OldKycAnswerID` | `—` | `—` | `runtime_lineage` |
