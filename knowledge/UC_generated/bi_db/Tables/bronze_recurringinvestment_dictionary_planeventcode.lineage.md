# Column Lineage: main.bi_db.bronze_recurringinvestment_dictionary_planeventcode
...
> `_discovery/column_lineage/bronze_recurringinvestment_dictionary_planeventcode.json` for upstream resolution.
