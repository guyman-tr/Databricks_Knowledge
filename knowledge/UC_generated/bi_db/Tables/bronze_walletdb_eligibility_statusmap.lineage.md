# Column Lineage: main.bi_db.bronze_walletdb_eligibility_statusmap
...
> `_discovery/column_lineage/bronze_walletdb_eligibility_statusmap.json` for upstream resolution.
...
| 2 | `GroupValue` | `—` | `—` | `runtime_lineage` |
| 3 | `CustomerValue` | `—` | `—` | `runtime_lineage` |
| 4 | `Status` | `—` | `—` | `runtime_lineage` |
