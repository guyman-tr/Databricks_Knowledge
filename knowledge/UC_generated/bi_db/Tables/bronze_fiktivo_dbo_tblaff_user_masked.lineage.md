# Column Lineage: main.bi_db.bronze_fiktivo_dbo_tblaff_user_masked
...
> `_discovery/column_lineage/bronze_fiktivo_dbo_tblaff_user_masked.json` for upstream resolution.
