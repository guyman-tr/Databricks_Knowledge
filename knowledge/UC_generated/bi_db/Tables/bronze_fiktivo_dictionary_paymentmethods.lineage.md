# Column Lineage: main.bi_db.bronze_fiktivo_dictionary_paymentmethods
...
> `_discovery/column_lineage/bronze_fiktivo_dictionary_paymentmethods.json` for upstream resolution.

## Column Lineage

| # | Element | source_object | source_column | transform |
|---|---------|---------------|---------------|-----------|
| 1 | `PaymentMethodID` | `—` | `—` | `runtime_lineage` |
