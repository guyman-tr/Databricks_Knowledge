# Column Lineage: main.bi_db.bronze_recurringinvestment_dictionary_planstatus
...
> `_discovery/column_lineage/bronze_recurringinvestment_dictionary_planstatus.json` for upstream resolution.
