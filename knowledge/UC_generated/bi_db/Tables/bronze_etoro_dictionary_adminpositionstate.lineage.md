# Column Lineage: main.bi_db.bronze_etoro_dictionary_adminpositionstate
...
> `_discovery/column_lineage/bronze_etoro_dictionary_adminpositionstate.json` for upstream resolution.
