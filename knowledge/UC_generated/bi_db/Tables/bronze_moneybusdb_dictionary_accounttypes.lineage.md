# Column Lineage: main.bi_db.bronze_moneybusdb_dictionary_accounttypes
...
> `_discovery/column_lineage/bronze_moneybusdb_dictionary_accounttypes.json` for upstream resolution.
