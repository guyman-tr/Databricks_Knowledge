# Column Lineage: main.bi_db.bronze_walletdb_dictionary_eligibilitystatuses
...
> `_discovery/column_lineage/bronze_walletdb_dictionary_eligibilitystatuses.json` for upstream resolution.
