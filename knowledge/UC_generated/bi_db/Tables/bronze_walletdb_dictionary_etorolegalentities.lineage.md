# Column Lineage: main.bi_db.bronze_walletdb_dictionary_etorolegalentities
...
> `_discovery/column_lineage/bronze_walletdb_dictionary_etorolegalentities.json` for upstream resolution.
