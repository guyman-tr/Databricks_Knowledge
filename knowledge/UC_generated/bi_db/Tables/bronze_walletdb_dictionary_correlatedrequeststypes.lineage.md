# Column Lineage: main.bi_db.bronze_walletdb_dictionary_correlatedrequeststypes
...
> `_discovery/column_lineage/bronze_walletdb_dictionary_correlatedrequeststypes.json` for upstream resolution.
