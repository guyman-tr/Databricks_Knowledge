# Column Lineage: main.bi_db.bronze_fiktivo_dictionary_positionassettype
...
> `_discovery/column_lineage/bronze_fiktivo_dictionary_positionassettype.json` for upstream resolution.
