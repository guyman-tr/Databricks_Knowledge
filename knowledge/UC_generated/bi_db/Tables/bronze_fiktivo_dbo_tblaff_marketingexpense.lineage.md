# Column Lineage: main.bi_db.bronze_fiktivo_dbo_tblaff_marketingexpense
...
> `_discovery/column_lineage/bronze_fiktivo_dbo_tblaff_marketingexpense.json` for upstream resolution.

## Column Lineage

| # | Element | source_object | source_column | transform |
|---|---------|---------------|---------------|-----------|
| 1 | `MarketingExpenseID` | `—` | `—` | `runtime_lineage` |
| 2 | `MarketingExpenseName` | `—` | `—` | `runtime_lineage` |
