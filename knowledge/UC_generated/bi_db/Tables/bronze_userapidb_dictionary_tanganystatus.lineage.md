# Column Lineage: main.bi_db.bronze_userapidb_dictionary_tanganystatus
...
> `_discovery/column_lineage/bronze_userapidb_dictionary_tanganystatus.json` for upstream resolution.

## Column Lineage

| # | Element | source_object | source_column | transform |
|---|---------|---------------|---------------|-----------|
| 1 | `TanganyStatusID` | `—` | `—` | `runtime_lineage` |
