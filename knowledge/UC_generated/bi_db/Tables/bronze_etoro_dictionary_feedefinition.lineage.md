# Column Lineage: main.bi_db.bronze_etoro_dictionary_feedefinition
...
> `_discovery/column_lineage/bronze_etoro_dictionary_feedefinition.json` for upstream resolution.

## Column Lineage

| # | Element | source_object | source_column | transform |
|---|---------|---------------|---------------|-----------|
| 1 | `FeeID` | `—` | `—` | `runtime_lineage` |
| 2 | `FeeDescription` | `—` | `—` | `runtime_lineage` |
