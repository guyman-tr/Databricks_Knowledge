# Column Lineage: main.bi_db.bronze_etoro_dictionary_withdrawtype
...
> `_discovery/column_lineage/bronze_etoro_dictionary_withdrawtype.json` for upstream resolution.

## Column Lineage

| # | Element | source_object | source_column | transform |
|---|---------|---------------|---------------|-----------|
| 1 | `WithdrawTypeID` | `—` | `—` | `runtime_lineage` |
| 2 | `WithdrawType` | `—` | `—` | `runtime_lineage` |
