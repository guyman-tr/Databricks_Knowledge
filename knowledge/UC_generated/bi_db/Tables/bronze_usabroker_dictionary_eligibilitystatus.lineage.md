# Column Lineage: main.bi_db.bronze_usabroker_dictionary_eligibilitystatus
...
> `_discovery/column_lineage/bronze_usabroker_dictionary_eligibilitystatus.json` for upstream resolution.

## Column Lineage

| # | Element | source_object | source_column | transform |
|---|---------|---------------|---------------|-----------|
| 1 | `EligibilityStatusID` | `—` | `—` | `runtime_lineage` |
