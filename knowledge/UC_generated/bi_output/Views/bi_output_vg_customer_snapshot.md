---
object_fqn: main.bi_output.bi_output_vg_customer_snapshot
object_type: VIEW
...
writer:
  ...
  path: knowledge/UC_generated/bi_output/_discovery/source_code/bi_output_vg_customer_snapshot.sql
  source_code_snapshot: knowledge/UC_generated/bi_output/_discovery/source_code/bi_output_vg_customer_snapshot.sql
concept_count: 14
formula_count: 56
tier_breakdown:
  tier1_columns: 13
...
**Rules**:
- `GuruStatusID > 1`
**Evidence**: `knowledge/UC_generated/bi_output/_discovery/source_code/bi_output_vg_customer_snapshot.sql` bi_output.sql L33-L36
...
**Evidence**: `knowledge/UC_generated/bi_output/_discovery/source_code/bi_output_vg_customer_snapshot.sql` L83
...
**Evidence**: `knowledge/UC_generated/bi_output/_discovery/source_code/bi_output_vg_customer_snapshot.sql` L85
...
**Evidence**: `knowledge/UC_generated/bi_output/_discovery/source_code/bi_output_vg_customer_snapshot.sql` L87
...
**Evidence**: `knowledge/UC_generated/bi_output/_discovery/source_code/bi_output_vg_customer_snapshot.sql` L89
...
**Evidence**: `knowledge/UC_generated/bi_output/_discovery/source_code/bi_output_vg_customer_snapshot.sql` L91,L111
...
**Evidence**: `knowledge/UC_generated/bi_output/_discovery/source_code/bi_output_vg_customer_snapshot.sql` L93,L109
...
**Evidence**: `knowledge/UC_generated/bi_output/_discovery/source_code/bi_output_vg_customer_snapshot.sql` L95
...
**Evidence**: `knowledge/UC_generated/bi_output/_discovery/source_code/bi_output_vg_customer_snapshot.sql` L97
...
**Evidence**: `knowledge/UC_generated/bi_output/_discovery/source_code/bi_output_vg_customer_snapshot.sql` L99
...
**Evidence**: `knowledge/UC_generated/bi_output/_discovery/source_code/bi_output_vg_customer_snapshot.sql` L101
...
**Evidence**: `knowledge/UC_generated/bi_output/_discovery/source_code/bi_output_vg_customer_snapshot.sql` L103
...
**Evidence**: `knowledge/UC_generated/bi_output/_discovery/source_code/bi_output_vg_customer_snapshot.sql` L105
...
**Evidence**: `knowledge/UC_generated/bi_output/_discovery/source_code/bi_output_vg_customer_snapshot.sql` L107
...
| 2 | Date | TIMESTAMP | YES | Direct passthrough from upstream. Formula: `Date`. (Tier 2 — from `main.bi_output.bi_output_vg_date`) |
| 3 | DateID | INT | YES | Direct passthrough from upstream. Formula: `DateID`. (Tier 2 — from `main.bi_output.bi_output_vg_date`) |
| 4 | PlayerLevelID | INT | YES | Account tier (4=demo, other=real tiers). FK to Dim_PlayerLevel. Critical for IsValidCustomer. (Tier 1 — inherited from Fact_SnapshotCustomer wiki) |
...
| 8 | VerificationLevelID | INT | YES | KYC verification level. FK to Dim_VerificationLevel. (Tier 1 — inherited from Fact_SnapshotCustomer wiki) |
...
| 10 | CountryID | INT | YES | Customer's registered country. FK to Dim_Country. Key filter for valid customer segmentation. (Tier 1 — inherited from Fact_SnapshotCustomer wiki) |
...
| 15 | LanguageID | INT | YES | Customer's preferred interface language. FK to Dim_Language. (Tier 1 — inherited from Fact_SnapshotCustomer wiki) |
...
| 19 | AccountTypeID | INT | YES | Account type (e.g., 7=Employee, 9=excluded). FK to Dim_AccountType. (Tier 1 — inherited from Fact_SnapshotCustomer wiki) |
...
| 21 | GuruStatusID | INT | YES | Popular Investor (Guru) program status. FK to Dim_GuruStatus. (Tier 1 — inherited from Fact_SnapshotCustomer wiki) |
...
| 24 | AccountStatusID | INT | YES | Account enabled/suspended status. FK to Dim_AccountStatus. (Tier 1 — inherited from Fact_SnapshotCustomer wiki) |
...
| 26 | PlayerStatusID | INT | YES | Customer lifecycle status. FK to Dim_PlayerStatus. (Tier 1 — inherited from Fact_SnapshotCustomer wiki) |
...
| 47 | CitizenshipCountry | STRING | YES | Direct passthrough from upstream. Formula: `Name`. (Tier 2 — from `main.dwh.gold_sql_dp_prod_we_dwh_dbo_dim_country`) |
...
| 49 | ClusterDetail | NULL | YES | Literal constant set in this object. Formula: `NULL`. (Tier 2 — literal) |
| 50 | ClusterSF | NULL | YES | Literal constant set in this object. Formula: `NULL`. (Tier 2 — literal) |
| 51 | IsLastCluster | NULL | YES | Literal constant set in this object. Formula: `NULL`. (Tier 2 — literal) |
| 52 | IsFirstCluster | NULL | YES | Literal constant set in this object. Formula: `NULL`. (Tier 2 — literal) |
| 53 | IsSFCluster | NULL | YES | Literal constant set in this object. Formula: `NULL`. (Tier 2 — literal) |
| 54 | UpdateDateIDSF | NULL | YES | Literal constant set in this object. Formula: `NULL`. (Tier 2 — literal) |
| 55 | ClusterDynamic | NULL | YES | Literal constant set in this object. Formula: `NULL`. (Tier 2 — literal) |
...
`parsed=56 runtime=56 mismatches=0` — see `.lineage.md` `## Cross-check` section for per-column detail.
