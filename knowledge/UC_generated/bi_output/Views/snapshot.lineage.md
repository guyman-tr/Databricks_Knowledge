# Column Lineage: main.bi_output.snapshot

| Property | Value |
|----------|-------|
| **UC Object** | `main.bi_output.snapshot` |
| **Object Type** | `VIEW` |
...
|--------------------|------|---------------|
| `main.csv.abfss://analysis@stgdpdlwe.dfs.core.windows.net/bi_output/finance/uploads/guy_m/snapshot_isfundedthisyear` | Primary (FROM) | ✗ `(no wiki found)` |

## Lineage Chain

```
main.csv.abfss://analysis@stgdpdlwe.dfs.core.windows.net/bi_output/finance/uploads/guy_m/snapshot_isfundedthisyear   ←── primary upstream
        │
        ▼
main.bi_output.snapshot   ←── this object
```
