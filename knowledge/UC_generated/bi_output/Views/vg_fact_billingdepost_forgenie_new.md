---
object_fqn: main.bi_output.vg_fact_billingdepost_forgenie_new
object_type: VIEW
...
writer:
  ...
  path: knowledge/UC_generated/bi_output/_discovery/source_code/vg_fact_billingdepost_forgenie_new.sql
  source_code_snapshot: knowledge/UC_generated/bi_output/_discovery/source_code/vg_fact_billingdepost_forgenie_new.sql
concept_count: 4
formula_count: 21
tier_breakdown:
  tier1_columns: 7
...
# vg_fact_billingdepost_forgenie_new
...
| Property | Value |
|----------|-------|
| **UC Object** | `main.bi_output.vg_fact_billingdepost_forgenie_new` |
| **Type** | VIEW |
| **Format** | n/a |
...
`vg_fact_billingdepost_forgenie_new` is a view in `main.bi_output` that composes 4 JOIN-enriched dimension lookup(s).
...
**Evidence**: `knowledge/UC_generated/bi_output/_discovery/source_code/vg_fact_billingdepost_forgenie_new.sql` L63
...
**Evidence**: `knowledge/UC_generated/bi_output/_discovery/source_code/vg_fact_billingdepost_forgenie_new.sql` L65
...
**Evidence**: `knowledge/UC_generated/bi_output/_discovery/source_code/vg_fact_billingdepost_forgenie_new.sql` L67
...
**Evidence**: `knowledge/UC_generated/bi_output/_discovery/source_code/vg_fact_billingdepost_forgenie_new.sql` L71
...
... (3 more upstream(s))
        │
        ▼
main.bi_output.vg_fact_billingdepost_forgenie_new   ←── this object
```
