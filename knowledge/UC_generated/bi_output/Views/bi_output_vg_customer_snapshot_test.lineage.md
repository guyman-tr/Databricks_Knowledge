# Column Lineage: main.bi_output.bi_output_vg_customer_snapshot_test

| Property | Value |
|----------|-------|
| **UC Object** | `main.bi_output.bi_output_vg_customer_snapshot_test` |
| **Object Type** | `VIEW` |
| **Source** | `knowledge\UC_generated\bi_output\_discovery\source_code\bi_output_vg_customer_snapshot_test.sql` |
| **Column-lineage cache** | `knowledge\UC_generated\bi_output\_discovery\column_lineage\bi_output_vg_customer_snapshot_test.json` (rows: 56, mismatches: 0) |
...
| 3 | `Date` | `main.bi_output.bi_output_vg_date` | `Date` | `join_enriched` | (Tier 1 — DDL) | dd.Date AS Date |
