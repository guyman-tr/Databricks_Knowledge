---
object_fqn: main.bi_output.positive_nmi
...
writer:
  kind: sp_or_sql
  path: knowledge/UC_generated/bi_output/_discovery/source_code/positive_nmi.sql
  source_code_snapshot: knowledge/UC_generated/bi_output/_discovery/source_code/positive_nmi.sql
concept_count: 1
formula_count: 5
tier_breakdown:
  tier1_columns: 0
...
| Property | Value |
|----------|-------|
| **UC Object** | `main.bi_output.positive_nmi` |
...
| **Created** | Thu Feb 20 20:39:18 UTC 2025 |

---

## 1. Business Meaning

`positive_nmi` is a table (SP/SQL writer) in `main.bi_output` that composes 1 JOIN-enriched dimension lookup(s).
...
**Evidence**: `knowledge/UC_generated/bi_output/_discovery/source_code/positive_nmi.sql` L50
...
... (1 more upstream(s))
        │
        ▼
main.bi_output.positive_nmi   ←── this object
```
