---
object_fqn: main.bi_output.current
object_type: VIEW
...
writer:
  ...
  path: knowledge/UC_generated/bi_output/_discovery/source_code/current.sql
  source_code_snapshot: knowledge/UC_generated/bi_output/_discovery/source_code/current.sql
concept_count: 0
formula_count: 0
tier_breakdown:
  tier1_columns: 0
...
| Property | Value |
|----------|-------|
| **UC Object** | `main.bi_output.current` |
| **Type** | VIEW |
| **Format** | n/a |
...
| **Created** | Tue Jun 03 07:34:14 UTC 2025 |

---

## 1. Business Meaning

`current` is a view in `main.bi_output`. No discriminator concepts were detected in the source — see §2 for the transform pattern breakdown.
...
... (17 more upstream(s))
        │
        ▼
main.bi_output.current   ←── this object
```
