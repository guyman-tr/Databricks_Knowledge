---
object_fqn: main.bi_output.snapshot_table
object_type: VIEW
...
writer:
  ...
  path: knowledge/UC_generated/bi_output/_discovery/source_code/snapshot_table.sql
  source_code_snapshot: knowledge/UC_generated/bi_output/_discovery/source_code/snapshot_table.sql
concept_count: 0
formula_count: 0
tier_breakdown:
  tier1_columns: 0
...
| **Created** | Tue Jun 03 12:48:55 UTC 2025 |

---

## 1. Business Meaning

`snapshot_table` is a view in `main.bi_output`. No discriminator concepts were detected in the source — see §2 for the transform pattern breakdown.
