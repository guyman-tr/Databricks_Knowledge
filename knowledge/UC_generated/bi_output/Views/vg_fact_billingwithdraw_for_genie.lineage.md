...
| `main.billing.bronze_etoro_billing_depot` | JOIN / referenced | ✓ `knowledge/ProdSchemas/DB_Schema/etoro/Wiki/Billing/Tables/Billing.Depot.md` |
...
| 15 | `DepotName` | `main.billing.bronze_etoro_billing_depot` | `Name` | `join_enriched` | — | d.Name AS DepotName /* Depot */ |
