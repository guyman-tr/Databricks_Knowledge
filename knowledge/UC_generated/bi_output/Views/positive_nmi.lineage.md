# Column Lineage: main.bi_output.positive_nmi

| Property | Value |
|----------|-------|
| **UC Object** | `main.bi_output.positive_nmi` |
| **Object Type** | `MATERIALIZED_VIEW` |
| **Source** | `knowledge\UC_generated\bi_output\_discovery\source_code\positive_nmi.sql` |
| **Column-lineage cache** | `knowledge\UC_generated\bi_output\_discovery\column_lineage\positive_nmi.json` (rows: 5, mismatches: 5) |
