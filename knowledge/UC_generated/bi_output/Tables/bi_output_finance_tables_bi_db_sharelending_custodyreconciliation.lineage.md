# Column Lineage: main.bi_output.bi_output_finance_tables_bi_db_sharelending_custodyreconciliation

| Property | Value |
|----------|-------|
| **UC Object** | `main.bi_output.bi_output_finance_tables_bi_db_sharelending_custodyreconciliation` |
...
> `_discovery/column_lineage/bi_output_finance_tables_bi_db_sharelending_custodyreconciliation.json` for upstream resolution.
