# Column Lineage: main.bi_output.bi_output_finance_tables_bi_db_sharelending_custodyreconciliation_eu

| Property | Value |
|----------|-------|
| **UC Object** | `main.bi_output.bi_output_finance_tables_bi_db_sharelending_custodyreconciliation_eu` |
...
> `_discovery/column_lineage/bi_output_finance_tables_bi_db_sharelending_custodyreconciliation_eu.json` for upstream resolution.
