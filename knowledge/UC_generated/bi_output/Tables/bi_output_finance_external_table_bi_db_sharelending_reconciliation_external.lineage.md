# Column Lineage: main.bi_output.bi_output_finance_external_table_bi_db_sharelending_reconciliation_external

| Property | Value |
|----------|-------|
| **UC Object** | `main.bi_output.bi_output_finance_external_table_bi_db_sharelending_reconciliation_external` |
...
> `_discovery/column_lineage/bi_output_finance_external_table_bi_db_sharelending_reconciliation_external.json` for upstream resolution.
