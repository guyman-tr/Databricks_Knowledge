# Column Lineage: main.bi_dealing.bi_output_dealing_ib_recon_trades

| Property | Value |
|----------|-------|
| **UC Object** | `main.bi_dealing.bi_output_dealing_ib_recon_trades` |
...
> `_discovery/column_lineage/bi_output_dealing_ib_recon_trades.json` for upstream resolution.
