# Run Summary — 2026-05-18T08-44-58Z
...
|--------|-----------|----------------|------------|------------|--------------|--------|---------|----------|-------|-------|-------|
| `etoro_kpi_prep` | 53 | 21 | 0 | 32 | 7.35 | 8.7 | 9.0 | 6.9 | 3.9 | 2.9 | 6.9 |
| **TOTAL** | **53** | **21** | **0** | **32** | **7.35** | **8.7** | **9.0** | **6.9** | **3.9** | **2.9** | **6.9** |
...
| `etoro_kpi_prep` | `v_ddr_revenues` | 6.30 | upstream wiki missing: main.etoro_kpi_prep.v_revenue_stakingfee |
...
---
_Generated by `tools/uc_pipelines/write_audit_summary.py` at 2026-05-18T08:45:53Z._
