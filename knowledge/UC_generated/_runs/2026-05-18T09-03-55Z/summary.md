# Run Summary — 2026-05-18T09-03-55Z
...
|--------|-----------|----------------|------------|------------|--------------|--------|---------|----------|-------|-------|-------|
| `etoro_kpi_prep` | 53 | 23 | 0 | 30 | 7.50 | 8.9 | 9.2 | 7.0 | 4.0 | 3.0 | 6.9 |
| **TOTAL** | **53** | **23** | **0** | **30** | **7.50** | **8.9** | **9.2** | **7.0** | **4.0** | **3.0** | **6.9** |

### Final-FAIL objects

| Schema | Object | Weighted score | First-line feedback |
|--------|--------|----------------|---------------------|
| `etoro_kpi_prep` | `gold_de_user_dim_ddr_customer_dailystatus_scd` | 6.10 | all 38 columns unclassifiable |
...
---
_Generated by `tools/uc_pipelines/write_audit_summary.py` at 2026-05-18T09:04:57Z._
