# Column Lineage: main.billing.bronze_recurringmanager_dictionary_frequency
...
> `_discovery/column_lineage/bronze_recurringmanager_dictionary_frequency.json` for upstream resolution.

## Column Lineage

| # | Element | source_object | source_column | transform |
|---|---------|---------------|---------------|-----------|
| 1 | `FrequencyID` | `—` | `—` | `runtime_lineage` |
