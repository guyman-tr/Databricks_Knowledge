...
| 12 | InstrumentID | INT | YES | The trading instrument being redeemed. FK to Trade.InstrumentMetaData(InstrumentID). Examples: 100001=Bitcoin, 100017=another crypto. Used by multiple procedures for instrument-specific business logic (Tier 1 — inherited from etoro.Billing.Redeem). |
