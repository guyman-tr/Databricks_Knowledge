# Column Lineage: main.billing.bronze_recurringmanager_dictionary_planstatus
...
> `_discovery/column_lineage/bronze_recurringmanager_dictionary_planstatus.json` for upstream resolution.

## Column Lineage

| # | Element | source_object | source_column | transform |
|---|---------|---------------|---------------|-----------|
| 1 | `PlanStatusID` | `—` | `—` | `runtime_lineage` |
