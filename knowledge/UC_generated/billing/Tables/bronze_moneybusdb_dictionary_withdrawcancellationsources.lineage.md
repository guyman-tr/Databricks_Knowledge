# Column Lineage: main.billing.bronze_moneybusdb_dictionary_withdrawcancellationsources
...
> `_discovery/column_lineage/bronze_moneybusdb_dictionary_withdrawcancellationsources.json` for upstream resolution.
