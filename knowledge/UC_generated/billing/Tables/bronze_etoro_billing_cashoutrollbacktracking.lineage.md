# Column Lineage: main.billing.bronze_etoro_billing_cashoutrollbacktracking
...
> `_discovery/column_lineage/bronze_etoro_billing_cashoutrollbacktracking.json` for upstream resolution.
...
| 3 | `WitdrawToFundingID` | `—` | `—` | `runtime_lineage` |
...
| 21 | `WithdrawID` | `—` | `—` | `runtime_lineage` |
| 22 | `WithdrawToFundingActionID` | `—` | `—` | `runtime_lineage` |
| 23 | `CreditID` | `—` | `—` | `runtime_lineage` |
