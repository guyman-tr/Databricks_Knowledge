# Column Lineage: main.billing.bronze_moneybusdb_dictionary_withdrawstatuses
...
> `_discovery/column_lineage/bronze_moneybusdb_dictionary_withdrawstatuses.json` for upstream resolution.
