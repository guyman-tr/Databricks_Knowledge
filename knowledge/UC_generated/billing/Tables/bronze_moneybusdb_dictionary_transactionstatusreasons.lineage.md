# Column Lineage: main.billing.bronze_moneybusdb_dictionary_transactionstatusreasons
...
> `_discovery/column_lineage/bronze_moneybusdb_dictionary_transactionstatusreasons.json` for upstream resolution.
...
| 3 | `TransactionStatusID` | `—` | `—` | `runtime_lineage` |
