# Column Lineage: main.billing.bronze_etoro_billing_badbin
...
> `_discovery/column_lineage/bronze_etoro_billing_badbin.json` for upstream resolution.

## Column Lineage

| # | Element | source_object | source_column | transform |
|---|---------|---------------|---------------|-----------|
| 1 | `BinFrom` | `—` | `—` | `runtime_lineage` |
| 2 | `BinTo` | `—` | `—` | `runtime_lineage` |
| 3 | `BlockReasonID` | `—` | `—` | `runtime_lineage` |
