...
from(SELECT fbw.CID 
	  ...
	  ,CASE WHEN f_funding.Name IN ('ACH','PWMB') THEN  pt.ModificationDate
	        WHEN f_funding.Name ='CreditCard' THEN pt1.ModificationDate
		    WHEN f_funding.Name = 'WireTransfer' THEN pt2.ModificationDate end  SendToProviderDate
