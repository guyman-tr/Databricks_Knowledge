SELECT COALESCE(q1.CID,q2.CID) CID
	  ...
	  ,ISNULL(q1.UserName,'AmitKup') UserName
	  ...
	  ,sum(vl.RealizedEquity) RealizedEquity_7Jan2024
	  ,SUM(vl.Equity) Equity_7Jan2024
	  ,SUM(vl.Credit) Credit_7Jan2024
	  ,SUM(ISNULL(c.EquityCopy,0)) EquityCopy_7Jan2024
FROM 
(SELECT q0.CID
	  ,q0.UserName
	  ,q0.AM
...
and wli.DateID <=20240107
  AND ItemId IN (11132144)
