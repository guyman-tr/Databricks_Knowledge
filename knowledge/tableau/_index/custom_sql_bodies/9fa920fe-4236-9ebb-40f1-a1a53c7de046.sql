SELECT da.RealCID 
      ...
      ,ifnull(tc.InstrumentDisplayName,'Didnt sign') Stock_Choise
...
left join (
            select CID
            ,ProviderHolderID
            , TRY_TO_TIMESTAMP(InstanceCreatedDate, 'M/d/yyyy h:mm:ss a')
...
and Position in ('Senior Account Manager', 'RM', 'Account Manager', 'Team leader')
 join (
            ...
            where a.Journey_Name = '9037759373_ConfirmParticipation_Log_BI'
...
and da.CountryID in (74,218,19,119,135,57,72,95,143,154,196,165,191,54,118,126,32,52,55,67,82,94,112,164,168,184,185,100,13,79,117,197,102)
