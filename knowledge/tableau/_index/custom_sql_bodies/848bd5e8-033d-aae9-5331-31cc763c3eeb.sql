SELECT 
    ...
    CAST(DATEADD(DAY, -CASE 
                         WHEN DATEPART(WEEKDAY, fca.Occurred) = 7 THEN 0 
                         ELSE DATEPART(WEEKDAY, fca.Occurred)
                       END, fca.Occurred) AS DATE) AS Week_Start_Date,
...
WHERE    
    fca.ActionTypeID IN (44, 45, 7, 8) AND fca.FundingTypeID=33 
