...
bdmcr.Balance,
CASE WHEN bdmcr.Balance<0 AND ABS(SUM(bdmcr.[CHB/ Refund $ Ammount * (-1)]))>ABS(bdmcr.Balance) THEN ABS(bdmcr.Balance)
WHEN  bdmcr.Balance<0 AND ABS(SUM(bdmcr.[CHB/ Refund $ Ammount * (-1)]))<=ABS(bdmcr.Balance) THEN ABS(SUM(bdmcr.[CHB/ Refund $ Ammount * (-1)])) ELSE 0 END AS Final,
bdmcr.[Refund / CHB],
