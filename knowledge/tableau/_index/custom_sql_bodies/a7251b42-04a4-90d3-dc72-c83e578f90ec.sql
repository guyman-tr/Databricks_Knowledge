SELECT fnl.GCID
      ...
      ,CASE WHEN fnl.Club IN ('Bronze') THEN 'NoClub'
       ...
       ,CASE WHEN mda.AccountSubProgram IS NOT NULL AND mda.AccountSubProgram IN 
('IBAN Standard EU Test', 'IBAN LIMITED EU', 'IBAN EU Green', 'IBAN EU Black', 'Card Black EU', 'Card Green EU')
