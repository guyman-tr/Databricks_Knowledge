...
left join DWH_dbo.Dim_Position dp2 WITH (NOLOCK) on dp.TreeID = dp2.PositionID
join DWH_dbo.Dim_Customer dc2 WITH (NOLOCK) on dp2.CID = dc2.RealCID
join DWH_dbo.Dim_Country dc3 WITH (NOLOCK) on dc2.CountryID = dc3.CountryID
