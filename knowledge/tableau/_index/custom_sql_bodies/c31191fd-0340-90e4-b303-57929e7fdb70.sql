...
JOIN main.general.bronze_etoro_dictionary_documentclassification ddc
  ON dib.DocumentClassificationSubType__c = ddc.DocumentClassificationID
JOIN main.general.bronze_etoro_dictionary_documenttype dt
  ON ddc.DocumentTypeID = dt.DocumentTypeID