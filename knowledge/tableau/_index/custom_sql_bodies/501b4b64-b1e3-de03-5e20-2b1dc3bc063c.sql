SELECT  s1.GCID, s1.SendDateID, s1.EmailName, s1.CountSend, s1.Delivered ,s1.UniqueOpen, s1.UniqueClicks
FROM bi_output.bi_output_marketing_sfmc_sfmc_report s1
WHERE s1.GCID=<[Parameters].[Parameter 1]>

UNION

SELECT  s2.GCID, s2.SendDateID, s2.EmailName, s2.CountSend, s2.Delivered ,s2.UniqueOpen, s2.UniqueClicks
