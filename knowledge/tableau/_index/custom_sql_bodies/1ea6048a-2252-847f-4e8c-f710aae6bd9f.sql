...
WHERE fca.ActionTypeID =7 AND fca.MoveMoneyReasonID=6 AND mda.IsValidETM=1 AND fca.FundingTypeID=33 AND fca.DateID>=20250401 
...
WHERE fca.ActionTypeID =8 AND fca.MoveMoneyReasonID=6 AND mda.IsValidETM=1 AND fca.FundingTypeID=33 AND fca.DateID>=20250401