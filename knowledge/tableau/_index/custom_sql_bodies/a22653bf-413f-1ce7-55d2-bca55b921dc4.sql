...
SELECT
  ...
  cc.City,
    cc.Registered,
    cm.firstDepositDate as FirstDepositDate,
...
JOIN main.dwh.gold_sql_dp_prod_we_dwh_dbo_dim_customer_masked cm on cm.RealCID=bc.CID
...
WHERE cm.FirstDepositDate>='2025-04-01'
