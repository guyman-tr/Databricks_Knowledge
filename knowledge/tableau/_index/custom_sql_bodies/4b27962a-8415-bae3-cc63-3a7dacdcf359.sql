...
, sum(isnull(TotalStocksPositionAmount	
	,0)) as TotalStocksPositionAmount					
...
WHERE DateID = CAST(CONVERT(VARCHAR(10), CAST(<[Parameters].[Parameter 1 1]> as DATE), 112) AS INT) and CID=<[Parameters].[Parameter 7]>
GROUP BY 
CID
, TransferDirection
, Regulation
