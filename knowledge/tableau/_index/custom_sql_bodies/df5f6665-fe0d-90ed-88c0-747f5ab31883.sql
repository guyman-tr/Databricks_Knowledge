...
INNER JOIN DWH.dbo.Dim_Customer dc WITH(NOLOCK) ON fca.RealCID = dc.RealCID
INNER JOIN eMoney.dbo.eMoney_Dim_Country_Rollout mdcr WITH(NOLOCK) ON dc.CountryID = mdcr.CountryID
