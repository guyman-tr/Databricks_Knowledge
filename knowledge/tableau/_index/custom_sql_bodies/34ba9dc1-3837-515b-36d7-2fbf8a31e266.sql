SELECT
  ...
  , [ClientMoneyT-1]
  , [NotionalFinancialInstrumentsT-1]
  , IsCountryEU
  , CreditLineRefDate
  , CryptoLoanRefDate
  , CrossBorderWireCount
  , CrossBorderWireAmount
  , NOPCFD
  , IsCopyAtReferenceDate
  , null as CountCrossBorderWires
  , null as CrossBorderWiresAmount
  , ExpandedCountUsers_section_I
  , TotalCreditIssued
  , TotalCryptoLoanIssued
...
where rb.DateID between 20220101 and 20221231