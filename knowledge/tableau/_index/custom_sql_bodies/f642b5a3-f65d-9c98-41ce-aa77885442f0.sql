SELECT t.EoM_date, t.Channel, t.us_options_campaign_filter, Metric, Value
FROM
(
...
CROSS APPLY (
		VALUES
			('Impressions', EoM_date, Channel, us_options_campaign_filter, Impressions),
			('Clicks',      EoM_date, Channel, us_options_campaign_filter, Clicks),
			('Views_10s', EoM_date, Channel, us_options_campaign_filter, Views_10s),
			('Cost', EoM_date, Channel, us_options_campaign_filter, Cost),
			('Click_on_CTA', EoM_date, Channel, us_options_campaign_filter, Click_on_CTA),
			('Platform_Regs', EoM_date, Channel, us_options_campaign_filter, Platform_Regs),
			('Platform_FTD', EoM_date, Channel, us_options_campaign_filter, Platform_FTD),
			('Platform_V2', EoM_date, Channel, us_options_campaign_filter, Platform_V2)
	) 
	AS Unpivoted(Metric, EoM_date, Channel, us_options_campaign_filter, Value)