SELECT 
([Nixar_TheoreticalHedgeCost_Prod].[DeltaPnl_Long] + [Nixar_TheoreticalHedgeCost_Prod].[DeltaPnl_Short]) * 0.75 AS [StrategyPnL],
  '75DeltaPnl' as StrategyName,
