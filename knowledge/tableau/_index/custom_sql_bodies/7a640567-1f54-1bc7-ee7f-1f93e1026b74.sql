SELECT t5s25.[index]
	  ...
	  ,t5s25.Hour80NopPnl
	  ,t5s25.HourNopPnl
	  ,t5s25.DeltaPnl AS [DeltaPnlT5S40]
	  ,t5s25.[50DeltaPnl] AS [50DeltaPnlT5S40]
	  ,t5s25.[25DeltaPnl] AS [25DeltaPnlT5S40]
	  ,t15s25.DeltaPnl AS [DeltaPnlT15S40]
	  ,t15s25.[50DeltaPnl] AS [50DeltaPnlT15S40]
	  ,t15s25.[25DeltaPnl] AS [25DeltaPnlT15S40]
	  ...
	  FROM 
Dealing_Dev.dbo.Nixar_Type2BacktestT5Sigma40 t5s25
JOIN 
Dealing_Dev.dbo.Nixar_Type2BacktestT15Sigma40 t15s25
ON t5s25.[index] = t15s25.[index] AND t5s25.InstrumentID = t15s25.InstrumentID
JOIN
Dealing_Dev.dbo.Nixar_Type2BacktestT5SigmaWeighted t5sw
ON t5s25.[index] = t5sw.[index] AND t5s25.InstrumentID = t5sw.InstrumentID
join
Dealing_Dev.dbo.Nixar_Type2BacktestT15SigmaWeighted t15sw
ON t5s25.[index] = t15sw.[index] AND t5s25.InstrumentID = t15sw.InstrumentID
join
Dealing_Dev.dbo.Nixar_Type2BacktestT15SigmaWeighted2 t15sw2
