SELECT bdcc.[Event_Date_Time__c] AS [Event_Date_Time__c],
  ...
  bdcc.[CaseNumber],
  csat.cSATFirst [FirstCsat],
 csat.cSATLast [LastCsat],
  sfu.Reports_to__c,
  ReportsTo_BOB,
  sfu.Country,
  ...
  IsPPReport,
us.Team,
  us.Department, us.SubRole, us.UserRole,
...
left join  [BI_DB].[dbo].[BI_DB_SF_M_cSAT]  csat on csat.CaseNumber=bdcc.CaseNumber
where bdcc.CreatedDate >= '20220101'