...
AND LA.LiquidityAccountName NOT LIKE '%Real%'
AND RIS.InstrumentTypeID = '5'
GROUP By cast(HL.ExecutionTime as date), HL.LiquidityAccountID, LA.LiquidityAccountName, RIS.InstrumentTypeID, DC.[Name])f
