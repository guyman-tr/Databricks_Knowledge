...
WHERE ag.DateID BETWEEN CAST(CONVERT(VARCHAR(10), CAST(<[Parameters].[Parameter 1]> as DATE), 112) as INT) AND CAST(CONVERT(VARCHAR(10), CAST(<[Parameters].[Parameter 2]> as DATE), 112) as INT)