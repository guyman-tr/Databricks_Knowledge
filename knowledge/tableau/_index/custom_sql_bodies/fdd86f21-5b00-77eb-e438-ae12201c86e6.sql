SELECT eomonth(efrr.[etoro - ModificationDate]) 'Month',
...
FROM EXW..EXW_FactRedeemReconciliation efrr
INNER JOIN DWH..Dim_Instrument di ON di.InstrumentID=efrr.[etoro - InstrumentID]
WHERE efrr.[etoro - ModificationDateID]>=20220101
AND  efrr.[etoro - RedeemStatus]='TransactionDone'
--AND efrr.PositionID = 834457495
GROUP BY eomonth(efrr.[etoro - ModificationDate]),
di.InstrumentDisplayName,
di.Name