...
,year(report_time)*1e8 + month(report_time)*1e6 + day(report_time)*1e4 + hour(report_time)*1e2+ minute (report_time) as report_time_id
from
(
select * 
...
where Percentile=99.5
and hc_value<100E6
and Report_time_history >='2023-01-01'
and Report_time_history >='2023-06-12' --Var 99.5 using 5 years
...
where 
report_time_id <> 202308180007 -- Crypto data mistake: Or request (20230820)
