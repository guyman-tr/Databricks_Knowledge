...
WHERE fs.TranDateID > CAST(FORMAT(CAST(getdate()-<[Parameters].[big TX threshold (copy 2)]> AS DATE),'yyyyMMdd') as INT)
and ISNULL(TransactionTypeID,00)<>10