select  aa.[index], bb.InstrumentID, aa.InstrumentName
...
, aa.Sigma
, aa.Strat
from Dealing_Dev.dbo.Nixar_TheoreticalHedgeCost_FX2_All aa
...
left join   DWH.dbo.Fact_CurrencyPriceWithSplit dd on cast(aa.[index] as DATE) = dd.OccurredDate and cc.InstrumentID = dd.InstrumentID