...
WHERE DateID BETWEEN 
    CAST(CONVERT(VARCHAR(8), DATEADD(DAY, 1, EOMONTH(GETDATE(), -2)), 112) AS INT) -- First day of previous month
AND 
    CAST(CONVERT(VARCHAR(8), EOMONTH(GETDATE(), -1), 112) AS INT)                 -- Last day of previous month
