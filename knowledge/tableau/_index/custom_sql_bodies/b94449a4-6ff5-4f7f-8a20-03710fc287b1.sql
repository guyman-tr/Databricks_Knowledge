SELECT DISTINCT  -- distinct required due to duplicates for customized full-workbook subscriptions
    ...
    COALESCE(da_w_pc.project_id, d_pc.project_id, 
             w_pc.project_id, f_pc.project_id,
             m_w_pc.project_id, m_d_pc.project_id, 
             m_f_pc.project_id, sub.project_id)            AS "Item Project Id" ,
...
FROM background_jobs bj
    ...
    LEFT JOIN
        ...
        SELECT DISTINCT
            ...
            COALESCE(sv_w_pc.project_id,
                     s_w_pc.project_id)   AS "project_id"
