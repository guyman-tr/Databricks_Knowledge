...
from [SYNAPSE-DWH-PROD-SERVERLESS].[data_views].[dbo].[TR_Silver_CappitechMifiD2EU_TRAX_ARM_TRAN_RESP]
...
[Description_2] [Reason 2],
[Description_3] [Reason 3]  
from [SYNAPSE-DWH-PROD-SERVERLESS].[data_views].[dbo].[TR_Silver_CappitechMifiD2EU_TRAX_ARM_TRAN_RSTS]
...
from [SYNAPSE-DWH-PROD-SERVERLESS].[data_views].[dbo].[TR_Silver_CappitechMifiD2EU_TRAX_ARM_TRAN_TSTS]
where [Transaction Status] = 'AREJ'
and cast([Submission Date] as Date) >= cast (getdate() - <[Parameters].[Trend Last Day Trade Date (copy)_5851020344607281156]>  as date)
