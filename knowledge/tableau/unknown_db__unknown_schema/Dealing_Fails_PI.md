# Tableau Usage — Dealing_Fails_PI
...
- Tableau id: `a7b94931-f8b5-237b-7da2-221167f0d89e`
...
- Tableau id: `fc0a3b4e-350a-384a-766b-b360ffa43788`
...
|---|---|---|---|---|---|---|
| 1 | Risk Management: Failures Execution (temp) | Arthur Kuperman (RahavBA) | Rahav BA | custom_sql | 2024-11-20T09:08:01Z | [open](https://reports.etorocorp.com/#/workbooks/RiskManagementFailuresExecutiontemp) |
| 2 | Risk Management: Failures execution weight (temp) | Arthur Kuperman (RahavBA) | Rahav BA | custom_sql | 2024-11-20T09:08:01Z | [open](https://reports.etorocorp.com/#/workbooks/RiskManagementFailuresexecutionweighttemp) |

### View URLs (per workbook)

- **Risk Management: Failures Execution (temp)** (Arthur Kuperman (RahavBA))
  - [Failures Execution](https://reports.etorocorp.com/#/views/RiskManagementFailuresExecutiontemp/FailuresExecution)
- **Risk Management: Failures execution weight (temp)** (Arthur Kuperman (RahavBA))
  - [Failures Execution weight](https://reports.etorocorp.com/#/views/RiskManagementFailuresexecutionweighttemp/FailuresExecutionweight)
