...
| 4 | IsCreditReportValidCB | int | YES | 1 if customer is eligible for CreditBureau credit report validation. ETL-computed. Point-in-time via Dim_Range. (Tier 2 — DWH_dbo.Fact_SnapshotCustomer) |
