...
Generated: 2026-06-14T17:33:39.836476Z
...
- Total trigger entries (raw): **4283**
- Distinct normalized concepts (triggers + required_tables + sample_questions): **4424**
- Concepts claimed by >=2 hubs (unmanaged overlap candidates): **86** (1.9% of all concepts)
- Substring overlap rows (matcher-false-positive candidates): **90**
...
| `domain-cross` | 5 | 107 | 54 | 32 |
| `domain-customer-and-identity` | 9 | 482 | 99 | 84 |
...
| `global ftd` | 2 | domain-customer-and-identity, domain-payments | triggers | global FTD |
...
| `local ftd vs global ftd` | domain-options | `global ftd` | domain-customer-and-identity; domain-payments | domain-customer-and-identity; domain-payments |
| `what defines an options funded account vs cumulative-since-unity funded` | domain-options | `funded account` | domain-customer-and-identity | domain-customer-and-identity |
