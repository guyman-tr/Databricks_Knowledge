# Phase 4 per-file trigger removals - APPLY
...
### `knowledge/skills/domain-revenue-and-fees/fees-deposit-withdraw-fx.md`

Triggers: 42 -> 32  (removed 10)

Removed:
- `BinCountry`  (money_flow_fiat, primary: `domain-payments`)
- `C2F`  (money_flow_crypto, primary: `domain-cross`)
- `CardType`  (money_flow_fiat, primary: `domain-payments`)
- `chargeback`  (money_flow_fiat, primary: `domain-cross`)
- `crypto to fiat`  (money_flow_crypto, primary: `domain-cross`)
- `MID`  (broker_provider_identity, primary: `domain-payments`)
- `MIDName`  (broker_provider_identity, primary: `domain-payments`)
...
### `knowledge/skills/domain-revenue-and-fees/revenue-options-platform.md`

Triggers: 34 -> 17  (removed 17)

Removed:
- `Apex`  (broker_provider_identity, primary: `domain-cross`)
- `apexrecon_holdings`  (trading_concepts, primary: `domain-trading`)
- `apexrecon_tradeactivity`  (trading_concepts, primary: `domain-trading`)
- `Gatsby`  (broker_provider_identity, primary: `domain-cross`)
- `Options`  (niche_platform_options, primary: `domain-options`)
- `options eligibility`  (niche_platform_options, primary: `domain-options`)
- `options revenue`  (fees_revenue, primary: `domain-options`)
- `payment for order flow`  (fees_revenue, primary: `domain-options`)
- `PFOF`  (fees_revenue, primary: `domain-options`)
- `sodreconciliation`  (broker_provider_identity, primary: `domain-cross`)
- `US options`  (fees_revenue, primary: `domain-options`)
- `USABroker`  (broker_provider_identity, primary: `domain-cross`)
- `usabroker`  (broker_provider_identity, primary: `domain-cross`)
- `v_mimo_options_platform`  (fees_revenue, primary: `domain-options`)
- `v_mimo_optionsplatform`  (fees_revenue, primary: `domain-options`)
- `v_options_aum`  (aum_aua, primary: `domain-options`)
- `v_revenue_optionsplatform`  (fees_revenue, primary: `domain-options`)

### `knowledge/skills/domain-revenue-and-fees/revenue-spaceship.md`

Triggers: 29 -> 16  (removed 13)

Removed:
- `Australian investment`  (niche_platform_spaceship, primary: `domain-spaceship`)
- `bronze_spaceship_metabase`  (niche_platform_spaceship, primary: `domain-spaceship`)
- `F30DD`  (niche_platform_spaceship, primary: `domain-spaceship`)
- `FTD`  (money_flow_fiat, primary: `domain-customer-and-identity`)
- `FUM`  (niche_platform_spaceship, primary: `domain-spaceship`)
...
- `Spaceship`  (niche_platform_spaceship, primary: `domain-spaceship`)
- `spaceship`  (niche_platform_spaceship, primary: `domain-spaceship`)
- `v_spaceship_aum`  (aum_aua, primary: `domain-spaceship`)
- `v_spaceship_fees`  (fees_revenue, primary: `domain-spaceship`)
- `v_spaceship_mimo`  (fees_revenue, primary: `domain-spaceship`)
- `weekend fill-forward`  (niche_platform_spaceship, primary: `domain-spaceship`)

### `knowledge/skills/domain-revenue-and-fees/revenue-staking-and-share-lending.md`

Triggers: 31 -> 27  (removed 4)

Removed:
- `RevShare`  (niche_platform_staking, primary: `domain-staking`)
- `rewards distribution`  (niche_platform_staking, primary: `domain-staking`)
- `staking`  (niche_platform_staking, primary: `domain-staking`)
- `staking rewards`  (niche_platform_staking, primary: `domain-staking`)

### `knowledge/skills/domain-revenue-and-fees/trading-revenue-and-fees.md`

Triggers: 51 -> 42  (removed 9)

Removed:
- `ActionTypeID`  (trading_concepts, primary: `domain-trading`)
- `CompensationReasonID`  (customer_identity_columns, primary: `domain-customer-and-identity`)
- `fact_customeraction_w_metrics`  (trading_concepts, primary: `domain-trading`)
- `IsBuy`  (trading_concepts, primary: `domain-trading`)
- `IsLeveraged`  (trading_concepts, primary: `domain-trading`)
- `IsSettled`  (trading_concepts, primary: `domain-trading`)
- `IsSQF`  (trading_concepts, primary: `domain-trading`)
- `MirrorID`  (trading_concepts, primary: `domain-trading`)
- `SettlementTypeID`  (trading_concepts, primary: `domain-trading`)
