...
| 6 | BlockchainCryptoId | int | YES | Identifier of the underlying blockchain network for this crypto asset. Sourced from EXW_Wallet.CryptoTypes.BlockchainCryptoId. 12 distinct values (e.g., 1=BTC, 2=ETH). (Tier 2 — EXW_Wallet.CryptoTypes) |
