...
- **Attempt**: `1`
- **Output directory** (relative to repo root): `audits/regen-sample/EXW_Wallet/AmlProviderUsers/regen/attempt_1/`
- **Absolute output directory**: `C:\Users\guyman\Documents\github\Databricks_Knowledge\audits\regen-sample\EXW_Wallet\AmlProviderUsers\regen\attempt_1`
- **Bundle path**: `C:\Users\guyman\Documents\github\Databricks_Knowledge\audits\regen-sample\EXW_Wallet\AmlProviderUsers\regen\_upstream_bundle.md`
- **DDL path**: `c:\Users\guyman\Documents\github\DataPlatform\SynapseSQLPool1\sql_dp_prod_we\EXW_Wallet\Tables\EXW_Wallet.AmlProviderUsers.sql`
- **No-upstream marker present**: `C:\Users\guyman\Documents\github\Databricks_Knowledge\audits\regen-sample\EXW_Wallet\AmlProviderUsers\regen\_no_upstream_found.txt` — object is dormant or has no resolvable upstream wiki. Footer may say `Production Source: Unknown (dormant)`. Tier 4 inferred is STILL banned — ground every column description in DDL + SP code.
...
# Pre-Resolved Upstream Bundle for `EXW_Wallet.AmlProviderUsers`

This bundle was assembled deterministically by the regen harness BEFORE the writer claude process started. Use this as your AUTHORITATIVE Tier 1 inheritance source. Quote descriptions VERBATIM from the upstream wikis below for any column that is a passthrough or rename of an upstream column. Do NOT paraphrase. Do NOT generalize vendor names. Do NOT drop NULL semantics.

---

## Source DDL — `EXW_Wallet.AmlProviderUsers.sql`

```sql
CREATE TABLE [EXW_Wallet].[AmlProviderUsers]
(
	[Id] [bigint] NULL,
	[AmlProviderId] [int] NULL,
	[Gcid] [int] NULL,
	[ProviderUserId] [varchar](max) NULL,
...
WITH
(
	DISTRIBUTION = HASH ( [AmlProviderId] ),
	HEAP
)

GO
CREATE NONCLUSTERED INDEX [XI_partition_date] ON [EXW_Wallet].[AmlProviderUsers]
(
	[partition_date] ASC
