...
| **Refresh** | Daily DELETE+INSERT on DateINT |
...
| Tier | Meaning |
|------|---------|
| Tier 1 | Verbatim from upstream production wiki — description copied as-is from the root source |
| Tier 2 | ETL-computed in SP — transform documented from SP source code |
| Tier 3 | Source identified but no upstream wiki available; description inferred from DDL + SP code |
...
| 10 | SymbolFull | varchar(100) | YES | Full/canonical symbol, UNIQUE in production. Used for instrument lookup. Primary identifier in Security Ops API. (Tier 1 — Trade.InstrumentMetaData) |
...
*Generated: 2026-04-28 | Regen Harness Attempt 2 | Quality: 7.5/10*
*Phases: P1 P2 P3 P4 P5 P6 P7 P8 P9 P9B P10A P10B P11 (P10 Jira: no tickets found)*
*Tiers: 5 T1, 6 T2, 10 T3, 0 T4 | Elements: 21/21*
