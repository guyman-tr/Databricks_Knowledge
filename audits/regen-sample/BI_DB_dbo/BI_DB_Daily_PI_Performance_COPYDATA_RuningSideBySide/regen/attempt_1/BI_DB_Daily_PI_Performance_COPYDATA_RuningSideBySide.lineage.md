...
| 10 | SymbolFull | DWH_dbo.Dim_Instrument | SymbolFull | Tier 1 | Passthrough via #TopPositionValue (top position by Value_percenet per CID); wiki: `knowledge/synapse/Wiki/DWH_dbo/Tables/Dim_Instrument.md` |
...
| 16 | CopyEquity | BI_DB_CopyDailyData | CopyAUM | Tier 1 | ISNULL(CopyAUM, 0); renamed CopyAUM → CopyEquity; wiki: `knowledge/synapse/Wiki/BI_DB_dbo/Tables/BI_DB_CopyDailyData.md` |
...
| 21 | Country | BI_DB_CopyDailyData | Country | Tier 1 | Passthrough; wiki: `knowledge/synapse/Wiki/BI_DB_dbo/Tables/BI_DB_CopyDailyData.md` |
