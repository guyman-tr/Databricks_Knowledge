...
- **Attempt**: `1`
- **Output directory** (relative to repo root): `audits/regen-sample/BI_DB_dbo/BI_DB_AML_Multiple_Accounts_SameIP_FullData/regen/attempt_1/`
- **Absolute output directory**: `C:\Users\guyman\Documents\github\Databricks_Knowledge\audits\regen-sample\BI_DB_dbo\BI_DB_AML_Multiple_Accounts_SameIP_FullData\regen\attempt_1`
- **Bundle path**: `C:\Users\guyman\Documents\github\Databricks_Knowledge\audits\regen-sample\BI_DB_dbo\BI_DB_AML_Multiple_Accounts_SameIP_FullData\regen\_upstream_bundle.md`
- **DDL path**: `c:\Users\guyman\Documents\github\DataPlatform\SynapseSQLPool1\sql_dp_prod_we\BI_DB_dbo\Tables\BI_DB_dbo.BI_DB_AML_Multiple_Accounts_SameIP_FullData.sql`
...
# Pre-Resolved Upstream Bundle for `BI_DB_dbo.BI_DB_AML_Multiple_Accounts_SameIP_FullData`

This bundle was assembled deterministically by the regen harness BEFORE the writer claude process started. Use this as your AUTHORITATIVE Tier 1 inheritance source. Quote descriptions VERBATIM from the upstream wikis below for any column that is a passthrough or rename of an upstream column. Do NOT paraphrase. Do NOT generalize vendor names. Do NOT drop NULL semantics.

---

## Source DDL — `BI_DB_dbo.BI_DB_AML_Multiple_Accounts_SameIP_FullData.sql`

```sql
CREATE TABLE [BI_DB_dbo].[BI_DB_AML_Multiple_Accounts_SameIP_FullData]
(
	[CID] [int] NULL,
	[HashIP] [nvarchar](250) NULL,
