...
- **Tier 1 (12 columns)**: CID, Customer, Currency, ExchangeRate, BaseExchangeRate, RegulationID, Regulation, PlayerLevelID, Club, PlayerStatus, RegCountry, RegCountryByIP, BinCountry, CardType — all dim-lookup passthroughs with upstream wiki traced to Dictionary source.
- **Tier 2 (25 columns)**: All SP-computed or multi-source columns including TransactionType, PIPsCalculation, Amount, AmountUSD, MIDValue, Entity, etc.
