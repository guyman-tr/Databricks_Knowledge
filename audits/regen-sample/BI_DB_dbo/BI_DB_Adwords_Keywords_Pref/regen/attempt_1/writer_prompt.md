...
- **Attempt**: `1`
- **Output directory** (relative to repo root): `audits/regen-sample/BI_DB_dbo/BI_DB_Adwords_Keywords_Pref/regen/attempt_1/`
- **Absolute output directory**: `C:\Users\guyman\Documents\github\Databricks_Knowledge\audits\regen-sample\BI_DB_dbo\BI_DB_Adwords_Keywords_Pref\regen\attempt_1`
- **Bundle path**: `C:\Users\guyman\Documents\github\Databricks_Knowledge\audits\regen-sample\BI_DB_dbo\BI_DB_Adwords_Keywords_Pref\regen\_upstream_bundle.md`
- **DDL path**: `c:\Users\guyman\Documents\github\DataPlatform\SynapseSQLPool1\sql_dp_prod_we\BI_DB_dbo\Tables\BI_DB_dbo.BI_DB_Adwords_Keywords_Pref.sql`
...
# Pre-Resolved Upstream Bundle for `BI_DB_dbo.BI_DB_Adwords_Keywords_Pref`

This bundle was assembled deterministically by the regen harness BEFORE the writer claude process started. Use this as your AUTHORITATIVE Tier 1 inheritance source. Quote descriptions VERBATIM from the upstream wikis below for any column that is a passthrough or rename of an upstream column. Do NOT paraphrase. Do NOT generalize vendor names. Do NOT drop NULL semantics.

---

## Source DDL — `BI_DB_dbo.BI_DB_Adwords_Keywords_Pref.sql`

```sql
CREATE TABLE [BI_DB_dbo].[BI_DB_Adwords_Keywords_Pref]
(
	[date] [date] NOT NULL,
	[DateID] [int] NOT NULL,
	...
	[search_budget_lost_top_impression_share] [nvarchar](256) NULL,
	[account_currency_code] [nvarchar](256) NULL,
	[campaign_id] [bigint] NULL,
	[interactions] [bigint] NULL,
	[search_impression_share] [nvarchar](256) NULL,
	[id] [bigint] NULL,
	[ad_group_id] [bigint] NULL,
	[clicks] [bigint] NULL,
	[search_rank_lost_impression_share] [nvarchar](256) NULL,
	[week] [nvarchar](256) NULL,
	[UpdateDate] [datetime] NULL,
	[Conversions] [bigint] NULL,
	[KeywordMatchType] [nvarchar](256) NULL
)
WITH
(
...
### Upstream `BI_DB_dbo.BI_DB_Adwords_Keywords_Conv` — synapse
- **Resolved as**: `BI_DB_dbo.BI_DB_Adwords_Keywords_Conv`
- **Wiki path**: `C:\Users\guyman\Documents\github\Databricks_Knowledge\knowledge\synapse\Wiki\BI_DB_dbo\Tables\BI_DB_Adwords_Keywords_Conv.md`
...
| `BI_DB_dbo.BI_DB_Adwords_Keywords_Conv` | synapse | BI_DB_dbo | BI_DB_Adwords_Keywords_Conv | `C:\Users\guyman\Documents\github\Databricks_Knowledge\knowledge\synapse\Wiki\BI_DB_dbo\Tables\BI_DB_Adwords_Keywords_Conv.md` |
