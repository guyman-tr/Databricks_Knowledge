...
- **Attempt**: `1`
- **Output directory** (relative to repo root): `audits/regen-sample/BI_DB_dbo/BI_DB_Adwords_Dictionary_AdGroup/regen/attempt_1/`
- **Absolute output directory**: `C:\Users\guyman\Documents\github\Databricks_Knowledge\audits\regen-sample\BI_DB_dbo\BI_DB_Adwords_Dictionary_AdGroup\regen\attempt_1`
- **Bundle path**: `C:\Users\guyman\Documents\github\Databricks_Knowledge\audits\regen-sample\BI_DB_dbo\BI_DB_Adwords_Dictionary_AdGroup\regen\_upstream_bundle.md`
- **DDL path**: `c:\Users\guyman\Documents\github\DataPlatform\SynapseSQLPool1\sql_dp_prod_we\BI_DB_dbo\Tables\BI_DB_dbo.BI_DB_Adwords_Dictionary_AdGroup.sql`
...
# Pre-Resolved Upstream Bundle for `BI_DB_dbo.BI_DB_Adwords_Dictionary_AdGroup`

This bundle was assembled deterministically by the regen harness BEFORE the writer claude process started. Use this as your AUTHORITATIVE Tier 1 inheritance source. Quote descriptions VERBATIM from the upstream wikis below for any column that is a passthrough or rename of an upstream column. Do NOT paraphrase. Do NOT generalize vendor names. Do NOT drop NULL semantics.

---

## Source DDL — `BI_DB_dbo.BI_DB_Adwords_Dictionary_AdGroup.sql`

```sql
CREATE TABLE [BI_DB_dbo].[BI_DB_Adwords_Dictionary_AdGroup]
(
	[campaign_id] [bigint] NULL,
	[ad_group_id] [bigint] NULL,
	[ad_group_name] [nvarchar](256) NULL,
	[target_cpa] [float] NULL,
	[UpdateDate] [datetime] NULL,
	[ad_group_status] [nvarchar](256) NULL
)
WITH
(
