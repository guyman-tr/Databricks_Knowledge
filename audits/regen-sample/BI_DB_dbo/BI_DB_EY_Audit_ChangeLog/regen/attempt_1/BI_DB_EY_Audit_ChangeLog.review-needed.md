...
- **ChangeTypeID=13** has no confirmed label. The SP applies IsSettled/unit backfill logic specifically for this type, suggesting it is settlement-related. Only ~13K rows exist (vs 86M for type 12). Expert should confirm the meaning.
