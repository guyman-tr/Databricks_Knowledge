...
- **Attempt**: `1`
- **Output directory** (relative to repo root): `audits/regen-sample/BI_DB_dbo/BI_DB_Adwords_Search_Conv/regen/attempt_1/`
- **Absolute output directory**: `C:\Users\guyman\Documents\github\Databricks_Knowledge\audits\regen-sample\BI_DB_dbo\BI_DB_Adwords_Search_Conv\regen\attempt_1`
- **Bundle path**: `C:\Users\guyman\Documents\github\Databricks_Knowledge\audits\regen-sample\BI_DB_dbo\BI_DB_Adwords_Search_Conv\regen\_upstream_bundle.md`
- **DDL path**: `c:\Users\guyman\Documents\github\DataPlatform\SynapseSQLPool1\sql_dp_prod_we\BI_DB_dbo\Tables\BI_DB_dbo.BI_DB_Adwords_Search_Conv.sql`
...
# Pre-Resolved Upstream Bundle for `BI_DB_dbo.BI_DB_Adwords_Search_Conv`

This bundle was assembled deterministically by the regen harness BEFORE the writer claude process started. Use this as your AUTHORITATIVE Tier 1 inheritance source. Quote descriptions VERBATIM from the upstream wikis below for any column that is a passthrough or rename of an upstream column. Do NOT paraphrase. Do NOT generalize vendor names. Do NOT drop NULL semantics.

---

## Source DDL — `BI_DB_dbo.BI_DB_Adwords_Search_Conv.sql`

```sql
CREATE TABLE [BI_DB_dbo].[BI_DB_Adwords_Search_Conv]
(
	[month] [nvarchar](256) NULL,
	[customer_id] [bigint] NOT NULL,
	[query] [nvarchar](256) NULL,
	[device] [nvarchar](256) NULL,
	[query_targeting_status] [nvarchar](256) NULL,
	[external_customer_id] [bigint] NULL,
	[query_match_type_with_variant] [nvarchar](256) NULL,
	[keyword_id] [bigint] NULL,
	[account_currency_code] [nvarchar](256) NULL,
	[campaign_id] [bigint] NULL,
	[ad_group_id] [bigint] NULL,
	[final_url] [nvarchar](256) NULL,
	[search_key] [nvarchar](1340) NULL,
	[Registration] [float] NULL,
	[V2] [float] NULL,
	[FTD] [float] NULL,
	[MultipleDeposit] [float] NULL,
	[FTDA] [float] NULL,
	[MTDA] [float] NULL,
