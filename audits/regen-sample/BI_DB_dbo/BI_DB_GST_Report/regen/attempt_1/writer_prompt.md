...
- **Attempt**: `1`
- **Output directory** (relative to repo root): `audits/regen-sample/BI_DB_dbo/BI_DB_GST_Report/regen/attempt_1/`
- **Absolute output directory**: `C:\Users\guyman\Documents\github\Databricks_Knowledge\audits\regen-sample\BI_DB_dbo\BI_DB_GST_Report\regen\attempt_1`
- **Bundle path**: `C:\Users\guyman\Documents\github\Databricks_Knowledge\audits\regen-sample\BI_DB_dbo\BI_DB_GST_Report\regen\_upstream_bundle.md`
- **DDL path**: `c:\Users\guyman\Documents\github\DataPlatform\SynapseSQLPool1\sql_dp_prod_we\BI_DB_dbo\Tables\BI_DB_dbo.BI_DB_GST_Report.sql`
...
# Pre-Resolved Upstream Bundle for `BI_DB_dbo.BI_DB_GST_Report`

This bundle was assembled deterministically by the regen harness BEFORE the writer claude process started. Use this as your AUTHORITATIVE Tier 1 inheritance source. Quote descriptions VERBATIM from the upstream wikis below for any column that is a passthrough or rename of an upstream column. Do NOT paraphrase. Do NOT generalize vendor names. Do NOT drop NULL semantics.

---

## Source DDL — `BI_DB_dbo.BI_DB_GST_Report.sql`

```sql
CREATE TABLE [BI_DB_dbo].[BI_DB_GST_Report]
(
	[RealCID] [int] NULL,
	[Regulation] [varchar](20) NULL,
	[Club] [varchar](20) NULL,
	[Entity] [varchar](50) NULL,
	[Is_eToro Group Trading] [int] NULL,
	[Date] [date] NULL,
	[Real Stocks] [float] NULL,
	[Real ETF] [float] NULL,
	[Real Indices] [float] NULL,
	[Real Commodities] [float] NULL,
	[Real Crypto Currencies] [float] NULL,
	[Real Currenciess] [float] NULL,
	[CFD Stocks] [float] NULL,
	[CFD ETF] [float] NULL,
	[CFD Indices] [float] NULL,
	[CFD Commodities] [float] NULL,
	[CFD Crypto Currencies] [float] NULL,
	[CFD Currenciess] [float] NULL,
	[OvernightFee] [float] NULL,
	[CashoutFee] [float] NULL,
	[ConversionFee] [float] NULL,
	[TotalDormantFee] [float] NULL,
	[Staking_Revshare] [float] NULL,
	[UpdateDate] [date] NULL,
	[TicketingFee] [float] NULL,
	[IslamicFee] [float] NULL,
	[TicketingFeeByPercent] [float] NULL
)
WITH
(
...
### Upstream `BI_DB_dbo.BI_DB_DDR_CID_Level` — synapse
- **Resolved as**: `BI_DB_dbo.BI_DB_DDR_CID_Level`
- **Wiki path**: `C:\Users\guyman\Documents\github\Databricks_Knowledge\knowledge\synapse\Wiki\BI_DB_dbo\Tables\BI_DB_DDR_CID_Level.md`
...
| 159 | StockTraderWithLoss | numeric(38,6) | YES | FLAG: 1 if t
...
### Upstream `BI_DB_dbo.Function_Revenue_TicketFee` — synapse
- **Resolved as**: `BI_DB_dbo.Function_Revenue_TicketFee`
- **Wiki path**: `C:\Users\guyman\Documents\github\Databricks_Knowledge\knowledge\synapse\Wiki\BI_DB_dbo\Functions\Function_Revenue_TicketFee.md`
...
### Upstream `BI_DB_dbo.Function_Revenue_TicketFeeByPercent` — synapse
- **Resolved as**: `BI_DB_dbo.Function_Revenue_TicketFeeByPercent`
- **Wiki path**: `C:\Users\guyman\Documents\github\Databricks_Knowledge\knowledge\synapse\Wiki\BI_DB_dbo\Functions\Function_Revenue_TicketFeeByPercent.md`
...
|---|--------|--------|----------------|------|
| 1 | RealCID | BI_DB_Fact_Customer_Action_Position_Distribution.RealCID | Direct | T1 |
| 2 | Occurred | Fact_History_Cost.Occurred | Direct | T1 |
| 3 | InstrumentID | BI_DB_Fact_Customer_Action_Position_Distribution.InstrumentID | Direct | T1 |
| 4 | PositionID | Fact_History_Cost.PositionID | Direct | T1 |
| 5 | DateID | Fact_History_Cost.DateID | Direct | T1 |
| 6 | IsSettled | BI_DB_Fact_Customer_Action_Position_Distribution.IsSettled | Direct | T1 |
| 7 | MirrorID | Fact_History_Cost.MirrorID | Direct | T1 |
| 8 | Leverage | BI_DB_Fact_Customer_Action_Position_Distribution.Leverage | Direct | T1 |
| 9 | IsAirDrop | BI_DB_Fact_Customer_Action_Position_Distribution.IsAirDrop | Direct | T1 |
| 10 | GCID | BI_DB_Fact_Customer_Action_Position_Distribution.GCID | Direct | T1 |
| 11 | CountryID | BI_DB_Fact_Customer_Action_Position_Distribution.CountryID | Direct | T1 |
...
### Upstream `Dealing_dbo.Dealing_Staking_Parameters` — synapse
- **Resolved as**: `Dealing_dbo.Dealing_Staking_Parameters`
- **Wiki path**: `C:\Users\guyman\Documents\github\Databricks_Knowledge\knowledge\synapse\Wiki\Dealing_dbo\Tables\Dealing_Staking_Parameters.md`
...
### SP `BI_DB_dbo.SP_GST_Report`
- **Path**: `c:\Users\guyman\Documents\github\DataPlatform\SynapseSQLPool1\sql_dp_prod_we\BI_DB_dbo\Stored Procedures\BI_DB_dbo.SP_GST_Report.sql`
...
GO
CREATE PROC [BI_DB_dbo].[SP_GST_Report] @Date [DATE] AS
...
20241030          Adi Meidan      Add ETH and SOL to the Staking RevShare Calculation
20250510		  Markos Chris	  Update Revenue Share Calculation & Automate new instruments
20251015		  Markos Chris    Updated Ticket Fee calculation logic
								  Replaced usage of Fact_CustomerAction with function-based implementation for better consistency and maintainability. 
								  Added TicketFeeByPercent as a separate calculation and metric, distinct from TicketFee.
20260206		  Markos Chris	  Change the source table for Staking table.
****************************************End Main Comment History****************************************************/
BEGIN

--EXEC [BI_DB_dbo].[SP_GST_Report] '2025-08-20'

/*
SELECT sum(bdgr.Staking_Revshare),bdgr.Date FROM BI_DB_dbo.BI_DB_GST_Report bdgr
WHERE bdgr.Date BETWEEN '20260101' AND '20260131'group BY bdgr.Date
order by bdgr.Date
*/
...
SELECT fsc.RealCID,
	   dr1.Name 'Regulation',
	   dpl.Name 'Club',
	   CASE WHEN fsc.RegulationID IN (4,10) THEN'eToro Capital Australia' -- NFA and ASIC & GAML
			WHEN fsc.RegulationID=2 THEN 'eToro UK' -- FCA
			ELSE NULL 
	   END AS 'Entity',
	   CASE WHEN fsc.RegulationID IN (1,2,4,10,9) THEN 1 
			ELSE 0 
	   END AS 'Is_eToro Group Trading', -- CySEC, FCA, ASIC, ASIC & GAML, FSA Seychelles
	   @DateID AS 'DateID',
	   fsc.PlayerLevelID
...
WHERE fsc.IsCreditReportValidCB=1 
	  AND fsc.CountryID =183 -- Singapore
	  AND fsc.IsValidCustomer=1 
	  AND fsc.IsDepositor=1

/****************** Commission Calc ********************/
IF OBJECT_ID('tempdb..#commisions01') IS NOT NULL DROP TABLE #commisions01
CREATE TABLE #commisions01
...
SELECT 
	...
	,di.InstrumentType
	,p.RealCID
	,sum(case when IsSettled=1 then CommissionOnClose else null end) as CommissionReal
	,sum(case when IsSettled=0 then CommissionOnClose else null end) as CommissionCFD
FROM #pop p
JOIN DWH_dbo.Fact_CustomerAction f WITH (NOLOCK) 
ON p.RealCID = f.RealCID
JOIN DWH_dbo.Fact_SnapshotCustomer fsc WITH (NOLOCK)
ON f.RealCID = fsc.RealCID
JOIN DWH_dbo.Dim_Range dr WITH (NOLOCK)
ON fsc.DateRangeID = dr.DateRangeID 
AND f.DateID BETWEEN dr.FromDateID AND dr.ToDateID
JOIN DWH_dbo.Dim_Instrument di ON f.InstrumentID = di.InstrumentID
WHERE f.DateID=@DateID 
	  AND fsc.IsCreditReportValidCB=1
GROUP BY di.InstrumentType,p.RealCID
 

IF OBJECT_ID('tempdb..#commision02') IS NOT NULL DROP TABLE #commision02
CREATE TABLE #commision02
    WITH (HEAP,DISTRIBUTION=HASH(RealCID))
AS
SELECT  p1.RealCID,
		SUM(bddcl.OvernightFee) AS 'OvernightFee',
		SUM(ISNULL(bddcl.CashoutFee,0)) AS 'CashoutFee',
		SUM(ISNULL(bddcl.DormantFee,0)) AS 'TotalDormantFee',
		sum(isnull(bddcl.TransferCoinFees,0)) as 'TransferCoinFee',
		@DateID 'DateID'
FROM BI_DB_dbo.BI_DB_DDR_CID_Level bddcl
JOIN #pop p1 
ON p1.RealCID=bddcl.CID 
AND bddcl.DateID=@DateID 
AND bddcl.IsCreditReportValidCB=1
GROUP BY 
	p1.RealCID

/****************** Calculate conversion fee ********************/
IF OBJECT_ID('tempdb..#commision03') IS NOT NULL DROP TABLE #commision03
CREATE TABLE #commision03
    WITH (HEAP,DISTRIBUTION=HASH(RealCID))
AS
SELECT  p.RealCID,
		SUM(ISNULL(bddwf.PIPsCalculation,0)) AS 'ConversionFee',
		@DateID 'DateID'
FROM BI_DB_dbo.BI_DB_DepositWithdrawFee bddwf
JOIN #pop p 
ON p.RealCID=bddwf.CID 
WHERE 
	bddwf.DateID=@DateID
GROUP BY 
	p.RealCID
...
/****************** Ticketing Fee ********************/
IF OBJECT_ID('tempdb..#commision04') IS NOT NULL DROP TABLE #commision04
CREATE TABLE #commision04
    WITH (HEAP,DISTRIBUTION=HASH(RealCID))
AS

SELECT p1.RealCID,
		-sum(IsNull(frtf.TicketFee,0)) AS 'TicketingFee',
		@DateID AS 'DateID'
FROM BI_DB_dbo.Function_Revenue_TicketFee(@DateID,@DateID,1) frtf
JOIN #pop p1 
ON frtf.RealCID = p1.RealCID

GROUP BY
	p1.RealCID

/****************** Ticketing Fee By Percent ********************/
IF OBJECT_ID('tempdb..#commision04_Extra') IS NOT NULL DROP TABLE #commision04_Extra
CREATE TABLE #commision04_Extra
    WITH (HEAP,DISTRIBUTION=HASH(RealCID))
AS

SELECT p1.RealCID,
		-sum(IsNull(frtf.TicketFeeByPercent,0)) AS 'TicketingFeeByPercent',
		@DateID AS 'DateID'
FROM BI_DB_dbo.Function_Revenue_TicketFeeByPercent (@DateID,@DateID,1) frtf
JOIN #pop p1 
ON frtf.RealCID = p1.RealCID
...
/****************** Islamic Fee ********************/
IF OBJECT_ID('tempdb..#commision05') IS NOT NULL DROP TABLE #commision05
CREATE TABLE #commision05
    WITH (HEAP,DISTRIBUTION=HASH(RealCID))
AS
SELECT  p1.RealCID,
		sum(ISNULL(fca.Amount,0)) AS 'IslamicFee',
		@DateID 'DateID'
FROM DWH_dbo.Fact_CustomerAction fca
JOIN #pop p1 
ON fca.RealCID = p1.RealCID
WHERE 
	fca.ActionTypeID=36 -- Compensation
	AND fca.CompensationReasonID IN (117,118) -- Administration fee, Spot price adjustment
	AND fca.DateID=@DateID
GROUP BY 
	p1.RealCID

/****************** Staking Income ********************/
IF OBJECT_ID('tempdb..#comp_data') IS NOT NULL DROP TABLE #comp_data
...
WHERE 
	  DateID=@DateID 
	  AND ActionTypeID=36 -- Compensation 
	  AND CompensationReasonID=3 -- Technical Problem
group by 
	DateID
	,fca.RealCID

IF OBJECT_ID('tempdb..#comp_final') IS NOT NULL DROP TABLE #comp_final
CREATE TABLE #comp_final
    WITH (HEAP,DISTRIBUTION=ROUND_ROBIN)
AS
SELECT  a1.RealCID 'CID',
		a1.Amount,
		a1.DateID,
		/*CASE WHEN p.PlayerLevelID IN (1) THEN 0.75 
					 WHEN p.PlayerLevelID IN (5, 3, 2) THEN 0.85
					 WHEN p.PlayerLevelID IN (6, 7) THEN 0.90
					 ELSE 1
		END  AS 'RevShare'*/
		CASE	WHEN p.PlayerLevelID = 1 THEN 0.45 --Bronze
				WHEN p.PlayerLevelID = 5 THEN 0.55 -- Silver
				WHEN p.PlayerLevelID = 3 THEN 0.65 -- Gold
				WHEN p.PlayerLevelID = 2 THEN 0.75 -- Platinum
				WHEN p.PlayerLevelID = 6 THEN 0.85 -- Platinum Plus
				WHEN p.PlayerLevelID = 7 THEN 0.90 -- Diamond
		ELSE 1 END RevShare
from  #comp_data a1
join #pop p 
ON  p.RealCID=a1.RealCID 
	AND p.DateID=a1.DateID

/****************** Airdrops ********************/
IF OBJECT_ID('tempdb..#airdrops_pos') IS NOT NULL DROP TABLE #airdrops_pos
CREATE TABLE #airdrops_pos
    WITH (HEAP,DISTRIBUTION=ROUND_ROBIN)
AS

SELECT  OpenDateID
		,CID
		,sum(pos.InitialAmountCents/100) as 'Amount'
from DWH_dbo.Dim_Position pos
JOIN (SELECT DISTINCT InstrumentID  FROM Dealing_dbo.Dealing_Staking_Parameters WHERE DailyPool_StartDate <= @Date) dsc /*New automated*/ -- Previous table was not updated until the begin of the next month. 
ON pos.InstrumentID = dsc.InstrumentID
where 
	  IsAirDrop=1 
	  and OpenDateID=@DateID  
	  /*and pos.InstrumentID in (100017,100026,100001,100063) */
GROUP BY 
	  OpenDateID
	  ,CID

IF OBJECT_ID('tempdb..#airdrops_final') IS NOT NULL DROP TABLE #airdrops_final
CREATE TABLE #airdrops_final
    WITH (HEAP,DISTRIBUTION=ROUND_ROBIN)
AS
SELECT 
	/*
    ...
    ELSE 1 END RevShare
	,CID
	,pos.OpenDateID 'DateID'
	,pos.Amount
from #airdrops_pos pos
join #pop p 
ON pos.CID=p.RealCID 
AND p.DateID=pos.OpenDateID

/****************** Rev Share Calc ********************/
IF OBJECT_ID('tempdb..#union_staking') IS NOT NULL DROP TABLE #union_staking
CREATE TABLE #union_staking
    WITH (HEAP,DISTRIBUTION=ROUND_ROBIN)
AS
SELECT  RevShare
		,CID
...
IF OBJECT_ID('tempdb..#staking_revshare') IS NOT NULL DROP TABLE #staking_revshare
CREATE TABLE #staking_revshare
    WITH (HEAP,DISTRIBUTION=ROUND_ROBIN)
AS
SELECT  a1.CID,
		a1.DateID,
		SUM(a1.Amount*(1-RevShare)/RevShare) as 'eToro RevShare'
from #union_staking a1
group by a1.CID
		 ,a1.DateID
...
SELECT 
   ...
   ,p.Club
   ,p.Entity
   ,p.[Is_eToro Group Trading]
   ,CONVERT(date, convert(varchar(10), p.DateID)) 'Date'

  ,SUM(c.[Real Stocks]) 'Real Stocks'
  ,SUM(c.[Real ETF]) 'Real ETF'
  ,SUM(c.[Real Indices]) 'Real Indices'
  ,SUM(c.[Real Commodities]) 'Real Commodities'
  ,SUM(c.[Real Crypto Currencies]) 'Real Crypto Currencies'
  ,SUM(c.[Real Currenciess]) 'Real Currenciess'
   
  ,SUM(c.[CFD Stocks]) 'CFD Stocks'
  ,SUM(c.[CFD ETF]) 'CFD ETF'
  ,SUM(c.[CFD Indices]) 'CFD Indices'
  ,SUM(c.[CFD Commodities]) 'CFD Commodities'
  ,SUM(c.[CFD Crypto Currencies]) 'CFD Crypto Currencies'
  ,SUM(c.[CFD Currenciess]) 'CFD Currenciess'

  ,SUM(isnull(c1.OvernightFee,0)) 'OvernightFee'
  ,SUM(isnull(c1.CashoutFee,0))'CashoutFee'
  ,SUM(isnull(c2.ConversionFee,0)) 'ConversionFee'
  ,SUM(ISNULL(c1.TotalDormantFee,0)) 'TotalDormantFee'
  ,sum(isnull(c1.TransferCoinFee,0)) 'TransferCoinFee'
  ,SUM(ISNULL(s.[eToro RevShare],0))as 'Staking_Revshare'
  ,sum(ISNULL(c3.TicketingFee,0)) AS 'TicketingFee'
  ,sum(ISNULL(ce.TicketingFeeByPercent,0)) AS 'TicketingFeeByPercent'
  ,SUM(ISNULL(c4.IslamicFee,0)) AS 'IslamicFee'
FROM #pop p 
LEFT JOIN (select  c.RealCID,c.DateID
  ,SUM(isnull(CASE WHEN c.InstrumentType='Stocks' THEN c.CommissionReal ELSE NULL end,0)) 'Real Stocks'
  ,SUM(isnull(CASE WHEN c.InstrumentType='ETF' THEN c.CommissionReal ELSE NULL end,0)) 'Real ETF'
  ,SUM(isnull(CASE WHEN c.InstrumentType='Indices' THEN c.CommissionReal ELSE NULL end,0)) 'Real Indices'
  ,SUM(isnull(CASE WHEN c.InstrumentType='Commodities' THEN c.CommissionReal ELSE NULL end,0)) 'Real Commodities'
  ,SUM(isnull(CASE WHEN c.InstrumentType='Crypto Currencies' THEN c.CommissionReal ELSE NULL end,0)) 'Real Crypto Currencies'
  ,SUM(isnull(CASE WHEN c.InstrumentType='Currencies' THEN c.CommissionReal ELSE NULL end,0)) 'Real Currenciess'
   
  ,SUM(isnull(CASE WHEN c.InstrumentType='Stocks' THEN c.CommissionCFD ELSE NULL end,0)) 'CFD Stocks'
  ,SUM(isnull(CASE WHEN c.InstrumentType='ETF' THEN c.CommissionCFD ELSE NULL end,0)) 'CFD ETF'
  ,SUM(isnull(CASE WHEN c.InstrumentType='Indices' THEN c.CommissionCFD ELSE NULL end,0)) 'CFD Indices'
  ,SUM(isnull(CASE WHEN c.InstrumentType='Commodities' THEN c.CommissionCFD ELSE NULL end,0)) 'CFD Commodities'
  ,SUM(isnull(CASE WHEN c.InstrumentType='Crypto Currencies' THEN c.CommissionCFD ELSE NULL end,0)) 'CFD Crypto Currencies'
  ,SUM(isnull(CASE WHEN c.InstrumentType='Currencies' THEN c.CommissionCFD ELSE NULL end,0)) 'CFD Currenciess'
  
   from #commisions01 c
   group by c.RealCID,c.DateID)c ON c.DateID=p.DateID AND c.RealCID=p.RealCID
LEFT JOIN #commision02 c1 
ON p.RealCID = c1.RealCID AND p.DateID = c1.DateID
LEFT JOIN #commision03 c2 
ON c2.RealCID = p.RealCID AND c2.DateID = p.DateID
LEFT JOIN #staking_revshare s 
ON s.CID=p.RealCID AND p.DateID = s.DateID
LEFT JOIN #commision04 c3 
ON p.RealCID = c3.RealCID AND p.DateID=c3.DateID
LEFT JOIN #commision04_Extra ce 
ON p.RealCID = ce.RealCID AND p.DateID=ce.DateID
LEFT JOIN #commision05 c4 
ON p.RealCID = c4.RealCID AND p.DateID = c4.DateID
--WHERE (c.RealCID IS NOT NULL OR c1.RealCID IS NOT NULL OR c2.RealCID IS NOT NULL OR s.CID IS NOT null) 
GROUP BY p.RealCID
		 ,p.Regulation
		 ,p.Club
		 ,p.Entity
		 ,p.[Is_eToro Group Trading]
		 ,CONVERT(date, convert(varchar(10), p.DateID))


 IF OBJECT_ID('tempdb..#final_2') IS NOT NULL DROP TABLE #final_2
...
SELECT RealCID
   ...
   ,Club 
   ,Entity 
   ,[Is_eToro Group Trading] 
   ,[Date] 

  ,isnull([Real Stocks],0) as 'Real Stocks'
  ,isnull([Real ETF],0) as 'Real ETF'
  ,isnull([Real Indices],0) as 'Real Indices'
  ,isnull([Real Commodities],0) as 'Real Commodities'
  ,isnull([Real Crypto Currencies],0) as 'Real Crypto Currencies'
  ,isnull([Real Currenciess],0) as 'Real Currenciess'
 
  ,isnull([CFD Stocks],0) as 'CFD Stocks'
  ,isnull([CFD ETF],0) as 'CFD ETF'
  ,isnull([CFD Indices],0) as 'CFD Indices'
  ,isnull([CFD Commodities],0) as 'CFD Commodities'
  ,isnull([CFD Crypto Currencies],0) as 'CFD Crypto Currencies'
  ,isnull([CFD Currenciess],0) as 'CFD Currenciess'

   ,isnull([OvernightFee],0) AS 'OvernightFee'
   ,[CashoutFee]+TransferCoinFee 'CashoutFee'
   ,[ConversionFee]
   ,TotalDormantFee
   ,Staking_Revshare
   ,@Date AS UpdateDate
   ,ISNULL(a.TicketingFee,0) AS 'TicketingFee'
   ,isnull(a.TicketingFeeByPercent,0) AS 'TicketingFeeByPercent'
   ,ISNULL(IslamicFee,0) AS 'IslamicFee'
FROM #final a
WHERE --Entity IS NOT NULL 
( [Real Stocks]<>0
  or [Real ETF]<>0
  or [Real Indices]<>0
  or [Real Commodities]<>0
  or [Real Crypto Currencies]<>0
  or [Real Currenciess]<>0

  or [CFD Stocks]>0
  or [CFD ETF]>0
  or [CFD Indices]<>0
  or [CFD Commodities]<>0
  or [CFD Crypto Currencies]<>0
  or [CFD Currenciess]<>0

   or [OvernightFee]<>0
   or [CashoutFee]<>0
   or [ConversionFee]<>0
   or TotalDormantFee <>0
   OR Staking_Revshare<>0
   OR IslamicFee<>0
   OR a.TicketingFee<>0
   OR a.TicketingFeeByPercent <>0)

--SELECT RealCID, SUM(Staking_Revshare) Staking_Revshare FROM #final_2 WHERE RealCID IN (6357726,23643748) GROUP BY RealCID

/****************** Delete and Insert ********************/
DELETE FROM BI_DB_dbo.BI_DB_GST_Report
WHERE [Date]=@Date


INSERT INTO BI_DB_dbo.BI_DB_GST_Report(
RealCID
	  ,Regulation
	  ,Club
	  ,Entity
...
|---|---|---|---|---|
| `BI_DB_dbo.SP_GST_Report` | synapse_sp | BI_DB_dbo | SP_GST_Report | `c:\Users\guyman\Documents\github\DataPlatform\SynapseSQLPool1\sql_dp_prod_we\BI_DB_dbo\Stored Procedures\BI_DB_dbo.SP_GST_Report.sql` |
...
| `BI_DB_dbo.BI_DB_DDR_CID_Level` | synapse | BI_DB_dbo | BI_DB_DDR_CID_Level | `C:\Users\guyman\Documents\github\Databricks_Knowledge\knowledge\synapse\Wiki\BI_DB_dbo\Tables\BI_DB_DDR_CID_Level.md` |
...
| `BI_DB_dbo.Function_Revenue_TicketFee` | synapse | BI_DB_dbo | Function_Revenue_TicketFee | `C:\Users\guyman\Documents\github\Databricks_Knowledge\knowledge\synapse\Wiki\BI_DB_dbo\Functions\Function_Revenue_TicketFee.md` |
| `BI_DB_dbo.Function_Revenue_TicketFeeByPercent` | synapse | BI_DB_dbo | Function_Revenue_TicketFeeByPercent | `C:\Users\guyman\Documents\github\Databricks_Knowledge\knowledge\synapse\Wiki\BI_DB_dbo\Functions\Function_Revenue_TicketFeeByPercent.md` |
...
| `Dealing_dbo.Dealing_Staking_Parameters` | synapse | Dealing_dbo | Dealing_Staking_Parameters | `C:\Users\guyman\Documents\github\Databricks_Knowledge\knowledge\synapse\Wiki\Dealing_dbo\Tables\Dealing_Staking_Parameters.md` |
