...
|--------------|--------------|---------------|-----------|------|
| Date | BI_DB_dbo.DWH_GainDaily | Date | Passthrough (filtered to Jan 1 dates via V_Dim_Date WHERE DayNumberOfYear=1) | Tier 1 |
| CID | BI_DB_dbo.DWH_GainDaily | CID | Passthrough | Tier 1 |
| Gain_y | BI_DB_dbo.DWH_GainDaily | Gain_y | Passthrough | Tier 1 |
