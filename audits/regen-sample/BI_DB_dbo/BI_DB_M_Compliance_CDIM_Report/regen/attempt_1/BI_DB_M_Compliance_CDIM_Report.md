...
| 20 | IsTradedDemo | int | YES | Whether the user has traded on demo. 1=traded, 0=registered but never traded. Passthrough from BI_DB_Demo_CID_Panel. (Tier 1 -- BI_DB_Demo_CID_Panel) |
