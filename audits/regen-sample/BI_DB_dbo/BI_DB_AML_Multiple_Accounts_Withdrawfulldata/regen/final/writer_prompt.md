...
- **Attempt**: `2`
- **Output directory** (relative to repo root): `audits/regen-sample/BI_DB_dbo/BI_DB_AML_Multiple_Accounts_Withdrawfulldata/regen/attempt_2/`
- **Absolute output directory**: `C:\Users\guyman\Documents\github\Databricks_Knowledge\audits\regen-sample\BI_DB_dbo\BI_DB_AML_Multiple_Accounts_Withdrawfulldata\regen\attempt_2`
- **Bundle path**: `C:\Users\guyman\Documents\github\Databricks_Knowledge\audits\regen-sample\BI_DB_dbo\BI_DB_AML_Multiple_Accounts_Withdrawfulldata\regen\_upstream_bundle.md`
- **DDL path**: `c:\Users\guyman\Documents\github\DataPlatform\SynapseSQLPool1\sql_dp_prod_we\BI_DB_dbo\Tables\BI_DB_dbo.BI_DB_AML_Multiple_Accounts_Withdrawfulldata.sql`
...
# Pre-Resolved Upstream Bundle for `BI_DB_dbo.BI_DB_AML_Multiple_Accounts_Withdrawfulldata`

This bundle was assembled deterministically by the regen harness BEFORE the writer claude process started. Use this as your AUTHORITATIVE Tier 1 inheritance source. Quote descriptions VERBATIM from the upstream wikis below for any column that is a passthrough or rename of an upstream column. Do NOT paraphrase. Do NOT generalize vendor names. Do NOT drop NULL semantics.

---

## Source DDL — `BI_DB_dbo.BI_DB_AML_Multiple_Accounts_Withdrawfulldata.sql`

```sql
CREATE TABLE [BI_DB_dbo].[BI_DB_AML_Multiple_Accounts_Withdrawfulldata]
(
	[FundingID] [int] NULL,
	[CID] [int] NULL,
	[GCID] [int] NULL,
	...
	[PhoneVerifiedName] [nvarchar](250) NULL,
	[RegisteredReal] [datetime] NULL,
	[FirstDepositDate] [datetime] NULL,
	[VerificationLevelID] [int] NULL,
	[Country] [nvarchar](250) NULL,
	[Regulation] [nvarchar](250) NULL,
	[PlayerStatus] [nvarchar](250) NULL,
	[PlayerStatusReason] [nvarchar](250) NULL,
	[PlayerStatusSubReasonName] [nvarchar](250) NULL,
	[Club] [nvarchar](250) NULL,
	[AffiliateID] [int] NULL,
	[City] [nvarchar](250) NULL,
	[Zip] [nvarchar](250) NULL,
	[BuildingNumber] [nvarchar](250) NULL,
	[Gender] [nvarchar](250) NULL,
	[EvMatchStatusName] [nvarchar](250) NULL,
	[HasWallet] [int] NULL,
	[AccountProgram] [nvarchar](250) NULL,
	[Liabilities] [money] NULL,
	[RealizedEquity] [money] NULL,
	[PositionPnL] [money] NULL,
	[TotalEquity] [money] NULL,
	[AlertID] [int] NULL,
	[CreationDate] [datetime] NULL,
	[ModificationDate] [datetime] NULL,
	[AlertType] [nvarchar](250) NULL,
	[AlertTypeDescription] [nvarchar](250) NULL,
	[CategoryName] [nvarchar](250) NULL,
	[TriggerType] [nvarchar](250) NULL,
...
Previous attempt scored **7.05** (FAIL). The adversarial judge required regeneration with the following specific fixes:
...
1. [high] `PlayerStatusSubReasonName` — Tier 1 column with major semantic loss. Drops 5 abbreviations (FTD=First Time Deposit, MOP=Method of Payment, PWMB=eToro Money, SAR=Suspicious Activity Report, WCH=World Check) and all 9 key value=ID pairs (Fraud (1), Fake docs (2), ACH CHBK (35), Credit Card CHBK (36), PayPal CHBK (37), SAR filed (73), FATCA (66), W-8BEN (76), Vulnerable Client (75)) from Dim_PlayerStatusSubReasons upstream. For an AML-focused table this is critical missing context.
2. [high] `PlayerStatusReason` — Tier 1 column with semantic loss. Drops eToro Money Restriction (33), Abusive Trading (34), Hacked Account (35), Tax (41) — four AML-relevant reason codes directly applicable to this table. Drops ID numbers from remaining values. Drops 'Used in BackOffice reporting and customer history views'. Adds 'CloseAccountByUser' sourced from upstream §2.1 business logic section rather than the elements key-values list — mixes text from different upstream sections.
3. [medium] `Footer tier count` — Footer states '19 T1, 9 T2, 9 T3' but body tag counting yields 22 T1, 6 T2, 9 T3 (total = 37 in both cases). The 3-column discrepancy in the tier breakdown undermines the audit trail. Either 3 columns tagged T1 in the body should be T2, or the footer count is wrong and must be corrected.
4. [medium] `EvMatchStatusName` — Tier tag reads '(Tier 2 -- SP_Dictionaries_DL_To_Synapse)'. SP_Dictionaries_DL_To_Synapse is the SP that built Dim_EvMatchStatus, not the SP that writes this table (SP_AML_Multiple_Accounts). An analyst following this tag to understand data pipeline dependency would trace to the wrong ETL. Should read '(Tier 2 -- SP_AML_Multiple_Accounts, via Dim_EvMatchStatus)' or equivalent.
5. [low] `Zip / Gender` — Both columns drop 'Used in LinkedAccountHash1' from upstream Dim_Customer descriptions. In the AML context of this specific table — which exists to detect multi-account patterns — the knowledge that Zip and Gender feed the linked-account deduplication hash is highly relevant context and should be preserved verbatim.

Tier 1 paraphrasing failures (must be fixed verbatim):

- **PlayerStatusReason**:
  - Upstream: `Human-readable reason label (nullable). Key values: None (0), Failed Verification (1), Chargeback (5), AML-Account Closed (6), HRC (7), AML (10), AML review (11), WCH match (18), Right to be forgotten`
  - You wrote: `Human-readable reason label for the customer's current account status change (nullable). Key values: None, Failed Verification, Chargeback, AML-Account Closed, HRC, AML, AML review, WCH match, Right t`
...
- **PlayerStatusSubReasonName**:
  - Upstream: `Human-readable sub-reason label (renamed from production `Name`). Nullable. Key abbreviations: CHBK=Chargeback, POI=Proof of Identity, POA=Proof of Address, FTD=First Time Deposit, MOP=Method of Payme`
  - You wrote: `Human-readable sub-reason label for the customer's account status change (nullable). Provides second-level detail beneath PlayerStatusReason. Key abbreviations: CHBK=Chargeback, POI=Proof of Identity,`
