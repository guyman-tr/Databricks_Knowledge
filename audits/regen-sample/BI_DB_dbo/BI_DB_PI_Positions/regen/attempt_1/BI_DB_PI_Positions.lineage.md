...
| OpenDateID | DWH_dbo.Dim_Position | OpenDateID | Passthrough | Tier 2 — Dim_Position |
| CloseDateID | DWH_dbo.Dim_Position | CloseDateID | Passthrough (synced via UPDATE in section 2.3) | Tier 2 — Dim_Position |
| Volume | DWH_dbo.Dim_Position | Volume | Passthrough | Tier 2 — Dim_Position |
| FullCommissionOnCloseOrig | DWH_dbo.Dim_Position | FullCommissionOnCloseOrig | Passthrough (synced via UPDATE in section 2.3) | Tier 2 — Dim_Position |
| IsSettled | DWH_dbo.Dim_Position | IsSettled | Passthrough | Tier 2 — Dim_Position |
| FullCommissionByUnits | DWH_dbo.Dim_Position | FullCommissionByUnits | Passthrough (synced via UPDATE in section 2.3) | Tier 2 — Dim_Position |
