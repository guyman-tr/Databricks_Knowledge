...
| 5 | AccountManagerID | int | YES | Assigned account manager (sales/retention). Sourced from Fact_SnapshotCustomer.AccountManagerID in all streams. FK to DWH_dbo.Dim_Manager. (Tier 2 — Fact_SnapshotCustomer) |
| 6 | CountryID | int | YES | Customer's registered country. Sourced from Fact_SnapshotCustomer.CountryID in all streams. FK to DWH_dbo.Dim_Country. (Tier 2 — Fact_SnapshotCustomer) |
| 7 | RegulationID | tinyint | YES | Regulatory entity ID. Sourced from Fact_SnapshotCustomer.RegulationID in all streams. FK to DWH_dbo.Dim_Regulation. (Tier 2 — Fact_SnapshotCustomer) |
...
*Generated: 2026-04-29 | Quality: 8.2/10 | Phases: 12/14*
*Tiers: 0 T1, 13 T2, 0 T3, 0 T4, 0 T5 | Elements: 13/13, Logic: 9/10, Relationships: 8/10, Sources: 9/10*
