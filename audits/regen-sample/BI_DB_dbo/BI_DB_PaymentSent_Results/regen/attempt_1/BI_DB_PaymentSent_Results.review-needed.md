...
- **CAD aging threshold**: The SP includes CAD (CurrencyID=7) in the currency filter but the final WHERE clause has no explicit aging condition for CAD. Is this intentional? CAD withdrawals in Payment Sent status may appear with any age.
