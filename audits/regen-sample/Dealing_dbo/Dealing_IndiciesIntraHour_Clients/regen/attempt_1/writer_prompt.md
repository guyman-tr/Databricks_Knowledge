...
- **Attempt**: `1`
- **Output directory** (relative to repo root): `audits/regen-sample/Dealing_dbo/Dealing_IndiciesIntraHour_Clients/regen/attempt_1/`
- **Absolute output directory**: `C:\Users\guyman\Documents\github\Databricks_Knowledge\audits\regen-sample\Dealing_dbo\Dealing_IndiciesIntraHour_Clients\regen\attempt_1`
- **Bundle path**: `C:\Users\guyman\Documents\github\Databricks_Knowledge\audits\regen-sample\Dealing_dbo\Dealing_IndiciesIntraHour_Clients\regen\_upstream_bundle.md`
- **DDL path**: `c:\Users\guyman\Documents\github\DataPlatform\SynapseSQLPool1\sql_dp_prod_we\Dealing_dbo\Tables\Dealing_dbo.Dealing_IndiciesIntraHour_Clients.sql`
...
# Pre-Resolved Upstream Bundle for `Dealing_dbo.Dealing_IndiciesIntraHour_Clients`

This bundle was assembled deterministically by the regen harness BEFORE the writer claude process started. Use this as your AUTHORITATIVE Tier 1 inheritance source. Quote descriptions VERBATIM from the upstream wikis below for any column that is a passthrough or rename of an upstream column. Do NOT paraphrase. Do NOT generalize vendor names. Do NOT drop NULL semantics.

---

## Source DDL — `Dealing_dbo.Dealing_IndiciesIntraHour_Clients.sql`

```sql
CREATE TABLE [Dealing_dbo].[Dealing_IndiciesIntraHour_Clients]
(
	[Date] [date] NULL,
	...
	[OP_Buy_Units] [float] NULL,
	[OP_Buy] [float] NULL,
	[OP_Sell_Units] [float] NULL,
	[OP_Sell] [float] NULL,
	[UnrealizedStart] [float] NULL,
	[UnrealizedEnd] [float] NULL,
	[Realized] [float] NULL,
	[Bid] [float] NULL,
	[Ask] [float] NULL,
...
| `Dealing_dbo.Dealing_IndiciesIntraHour_Etoro` | unresolved | Dealing_dbo | Dealing_IndiciesIntraHour_Etoro | `—` |
