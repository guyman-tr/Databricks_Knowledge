...
- **Attempt**: `1`
- **Output directory** (relative to repo root): `audits/regen-sample/eMoney_Tribe/AccountsActivities_862157/regen/attempt_1/`
- **Absolute output directory**: `C:\Users\guyman\Documents\github\Databricks_Knowledge\audits\regen-sample\eMoney_Tribe\AccountsActivities_862157\regen\attempt_1`
- **Bundle path**: `C:\Users\guyman\Documents\github\Databricks_Knowledge\audits\regen-sample\eMoney_Tribe\AccountsActivities_862157\regen\_upstream_bundle.md`
- **DDL path**: `c:\Users\guyman\Documents\github\DataPlatform\SynapseSQLPool1\sql_dp_prod_we\eMoney_Tribe\Tables\eMoney_Tribe.AccountsActivities_862157.sql`
- **No-upstream marker present**: `C:\Users\guyman\Documents\github\Databricks_Knowledge\audits\regen-sample\eMoney_Tribe\AccountsActivities_862157\regen\_no_upstream_found.txt` — object is dormant or has no resolvable upstream wiki. Footer may say `Production Source: Unknown (dormant)`. Tier 4 inferred is STILL banned — ground every column description in DDL + SP code.
...
# Pre-Resolved Upstream Bundle for `eMoney_Tribe.AccountsActivities_862157`

This bundle was assembled deterministically by the regen harness BEFORE the writer claude process started. Use this as your AUTHORITATIVE Tier 1 inheritance source. Quote descriptions VERBATIM from the upstream wikis below for any column that is a passthrough or rename of an upstream column. Do NOT paraphrase. Do NOT generalize vendor names. Do NOT drop NULL semantics.

---

## Source DDL — `eMoney_Tribe.AccountsActivities_862157.sql`

```sql
CREATE TABLE [eMoney_Tribe].[AccountsActivities_862157]
(
...
GO
CREATE NONCLUSTERED INDEX [ClusteredIndex_AA_862157_Id] ON [eMoney_Tribe].[AccountsActivities_862157]
(
	[@Id] ASC
)WITH (DROP_EXISTING = OFF)
GO
CREATE NONCLUSTERED INDEX [XI_partition_date] ON [eMoney_Tribe].[AccountsActivities_862157]
(
	[partition_date] ASC
)WITH (DROP_EXISTING = OFF)
GO
CREATE NONCLUSTERED INDEX [idx_862157_created] ON [eMoney_Tribe].[AccountsActivities_862157]
(
	[@Created] ASC
)WITH (DROP_EXISTING = OFF)
GO
