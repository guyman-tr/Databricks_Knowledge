...
| Tier | Meaning |
|------|---------|
| Tier 1 | Verbatim from upstream production wiki (FiatDwhDB.Tribe) |
...
|---|---------|------|----------|-------------|
| 1 | @Created | datetime2(7) | YES | DWH timestamp. (Tier 1 — FiatDwhDB.Tribe.SettlementsTransactions_SettlementTransaction-637239) |
...
| 3 | @SettlementsTransactions@Id-333243 | varchar(40) | YES | FK to parent. Links to the parent SettlementsTransactions-333243 container record. Contains identical GUID values to @Id in sampled data (1:1 relationship). Indexed by ClusteredIndex_ST_637239_c2. (Tier 1 — FiatDwhDB.Tribe.SettlementsTransactions_SettlementTransaction-637239) |
...
| 111 | Created | datetime2(7) | YES | Source timestamp. Timestamp of when the settlement record was created in the source system (FiatDwhDB.Tribe). Used as the incremental load watermark by SP_eMoney_Reconciliation_ETLs (`WHERE @Created >= @SettlementsTransactions_DATE`). (Tier 1 — FiatDwhDB.Tribe.SettlementsTransactions_SettlementTransaction-637239) |
...
*Tiers: 4 T1, 5 T2, 103 T3, 0 T4, 0 T5 | Elements: 112/112, Logic: 7/10, Lineage: 8/10*
