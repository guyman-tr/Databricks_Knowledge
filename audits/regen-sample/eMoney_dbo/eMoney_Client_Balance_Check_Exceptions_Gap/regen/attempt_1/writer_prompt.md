...
- **Attempt**: `1`
- **Output directory** (relative to repo root): `audits/regen-sample/eMoney_dbo/eMoney_Client_Balance_Check_Exceptions_Gap/regen/attempt_1/`
- **Absolute output directory**: `C:\Users\guyman\Documents\github\Databricks_Knowledge\audits\regen-sample\eMoney_dbo\eMoney_Client_Balance_Check_Exceptions_Gap\regen\attempt_1`
- **Bundle path**: `C:\Users\guyman\Documents\github\Databricks_Knowledge\audits\regen-sample\eMoney_dbo\eMoney_Client_Balance_Check_Exceptions_Gap\regen\_upstream_bundle.md`
- **DDL path**: `c:\Users\guyman\Documents\github\DataPlatform\SynapseSQLPool1\sql_dp_prod_we\eMoney_dbo\Tables\eMoney_dbo.eMoney_Client_Balance_Check_Exceptions_Gap.sql`
...
# Pre-Resolved Upstream Bundle for `eMoney_dbo.eMoney_Client_Balance_Check_Exceptions_Gap`

This bundle was assembled deterministically by the regen harness BEFORE the writer claude process started. Use this as your AUTHORITATIVE Tier 1 inheritance source. Quote descriptions VERBATIM from the upstream wikis below for any column that is a passthrough or rename of an upstream column. Do NOT paraphrase. Do NOT generalize vendor names. Do NOT drop NULL semantics.

---

## Source DDL — `eMoney_dbo.eMoney_Client_Balance_Check_Exceptions_Gap.sql`

```sql
CREATE TABLE [eMoney_dbo].[eMoney_Client_Balance_Check_Exceptions_Gap]
(
	[Date] [date] NULL,
	[Exceptions_Gap] [decimal](16, 6) NULL,
...
### SP `eMoney_dbo.SP_eMoney_Client_Balance_Check_Exceptions_Gap`
- **Path**: `c:\Users\guyman\Documents\github\DataPlatform\SynapseSQLPool1\sql_dp_prod_we\eMoney_dbo\Stored Procedures\eMoney_dbo.SP_eMoney_Client_Balance_Check_Exceptions_Gap.sql`
...
GO
CREATE PROC [eMoney_dbo].[SP_eMoney_Client_Balance_Check_Exceptions_Gap] @Date [Date] AS
BEGIN
/**************************************Start Main Comment History******************************************************
Author:      Adi Meidan  
Date:        Alert for eMoney CB Opening Exceptions Gap
...
--SELECT ddbp.DateID
--	  ,ddbp.Exceptions_Gap
--FROM #Exceptions ddbp
--WHERE ddbp.Exceptions_Gap<>0 

-----truncate table --------
TRUNCATE TABLE eMoney_dbo.eMoney_Client_Balance_Check_Exceptions_Gap

---insert---

INSERT INTO eMoney_dbo.eMoney_Client_Balance_Check_Exceptions_Gap
(
[Date] 
,Exceptions_Gap
,UpdateDate
...
| `eMoney_dbo.SP_eMoney_Client_Balance_Check_Exceptions_Gap` | synapse_sp | eMoney_dbo | SP_eMoney_Client_Balance_Check_Exceptions_Gap | `c:\Users\guyman\Documents\github\DataPlatform\SynapseSQLPool1\sql_dp_prod_we\eMoney_dbo\Stored Procedures\eMoney_dbo.SP_eMoney_Client_Balance_Check_Exceptions_Gap.sql` |
