...
- **Object**: `Dim_CardType`
- **Attempt**: `1`
- **Output directory** (relative to repo root): `audits/regen-sample/DWH_dbo/Dim_CardType/regen/attempt_1/`
- **Absolute output directory**: `C:\Users\guyman\Documents\github\Databricks_Knowledge\audits\regen-sample\DWH_dbo\Dim_CardType\regen\attempt_1`
- **Bundle path**: `C:\Users\guyman\Documents\github\Databricks_Knowledge\audits\regen-sample\DWH_dbo\Dim_CardType\regen\_upstream_bundle.md`
- **DDL path**: `c:\Users\guyman\Documents\github\DataPlatform\SynapseSQLPool1\sql_dp_prod_we\DWH_dbo\Tables\DWH_dbo.Dim_CardType.sql`
...
# Pre-Resolved Upstream Bundle for `DWH_dbo.Dim_CardType`

This bundle was assembled deterministically by the regen harness BEFORE the writer claude process started. Use this as your AUTHORITATIVE Tier 1 inheritance source. Quote descriptions VERBATIM from the upstream wikis below for any column that is a passthrough or rename of an upstream column. Do NOT paraphrase. Do NOT generalize vendor names. Do NOT drop NULL semantics.

---

## Source DDL — `DWH_dbo.Dim_CardType.sql`

```sql
CREATE TABLE [DWH_dbo].[Dim_CardType]
(
	[CardTypeID] [int] NULL,
...
### Upstream `etoro.Dictionary.CardType` — production
- **Resolved as**: `etoro.Dictionary.CardType`
- **Wiki path**: `C:\Users\guyman\Documents\github\DB_Schema\etoro\Wiki\Dictionary\Tables\Dictionary.CardType.md`
...
|---|---|---|---|---|
| `dwh.gold_sql_dp_prod_we_dwh_dbo_dim_cardtype` | unresolved | dwh | gold_sql_dp_prod_we_dwh_dbo_dim_cardtype | `—` |
| `etoro.Dictionary.CardType` | production | Dictionary | CardType | `C:\Users\guyman\Documents\github\DB_Schema\etoro\Wiki\Dictionary\Tables\Dictionary.CardType.md` |
