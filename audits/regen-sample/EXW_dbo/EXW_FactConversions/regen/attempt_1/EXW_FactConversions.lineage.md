...
|---|--------------|------------|----------|--------|----------|
| 1 | Wallet.Conversions | Table | WalletDB | Wallet | Primary source — base conversion record (Id, wallets, amounts, crypto IDs, correlation, occurred) |
| 2 | Wallet.ConversionTransactions | Table | WalletDB | Wallet | Per-leg transaction details — fees, addresses, amounts sent/received for From and To legs |
...
| 5 | FromAddress | Wallet.ConversionTransactions | ToAddress | From-leg address (renamed) | Tier 2 |
| 6 | SendingGCID | — | — | Customer GCID from wallet-to-customer mapping; not in upstream tables | Tier 3 |
| 7 | RequestedFromAmount | Wallet.Conversions | FromAmount | Passthrough (renamed — original requested amount) | Tier 1 |
...
| 12 | FromAmount | Wallet.Conversions | FromAmount | Passthrough | Tier 1 |
...
| 19 | RequestedToAmount | Wallet.Conversions | ToAmount | Passthrough (renamed — original requested amount) | Tier 1 |
...
| 22 | ToAmount | Wallet.Conversions | ToAmount | Passthrough | Tier 1 |
