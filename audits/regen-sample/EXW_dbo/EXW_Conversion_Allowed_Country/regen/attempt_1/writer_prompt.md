...
- **Attempt**: `1`
- **Output directory** (relative to repo root): `audits/regen-sample/EXW_dbo/EXW_Conversion_Allowed_Country/regen/attempt_1/`
- **Absolute output directory**: `C:\Users\guyman\Documents\github\Databricks_Knowledge\audits\regen-sample\EXW_dbo\EXW_Conversion_Allowed_Country\regen\attempt_1`
